...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	62b040ef          	jal	ra,ffffffffc0204e74 <memset>
...
ffffffffc0200056:	e7658593          	addi	a1,a1,-394 # ffffffffc0204ec8 <etext+0x6>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	e8e50513          	addi	a0,a0,-370 # ffffffffc0204ee8 <etext+0x26>
...
ffffffffc020008e:	01b040ef          	jal	ra,ffffffffc02048a8 <cpu_idle>
...
ffffffffc02000ac:	e4850513          	addi	a0,a0,-440 # ffffffffc0204ef0 <etext+0x2e>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	103040ef          	jal	ra,ffffffffc0204a76 <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	0cd040ef          	jal	ra,ffffffffc0204a76 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	d2e50513          	addi	a0,a0,-722 # ffffffffc0204ef8 <etext+0x36>
void print_kerninfo(void) {
...
ffffffffc02001e4:	d3850513          	addi	a0,a0,-712 # ffffffffc0204f18 <etext+0x56>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	cd658593          	addi	a1,a1,-810 # ffffffffc0204ec2 <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	d4450513          	addi	a0,a0,-700 # ffffffffc0204f38 <etext+0x76>
...
ffffffffc020020c:	d5050513          	addi	a0,a0,-688 # ffffffffc0204f58 <etext+0x96>
...
ffffffffc0200220:	d5c50513          	addi	a0,a0,-676 # ffffffffc0204f78 <etext+0xb6>
...
ffffffffc020024e:	d4e50513          	addi	a0,a0,-690 # ffffffffc0204f98 <etext+0xd6>
}
...
ffffffffc020025c:	d7060613          	addi	a2,a2,-656 # ffffffffc0204fc8 <etext+0x106>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	d7c50513          	addi	a0,a0,-644 # ffffffffc0204fe0 <etext+0x11e>
void print_stackframe(void) {
...
ffffffffc0200278:	d8460613          	addi	a2,a2,-636 # ffffffffc0204ff8 <etext+0x136>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	d9c58593          	addi	a1,a1,-612 # ffffffffc0205018 <etext+0x156>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	d9c50513          	addi	a0,a0,-612 # ffffffffc0205020 <etext+0x15e>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	d9e60613          	addi	a2,a2,-610 # ffffffffc0205030 <etext+0x16e>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	dbe58593          	addi	a1,a1,-578 # ffffffffc0205058 <etext+0x196>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	d7e50513          	addi	a0,a0,-642 # ffffffffc0205020 <etext+0x15e>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	dba60613          	addi	a2,a2,-582 # ffffffffc0205068 <etext+0x1a6>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	dd258593          	addi	a1,a1,-558 # ffffffffc0205088 <etext+0x1c6>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	d6250513          	addi	a0,a0,-670 # ffffffffc0205020 <etext+0x15e>
...
ffffffffc02002fc:	da050513          	addi	a0,a0,-608 # ffffffffc0205098 <etext+0x1d6>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	da650513          	addi	a0,a0,-602 # ffffffffc02050c0 <etext+0x1fe>
...
ffffffffc0200348:	da490913          	addi	s2,s2,-604 # ffffffffc02050e8 <etext+0x226>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	da448493          	addi	s1,s1,-604 # ffffffffc02050f0 <etext+0x22e>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	da2b0b13          	addi	s6,s6,-606 # ffffffffc02050f8 <etext+0x236>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	cbaa0a13          	addi	s4,s4,-838 # ffffffffc0205018 <etext+0x156>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	2b3040ef          	jal	ra,ffffffffc0204e40 <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	29f040ef          	jal	ra,ffffffffc0204e40 <strcmp>
...
ffffffffc02003e0:	27f040ef          	jal	ra,ffffffffc0204e5e <strchr>
...
ffffffffc020041e:	241040ef          	jal	ra,ffffffffc0204e5e <strchr>
...
ffffffffc020043c:	ce050513          	addi	a0,a0,-800 # ffffffffc0205118 <etext+0x256>
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	0fb040ef          	jal	ra,ffffffffc0204e86 <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	0d7040ef          	jal	ra,ffffffffc0204e86 <memcpy>
    return 0;
}
...
ffffffffc0201bbe:	2b6030ef          	jal	ra,ffffffffc0204e74 <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	224030ef          	jal	ra,ffffffffc0204e74 <memset>
    return page - pages + nbase;
...
ffffffffc0202352:	2dd020ef          	jal	ra,ffffffffc0204e2e <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	2e3020ef          	jal	ra,ffffffffc0204e40 <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	265020ef          	jal	ra,ffffffffc0204df8 <strlen>
...
ffffffffc0202b7e:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202b80:	570010ef          	jal	ra,ffffffffc02040f0 <swapfs_init>
...
ffffffffc020335a:	65d000ef          	jal	ra,ffffffffc02041b6 <swapfs_write>
...
ffffffffc02033f8:	531000ef          	jal	ra,ffffffffc0204128 <swapfs_read>
...
ffffffffc0203606:	05400593          	li	a1,84
...
ffffffffc0203626:	07600593          	li	a1,118
...
ffffffffc0203646:	07400593          	li	a1,116
...
ffffffffc0203666:	07200593          	li	a1,114
...
ffffffffc0203686:	06f00593          	li	a1,111
...
ffffffffc02036a6:	06c00593          	li	a1,108
...
ffffffffc02036c6:	06900593          	li	a1,105
...
ffffffffc02036e6:	06600593          	li	a1,102
...
ffffffffc0203706:	06300593          	li	a1,99
...
ffffffffc0203726:	06000593          	li	a1,96
...
ffffffffc0203746:	05d00593          	li	a1,93
...
ffffffffc0203766:	05a00593          	li	a1,90
...
ffffffffc0203786:	05700593          	li	a1,87
...
ffffffffc0203cd2:	2faa3a03          	ld	s4,762(s4) # ffffffffc0206fc8 <nbase>
...
do_pgfault(struct mm_struct *mm, uint32_t error_code, uintptr_t addr) {
ffffffffc0203ff2:	f822                	sd	s0,48(sp)
ffffffffc0203ff4:	f426                	sd	s1,40(sp)
ffffffffc0203ff6:	fc06                	sd	ra,56(sp)
ffffffffc0203ff8:	f04a                	sd	s2,32(sp)
ffffffffc0203ffa:	ec4e                	sd	s3,24(sp)
ffffffffc0203ffc:	8432                	mv	s0,a2
ffffffffc0203ffe:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0204000:	8ddff0ef          	jal	ra,ffffffffc02038dc <find_vma>

    pgfault_num++;
ffffffffc0204004:	00011797          	auipc	a5,0x11
ffffffffc0204008:	5a47a783          	lw	a5,1444(a5) # ffffffffc02155a8 <pgfault_num>
ffffffffc020400c:	2785                	addiw	a5,a5,1
ffffffffc020400e:	00011717          	auipc	a4,0x11
ffffffffc0204012:	58f72d23          	sw	a5,1434(a4) # ffffffffc02155a8 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0204016:	c545                	beqz	a0,ffffffffc02040be <do_pgfault+0xd0>
ffffffffc0204018:	651c                	ld	a5,8(a0)
ffffffffc020401a:	0af46263          	bltu	s0,a5,ffffffffc02040be <do_pgfault+0xd0>
...
ffffffffc020401e:	4d1c                	lw	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0204020:	49c1                	li	s3,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0204022:	8b89                	andi	a5,a5,2
ffffffffc0204024:	efb1                	bnez	a5,ffffffffc0204080 <do_pgfault+0x92>
        perm |= READ_WRITE;
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0204026:	75fd                	lui	a1,0xfffff
...
ffffffffc0204028:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc020402a:	8c6d                	and	s0,s0,a1
    if ((ptep = get_pte(mm->pgdir, addr, 1)) == NULL) {
ffffffffc020402c:	4605                	li	a2,1
ffffffffc020402e:	85a2                	mv	a1,s0
ffffffffc0204030:	b09fd0ef          	jal	ra,ffffffffc0201b38 <get_pte>
ffffffffc0204034:	c555                	beqz	a0,ffffffffc02040e0 <do_pgfault+0xf2>
        cprintf("get_pte in do_pgfault failed\n");
        goto failed;
    }
    if (*ptep == 0) { // if the phy addr isn't exist, then alloc a page & map the phy addr with logical addr
ffffffffc0204036:	610c                	ld	a1,0(a0)
ffffffffc0204038:	c5a5                	beqz	a1,ffffffffc02040a0 <do_pgfault+0xb2>
        ...
        */
        if (swap_init_ok) {
ffffffffc020403a:	00011797          	auipc	a5,0x11
ffffffffc020403e:	55e7a783          	lw	a5,1374(a5) # ffffffffc0215598 <swap_init_ok>
ffffffffc0204042:	c7d9                	beqz	a5,ffffffffc02040d0 <do_pgfault+0xe2>
...
ffffffffc020404a:	e402                	sd	zero,8(sp)
            ret=swap_in(mm,addr,&page);
ffffffffc020404c:	b7eff0ef          	jal	ra,ffffffffc02033ca <swap_in>
ffffffffc0204050:	892a                	mv	s2,a0
            if(ret!=0){
ffffffffc0204052:	e90d                	bnez	a0,ffffffffc0204084 <do_pgfault+0x96>
                cprintf("swap_in in do_pgfault failed\n");
                goto failed;
            }
            page_insert(mm->pgdir,page,addr,perm);
ffffffffc0204054:	65a2                	ld	a1,8(sp)
ffffffffc0204056:	6c88                	ld	a0,24(s1)
ffffffffc0204058:	86ce                	mv	a3,s3
ffffffffc020405a:	8622                	mv	a2,s0
ffffffffc020405c:	d9ffd0ef          	jal	ra,ffffffffc0201dfa <page_insert>
...
ffffffffc0204068:	a42ff0ef          	jal	ra,ffffffffc02032aa <swap_map_swappable>
...
ffffffffc0204070:	70e2                	ld	ra,56(sp)
ffffffffc0204072:	7442                	ld	s0,48(sp)
ffffffffc0204074:	74a2                	ld	s1,40(sp)
ffffffffc0204076:	69e2                	ld	s3,24(sp)
ffffffffc0204078:	854a                	mv	a0,s2
ffffffffc020407a:	7902                	ld	s2,32(sp)
ffffffffc020407c:	6121                	addi	sp,sp,64
ffffffffc020407e:	8082                	ret
        perm |= READ_WRITE;
ffffffffc0204080:	49dd                	li	s3,23
ffffffffc0204082:	b755                	j	ffffffffc0204026 <do_pgfault+0x38>
                cprintf("swap_in in do_pgfault failed\n");
ffffffffc0204084:	00003517          	auipc	a0,0x3
ffffffffc0204088:	aac50513          	addi	a0,a0,-1364 # ffffffffc0206b30 <default_pmm_manager+0xf18>
ffffffffc020408c:	8f4fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
}
ffffffffc0204090:	70e2                	ld	ra,56(sp)
ffffffffc0204092:	7442                	ld	s0,48(sp)
ffffffffc0204094:	74a2                	ld	s1,40(sp)
ffffffffc0204096:	69e2                	ld	s3,24(sp)
ffffffffc0204098:	854a                	mv	a0,s2
ffffffffc020409a:	7902                	ld	s2,32(sp)
ffffffffc020409c:	6121                	addi	sp,sp,64
ffffffffc020409e:	8082                	ret
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc02040a0:	6c88                	ld	a0,24(s1)
ffffffffc02040a2:	864e                	mv	a2,s3
ffffffffc02040a4:	85a2                	mv	a1,s0
ffffffffc02040a6:	9ebfe0ef          	jal	ra,ffffffffc0202a90 <pgdir_alloc_page>
   ret = 0;
ffffffffc02040aa:	4901                	li	s2,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc02040ac:	f171                	bnez	a0,ffffffffc0204070 <do_pgfault+0x82>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc02040ae:	00003517          	auipc	a0,0x3
ffffffffc02040b2:	a5a50513          	addi	a0,a0,-1446 # ffffffffc0206b08 <default_pmm_manager+0xef0>
ffffffffc02040b6:	8cafc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040ba:	5971                	li	s2,-4
            goto failed;
ffffffffc02040bc:	bf55                	j	ffffffffc0204070 <do_pgfault+0x82>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc02040be:	85a2                	mv	a1,s0
ffffffffc02040c0:	00003517          	auipc	a0,0x3
ffffffffc02040c4:	9f850513          	addi	a0,a0,-1544 # ffffffffc0206ab8 <default_pmm_manager+0xea0>
ffffffffc02040c8:	8b8fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    int ret = -E_INVAL;
ffffffffc02040cc:	5975                	li	s2,-3
        goto failed;
ffffffffc02040ce:	b74d                	j	ffffffffc0204070 <do_pgfault+0x82>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc02040d0:	00003517          	auipc	a0,0x3
ffffffffc02040d4:	a8050513          	addi	a0,a0,-1408 # ffffffffc0206b50 <default_pmm_manager+0xf38>
ffffffffc02040d8:	8a8fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040dc:	5971                	li	s2,-4
            goto failed;
ffffffffc02040de:	bf49                	j	ffffffffc0204070 <do_pgfault+0x82>
        cprintf("get_pte in do_pgfault failed\n");
ffffffffc02040e0:	00003517          	auipc	a0,0x3
ffffffffc02040e4:	a0850513          	addi	a0,a0,-1528 # ffffffffc0206ae8 <default_pmm_manager+0xed0>
ffffffffc02040e8:	898fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
    ret = -E_NO_MEM;
ffffffffc02040ec:	5971                	li	s2,-4
        goto failed;
ffffffffc02040ee:	b749                	j	ffffffffc0204070 <do_pgfault+0x82>

ffffffffc02040f0 <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
ffffffffc02040f4:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc02040f6:	c72fc0ef          	jal	ra,ffffffffc0200568 <ide_device_valid>
ffffffffc02040fa:	cd01                	beqz	a0,ffffffffc0204112 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc02040fc:	4505                	li	a0,1
ffffffffc02040fe:	c70fc0ef          	jal	ra,ffffffffc020056e <ide_device_size>
}
ffffffffc0204102:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0204104:	810d                	srli	a0,a0,0x3
ffffffffc0204106:	00011797          	auipc	a5,0x11
ffffffffc020410a:	48a7b123          	sd	a0,1154(a5) # ffffffffc0215588 <max_swap_offset>
}
ffffffffc020410e:	0141                	addi	sp,sp,16
ffffffffc0204110:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0204112:	00003617          	auipc	a2,0x3
ffffffffc0204116:	a6660613          	addi	a2,a2,-1434 # ffffffffc0206b78 <default_pmm_manager+0xf60>
ffffffffc020411a:	45b5                	li	a1,13
ffffffffc020411c:	00003517          	auipc	a0,0x3
ffffffffc0204120:	a7c50513          	addi	a0,a0,-1412 # ffffffffc0206b98 <default_pmm_manager+0xf80>
ffffffffc0204124:	b22fc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204128 <swapfs_read>:

int
swapfs_read(swap_entry_t entry, struct Page *page) {
ffffffffc0204128:	1141                	addi	sp,sp,-16
ffffffffc020412a:	e406                	sd	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc020412c:	00855793          	srli	a5,a0,0x8
ffffffffc0204130:	cbb1                	beqz	a5,ffffffffc0204184 <swapfs_read+0x5c>
ffffffffc0204132:	00011717          	auipc	a4,0x11
ffffffffc0204136:	45673703          	ld	a4,1110(a4) # ffffffffc0215588 <max_swap_offset>
ffffffffc020413a:	04e7f563          	bgeu	a5,a4,ffffffffc0204184 <swapfs_read+0x5c>
    return page - pages + nbase;
ffffffffc020413e:	00011617          	auipc	a2,0x11
ffffffffc0204142:	43263603          	ld	a2,1074(a2) # ffffffffc0215570 <pages>
ffffffffc0204146:	8d91                	sub	a1,a1,a2
ffffffffc0204148:	4065d613          	srai	a2,a1,0x6
ffffffffc020414c:	00003717          	auipc	a4,0x3
ffffffffc0204150:	e7c73703          	ld	a4,-388(a4) # ffffffffc0206fc8 <nbase>
ffffffffc0204154:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc0204156:	00c61713          	slli	a4,a2,0xc
ffffffffc020415a:	8331                	srli	a4,a4,0xc
ffffffffc020415c:	00011697          	auipc	a3,0x11
ffffffffc0204160:	40c6b683          	ld	a3,1036(a3) # ffffffffc0215568 <npage>
ffffffffc0204164:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc0204168:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc020416a:	02d77963          	bgeu	a4,a3,ffffffffc020419c <swapfs_read+0x74>
}
ffffffffc020416e:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204170:	00011797          	auipc	a5,0x11
ffffffffc0204174:	4107b783          	ld	a5,1040(a5) # ffffffffc0215580 <va_pa_offset>
...
ffffffffc020417e:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0204180:	bf4fc06f          	j	ffffffffc0200574 <ide_read_secs>
ffffffffc0204184:	86aa                	mv	a3,a0
ffffffffc0204186:	00003617          	auipc	a2,0x3
ffffffffc020418a:	a2a60613          	addi	a2,a2,-1494 # ffffffffc0206bb0 <default_pmm_manager+0xf98>
ffffffffc020418e:	45d1                	li	a1,20
ffffffffc0204190:	00003517          	auipc	a0,0x3
ffffffffc0204194:	a0850513          	addi	a0,a0,-1528 # ffffffffc0206b98 <default_pmm_manager+0xf80>
ffffffffc0204198:	aaefc0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc020419c:	86b2                	mv	a3,a2
ffffffffc020419e:	06900593          	li	a1,105
ffffffffc02041a2:	00002617          	auipc	a2,0x2
ffffffffc02041a6:	aae60613          	addi	a2,a2,-1362 # ffffffffc0205c50 <default_pmm_manager+0x38>
ffffffffc02041aa:	00002517          	auipc	a0,0x2
ffffffffc02041ae:	ace50513          	addi	a0,a0,-1330 # ffffffffc0205c78 <default_pmm_manager+0x60>
ffffffffc02041b2:	a94fc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02041b6 <swapfs_write>:

int
swapfs_write(swap_entry_t entry, struct Page *page) {
ffffffffc02041b6:	1141                	addi	sp,sp,-16
ffffffffc02041b8:	e406                	sd	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02041ba:	00855793          	srli	a5,a0,0x8
ffffffffc02041be:	cbb1                	beqz	a5,ffffffffc0204212 <swapfs_write+0x5c>
ffffffffc02041c0:	00011717          	auipc	a4,0x11
ffffffffc02041c4:	3c873703          	ld	a4,968(a4) # ffffffffc0215588 <max_swap_offset>
ffffffffc02041c8:	04e7f563          	bgeu	a5,a4,ffffffffc0204212 <swapfs_write+0x5c>
    return page - pages + nbase;
ffffffffc02041cc:	00011617          	auipc	a2,0x11
ffffffffc02041d0:	3a463603          	ld	a2,932(a2) # ffffffffc0215570 <pages>
ffffffffc02041d4:	8d91                	sub	a1,a1,a2
ffffffffc02041d6:	4065d613          	srai	a2,a1,0x6
ffffffffc02041da:	00003717          	auipc	a4,0x3
ffffffffc02041de:	dee73703          	ld	a4,-530(a4) # ffffffffc0206fc8 <nbase>
ffffffffc02041e2:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc02041e4:	00c61713          	slli	a4,a2,0xc
ffffffffc02041e8:	8331                	srli	a4,a4,0xc
ffffffffc02041ea:	00011697          	auipc	a3,0x11
ffffffffc02041ee:	37e6b683          	ld	a3,894(a3) # ffffffffc0215568 <npage>
ffffffffc02041f2:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc02041f6:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
ffffffffc02041f8:	02d77963          	bgeu	a4,a3,ffffffffc020422a <swapfs_write+0x74>
}
ffffffffc02041fc:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc02041fe:	00011797          	auipc	a5,0x11
ffffffffc0204202:	3827b783          	ld	a5,898(a5) # ffffffffc0215580 <va_pa_offset>
ffffffffc0204206:	46a1                	li	a3,8
ffffffffc0204208:	963e                	add	a2,a2,a5
ffffffffc020420a:	4505                	li	a0,1
}
ffffffffc020420c:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc020420e:	b8afc06f          	j	ffffffffc0200598 <ide_write_secs>
ffffffffc0204212:	86aa                	mv	a3,a0
ffffffffc0204214:	00003617          	auipc	a2,0x3
ffffffffc0204218:	99c60613          	addi	a2,a2,-1636 # ffffffffc0206bb0 <default_pmm_manager+0xf98>
ffffffffc020421c:	45e5                	li	a1,25
ffffffffc020421e:	00003517          	auipc	a0,0x3
ffffffffc0204222:	97a50513          	addi	a0,a0,-1670 # ffffffffc0206b98 <default_pmm_manager+0xf80>
ffffffffc0204226:	a20fc0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc020422a:	86b2                	mv	a3,a2
ffffffffc020422c:	06900593          	li	a1,105
ffffffffc0204230:	00002617          	auipc	a2,0x2
ffffffffc0204234:	a2060613          	addi	a2,a2,-1504 # ffffffffc0205c50 <default_pmm_manager+0x38>
ffffffffc0204238:	00002517          	auipc	a0,0x2
ffffffffc020423c:	a4050513          	addi	a0,a0,-1472 # ffffffffc0205c78 <default_pmm_manager+0x60>
ffffffffc0204240:	a06fc0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc0204244 <kernel_thread_entry>:
.text
...
ffffffffc0204244:	8526                	mv	a0,s1
	jalr s0
ffffffffc0204246:	9402                	jalr	s0

	jal do_exit
ffffffffc0204248:	3f6000ef          	jal	ra,ffffffffc020463e <do_exit>

ffffffffc020424c <alloc_proc>:
...
ffffffffc020424e:	0e800513          	li	a0,232
alloc_proc(void) {
ffffffffc0204252:	e022                	sd	s0,0(sp)
ffffffffc0204254:	e406                	sd	ra,8(sp)
    struct proc_struct *proc = kmalloc(sizeof(struct proc_struct));
ffffffffc0204256:	df8fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
ffffffffc020425a:	842a                	mv	s0,a0
    if (proc != NULL) {
ffffffffc020425c:	c521                	beqz	a0,ffffffffc02042a4 <alloc_proc+0x58>
...
ffffffffc020425e:	57fd                	li	a5,-1
ffffffffc0204260:	1782                	slli	a5,a5,0x20
ffffffffc0204262:	e11c                	sd	a5,0(a0)
    proc->runs=0;
    proc->kstack=0;
    proc->need_resched=0;
    proc->parent=NULL;
...
ffffffffc0204264:	07000613          	li	a2,112
...
ffffffffc020427a:	02053423          	sd	zero,40(a0)
    memset(&(proc->context), 0, sizeof(struct context));
ffffffffc020427e:	03050513          	addi	a0,a0,48
ffffffffc0204282:	3f3000ef          	jal	ra,ffffffffc0204e74 <memset>
    proc->tf=NULL;
    proc->cr3=boot_cr3;
ffffffffc0204286:	00011797          	auipc	a5,0x11
ffffffffc020428a:	2d27b783          	ld	a5,722(a5) # ffffffffc0215558 <boot_cr3>
    proc->tf=NULL;
ffffffffc020428e:	0a043023          	sd	zero,160(s0)
    proc->cr3=boot_cr3;
ffffffffc0204292:	f45c                	sd	a5,168(s0)
    proc->flags=0;
ffffffffc0204294:	0a042823          	sw	zero,176(s0)
    memset(proc->name, 0, PROC_NAME_LEN);
ffffffffc0204298:	463d                	li	a2,15
ffffffffc020429a:	4581                	li	a1,0
ffffffffc020429c:	0b440513          	addi	a0,s0,180
ffffffffc02042a0:	3d5000ef          	jal	ra,ffffffffc0204e74 <memset>
    }
    return proc;
}
...
ffffffffc02042b2:	3027b783          	ld	a5,770(a5) # ffffffffc02155b0 <current>
...
ffffffffc02042c4:	25848493          	addi	s1,s1,600 # ffffffffc0215518 <name.2>
init_main(void *arg) {
ffffffffc02042c8:	f022                	sd	s0,32(sp)
ffffffffc02042ca:	e84a                	sd	s2,16(sp)
ffffffffc02042cc:	842a                	mv	s0,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042ce:	00011917          	auipc	s2,0x11
ffffffffc02042d2:	2e293903          	ld	s2,738(s2) # ffffffffc02155b0 <current>
    memset(name, 0, sizeof(name));
...
ffffffffc020430a:	8f250513          	addi	a0,a0,-1806 # ffffffffc0206bf8 <default_pmm_manager+0xfe0>
ffffffffc020430e:	e73fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc0204312:	00003517          	auipc	a0,0x3
ffffffffc0204316:	8f650513          	addi	a0,a0,-1802 # ffffffffc0206c08 <default_pmm_manager+0xff0>
...
ffffffffc0204330:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc0204332:	00011497          	auipc	s1,0x11
ffffffffc0204336:	27e48493          	addi	s1,s1,638 # ffffffffc02155b0 <current>
ffffffffc020433a:	609c                	ld	a5,0(s1)
proc_run(struct proc_struct *proc) {
ffffffffc020433c:	f406                	sd	ra,40(sp)
ffffffffc020433e:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc0204340:	02a78763          	beq	a5,a0,ffffffffc020436e <proc_run+0x40>
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc020434a:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020434c:	ef85                	bnez	a5,ffffffffc0204384 <proc_run+0x56>
...
ffffffffc0204364:	852e                	mv	a0,a1
ffffffffc0204366:	55e000ef          	jal	ra,ffffffffc02048c4 <switch_to>
    if (flag) {
ffffffffc020436a:	00091763          	bnez	s2,ffffffffc0204378 <proc_run+0x4a>
}
ffffffffc020436e:	70a2                	ld	ra,40(sp)
ffffffffc0204370:	7482                	ld	s1,32(sp)
ffffffffc0204372:	6962                	ld	s2,24(sp)
...
ffffffffc020437e:	6145                	addi	sp,sp,48
        intr_enable();
ffffffffc0204380:	a3cfc06f          	j	ffffffffc02005bc <intr_enable>
ffffffffc0204384:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc0204386:	a3cfc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc020438a:	6522                	ld	a0,8(sp)
ffffffffc020438c:	4905                	li	s2,1
ffffffffc020438e:	b7c1                	j	ffffffffc020434e <proc_run+0x20>

ffffffffc0204390 <do_fork>:
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204390:	00011717          	auipc	a4,0x11
ffffffffc0204394:	23872703          	lw	a4,568(a4) # ffffffffc02155c8 <nr_process>
ffffffffc0204398:	6785                	lui	a5,0x1
ffffffffc020439a:	20f75d63          	bge	a4,a5,ffffffffc02045b4 <do_fork+0x224>
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc020439e:	7179                	addi	sp,sp,-48
ffffffffc02043a0:	f022                	sd	s0,32(sp)
ffffffffc02043a2:	ec26                	sd	s1,24(sp)
ffffffffc02043a4:	e84a                	sd	s2,16(sp)
ffffffffc02043a6:	e44e                	sd	s3,8(sp)
ffffffffc02043a8:	f406                	sd	ra,40(sp)
ffffffffc02043aa:	89aa                	mv	s3,a0
ffffffffc02043ac:	892e                	mv	s2,a1
ffffffffc02043ae:	8432                	mv	s0,a2
    proc = alloc_proc();
ffffffffc02043b0:	e9dff0ef          	jal	ra,ffffffffc020424c <alloc_proc>
ffffffffc02043b4:	84aa                	mv	s1,a0
    if (proc == NULL) {
ffffffffc02043b6:	1e050d63          	beqz	a0,ffffffffc02045b0 <do_fork+0x220>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043ba:	4509                	li	a0,2
ffffffffc02043bc:	e70fd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc02043c0:	1e050563          	beqz	a0,ffffffffc02045aa <do_fork+0x21a>
    return page - pages + nbase;
ffffffffc02043c4:	00011e17          	auipc	t3,0x11
ffffffffc02043c8:	1ace3e03          	ld	t3,428(t3) # ffffffffc0215570 <pages>
ffffffffc02043cc:	41c506b3          	sub	a3,a0,t3
ffffffffc02043d0:	00003e97          	auipc	t4,0x3
ffffffffc02043d4:	bf8ebe83          	ld	t4,-1032(t4) # ffffffffc0206fc8 <nbase>
ffffffffc02043d8:	8699                	srai	a3,a3,0x6
ffffffffc02043da:	96f6                	add	a3,a3,t4
    return KADDR(page2pa(page));
ffffffffc02043dc:	00c69f13          	slli	t5,a3,0xc
ffffffffc02043e0:	00cf5f13          	srli	t5,t5,0xc
ffffffffc02043e4:	00011797          	auipc	a5,0x11
ffffffffc02043e8:	1847b783          	ld	a5,388(a5) # ffffffffc0215568 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc02043ec:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043ee:	1eff7463          	bgeu	t5,a5,ffffffffc02045d6 <do_fork+0x246>
ffffffffc02043f2:	00011797          	auipc	a5,0x11
ffffffffc02043f6:	18e7b783          	ld	a5,398(a5) # ffffffffc0215580 <va_pa_offset>
ffffffffc02043fa:	96be                	add	a3,a3,a5
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02043fc:	e894                	sd	a3,16(s1)
    if (!(clone_flags & CLONE_VM)) {
ffffffffc02043fe:	1009f993          	andi	s3,s3,256
ffffffffc0204402:	14098763          	beqz	s3,ffffffffc0204550 <do_fork+0x1c0>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204406:	6709                	lui	a4,0x2
ffffffffc0204408:	ee070713          	addi	a4,a4,-288 # 1ee0 <kern_entry-0xffffffffc01fe120>
ffffffffc020440c:	9736                	add	a4,a4,a3
    *(proc->tf) = *tf;
ffffffffc020440e:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc0204410:	f0d8                	sd	a4,160(s1)
    *(proc->tf) = *tf;
ffffffffc0204412:	87ba                	mv	a5,a4
ffffffffc0204414:	12040513          	addi	a0,s0,288
ffffffffc0204418:	00063303          	ld	t1,0(a2)
ffffffffc020441c:	00863883          	ld	a7,8(a2)
ffffffffc0204420:	01063803          	ld	a6,16(a2)
ffffffffc0204424:	6e0c                	ld	a1,24(a2)
ffffffffc0204426:	0067b023          	sd	t1,0(a5)
ffffffffc020442a:	0117b423          	sd	a7,8(a5)
ffffffffc020442e:	0107b823          	sd	a6,16(a5)
ffffffffc0204432:	ef8c                	sd	a1,24(a5)
ffffffffc0204434:	02060613          	addi	a2,a2,32
ffffffffc0204438:	02078793          	addi	a5,a5,32
ffffffffc020443c:	fca61ee3          	bne	a2,a0,ffffffffc0204418 <do_fork+0x88>
    proc->tf->gpr.a0 = 0;
ffffffffc0204440:	04073823          	sd	zero,80(a4)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204444:	10090463          	beqz	s2,ffffffffc020454c <do_fork+0x1bc>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204448:	00006317          	auipc	t1,0x6
ffffffffc020444c:	c1030313          	addi	t1,t1,-1008 # ffffffffc020a058 <last_pid.1>
ffffffffc0204450:	00032783          	lw	a5,0(t1)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204454:	01273823          	sd	s2,16(a4)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204458:	00000617          	auipc	a2,0x0
ffffffffc020445c:	e5660613          	addi	a2,a2,-426 # ffffffffc02042ae <forkret>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204460:	0017851b          	addiw	a0,a5,1
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204464:	f890                	sd	a2,48(s1)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204466:	fc98                	sd	a4,56(s1)
    if (++ last_pid >= MAX_PID) {
ffffffffc0204468:	00a32023          	sw	a0,0(t1)
ffffffffc020446c:	6789                	lui	a5,0x2
ffffffffc020446e:	06f55763          	bge	a0,a5,ffffffffc02044dc <do_fork+0x14c>
    if (last_pid >= next_safe) {
ffffffffc0204472:	00006297          	auipc	t0,0x6
ffffffffc0204476:	bea28293          	addi	t0,t0,-1046 # ffffffffc020a05c <next_safe.0>
ffffffffc020447a:	0002a783          	lw	a5,0(t0)
ffffffffc020447e:	06f55763          	bge	a0,a5,ffffffffc02044ec <do_fork+0x15c>
    proc->pid = get_pid();
ffffffffc0204482:	c0c8                	sw	a0,4(s1)
    if (proc->pid <= 0) {
ffffffffc0204484:	10a05863          	blez	a0,ffffffffc0204594 <do_fork+0x204>
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0204488:	45a9                	li	a1,10
ffffffffc020448a:	2501                	sext.w	a0,a0
ffffffffc020448c:	568000ef          	jal	ra,ffffffffc02049f4 <hash32>
ffffffffc0204490:	02051793          	slli	a5,a0,0x20
ffffffffc0204494:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0204498:	0000d797          	auipc	a5,0xd
ffffffffc020449c:	08078793          	addi	a5,a5,128 # ffffffffc0211518 <hash_list>
ffffffffc02044a0:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc02044a2:	6518                	ld	a4,8(a0)
ffffffffc02044a4:	00011797          	auipc	a5,0x11
ffffffffc02044a8:	08478793          	addi	a5,a5,132 # ffffffffc0215528 <proc_list>
ffffffffc02044ac:	0d848613          	addi	a2,s1,216
    prev->next = next->prev = elm;
ffffffffc02044b0:	e310                	sd	a2,0(a4)
    __list_add(elm, listelm, listelm->next);
ffffffffc02044b2:	6794                	ld	a3,8(a5)
    prev->next = next->prev = elm;
ffffffffc02044b4:	e510                	sd	a2,8(a0)
    elm->next = next;
ffffffffc02044b6:	f0f8                	sd	a4,224(s1)
    elm->prev = prev;
ffffffffc02044b8:	ece8                	sd	a0,216(s1)
    list_add(&proc_list, &(proc->list_link)); // 将进程加入进程列表
ffffffffc02044ba:	0c848713          	addi	a4,s1,200
    prev->next = next->prev = elm;
ffffffffc02044be:	e298                	sd	a4,0(a3)
    wakeup_proc(proc);
ffffffffc02044c0:	8526                	mv	a0,s1
    elm->next = next;
ffffffffc02044c2:	e8f4                	sd	a3,208(s1)
    elm->prev = prev;
ffffffffc02044c4:	e4fc                	sd	a5,200(s1)
    prev->next = next->prev = elm;
ffffffffc02044c6:	e798                	sd	a4,8(a5)
ffffffffc02044c8:	466000ef          	jal	ra,ffffffffc020492e <wakeup_proc>
    ret = proc->pid;
ffffffffc02044cc:	40c8                	lw	a0,4(s1)
}
...
ffffffffc02044e4:	00006297          	auipc	t0,0x6
ffffffffc02044e8:	b7828293          	addi	t0,t0,-1160 # ffffffffc020a05c <next_safe.0>
    return listelm->next;
ffffffffc02044ec:	00011597          	auipc	a1,0x11
ffffffffc02044f0:	03c58593          	addi	a1,a1,60 # ffffffffc0215528 <proc_list>
ffffffffc02044f4:	0085b383          	ld	t2,8(a1)
        next_safe = MAX_PID;
ffffffffc02044f8:	6789                	lui	a5,0x2
ffffffffc02044fa:	00f2a023          	sw	a5,0(t0)
ffffffffc02044fe:	862a                	mv	a2,a0
ffffffffc0204500:	4881                	li	a7,0
        while ((le = list_next(le)) != list) {
ffffffffc0204502:	6409                	lui	s0,0x2
ffffffffc0204504:	08b38263          	beq	t2,a1,ffffffffc0204588 <do_fork+0x1f8>
ffffffffc0204508:	8fc6                	mv	t6,a7
ffffffffc020450a:	879e                	mv	a5,t2
ffffffffc020450c:	6809                	lui	a6,0x2
ffffffffc020450e:	a811                	j	ffffffffc0204522 <do_fork+0x192>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc0204510:	00e65663          	bge	a2,a4,ffffffffc020451c <do_fork+0x18c>
ffffffffc0204514:	01075463          	bge	a4,a6,ffffffffc020451c <do_fork+0x18c>
ffffffffc0204518:	883a                	mv	a6,a4
ffffffffc020451a:	4f85                	li	t6,1
ffffffffc020451c:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020451e:	00b78d63          	beq	a5,a1,ffffffffc0204538 <do_fork+0x1a8>
            if (proc->pid == last_pid) {
ffffffffc0204522:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc0204526:	fec715e3          	bne	a4,a2,ffffffffc0204510 <do_fork+0x180>
                if (++ last_pid >= next_safe) {
ffffffffc020452a:	2605                	addiw	a2,a2,1
ffffffffc020452c:	05065963          	bge	a2,a6,ffffffffc020457e <do_fork+0x1ee>
ffffffffc0204530:	679c                	ld	a5,8(a5)
ffffffffc0204532:	4885                	li	a7,1
        while ((le = list_next(le)) != list) {
ffffffffc0204534:	feb797e3          	bne	a5,a1,ffffffffc0204522 <do_fork+0x192>
ffffffffc0204538:	00088563          	beqz	a7,ffffffffc0204542 <do_fork+0x1b2>
ffffffffc020453c:	00c32023          	sw	a2,0(t1)
ffffffffc0204540:	8532                	mv	a0,a2
ffffffffc0204542:	f40f80e3          	beqz	t6,ffffffffc0204482 <do_fork+0xf2>
ffffffffc0204546:	0102a023          	sw	a6,0(t0)
ffffffffc020454a:	bf25                	j	ffffffffc0204482 <do_fork+0xf2>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020454c:	893a                	mv	s2,a4
ffffffffc020454e:	bded                	j	ffffffffc0204448 <do_fork+0xb8>
    assert(current->mm == NULL);
ffffffffc0204550:	00011797          	auipc	a5,0x11
ffffffffc0204554:	0607b783          	ld	a5,96(a5) # ffffffffc02155b0 <current>
ffffffffc0204558:	779c                	ld	a5,40(a5)
ffffffffc020455a:	ea0786e3          	beqz	a5,ffffffffc0204406 <do_fork+0x76>
ffffffffc020455e:	00002697          	auipc	a3,0x2
ffffffffc0204562:	6ca68693          	addi	a3,a3,1738 # ffffffffc0206c28 <default_pmm_manager+0x1010>
ffffffffc0204566:	00001617          	auipc	a2,0x1
ffffffffc020456a:	30260613          	addi	a2,a2,770 # ffffffffc0205868 <commands+0x738>
ffffffffc020456e:	10200593          	li	a1,258
ffffffffc0204572:	00002517          	auipc	a0,0x2
ffffffffc0204576:	6ce50513          	addi	a0,a0,1742 # ffffffffc0206c40 <default_pmm_manager+0x1028>
ffffffffc020457a:	ecdfb0ef          	jal	ra,ffffffffc0200446 <__panic>
                    if (last_pid >= MAX_PID) {
ffffffffc020457e:	00864363          	blt	a2,s0,ffffffffc0204584 <do_fork+0x1f4>
                        last_pid = 1;
ffffffffc0204582:	4605                	li	a2,1
                    goto repeat;
ffffffffc0204584:	4885                	li	a7,1
ffffffffc0204586:	bfbd                	j	ffffffffc0204504 <do_fork+0x174>
ffffffffc0204588:	02088863          	beqz	a7,ffffffffc02045b8 <do_fork+0x228>
ffffffffc020458c:	00c32023          	sw	a2,0(t1)
    return last_pid;
ffffffffc0204590:	8532                	mv	a0,a2
ffffffffc0204592:	bdc5                	j	ffffffffc0204482 <do_fork+0xf2>
    return pa2page(PADDR(kva));
ffffffffc0204594:	c02007b7          	lui	a5,0xc0200
ffffffffc0204598:	02f6e363          	bltu	a3,a5,ffffffffc02045be <do_fork+0x22e>
    return &pages[PPN(pa) - nbase];
ffffffffc020459c:	41df0533          	sub	a0,t5,t4
ffffffffc02045a0:	051a                	slli	a0,a0,0x6
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc02045a2:	4589                	li	a1,2
ffffffffc02045a4:	9572                	add	a0,a0,t3
ffffffffc02045a6:	d18fd0ef          	jal	ra,ffffffffc0201abe <free_pages>
    kfree(proc);
ffffffffc02045aa:	8526                	mv	a0,s1
ffffffffc02045ac:	b52fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc02045b0:	5571                	li	a0,-4
    return ret;
ffffffffc02045b2:	bf31                	j	ffffffffc02044ce <do_fork+0x13e>
    int ret = -E_NO_FREE_PROC;
ffffffffc02045b4:	556d                	li	a0,-5
}
ffffffffc02045b6:	8082                	ret
    return last_pid;
ffffffffc02045b8:	00032503          	lw	a0,0(t1)
ffffffffc02045bc:	b5d9                	j	ffffffffc0204482 <do_fork+0xf2>
    return pa2page(PADDR(kva));
ffffffffc02045be:	00001617          	auipc	a2,0x1
ffffffffc02045c2:	73a60613          	addi	a2,a2,1850 # ffffffffc0205cf8 <default_pmm_manager+0xe0>
ffffffffc02045c6:	06e00593          	li	a1,110
ffffffffc02045ca:	00001517          	auipc	a0,0x1
ffffffffc02045ce:	6ae50513          	addi	a0,a0,1710 # ffffffffc0205c78 <default_pmm_manager+0x60>
ffffffffc02045d2:	e75fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc02045d6:	00001617          	auipc	a2,0x1
ffffffffc02045da:	67a60613          	addi	a2,a2,1658 # ffffffffc0205c50 <default_pmm_manager+0x38>
ffffffffc02045de:	06900593          	li	a1,105
ffffffffc02045e2:	00001517          	auipc	a0,0x1
ffffffffc02045e6:	69650513          	addi	a0,a0,1686 # ffffffffc0205c78 <default_pmm_manager+0x60>
ffffffffc02045ea:	e5dfb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02045ee <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc02045ee:	7129                	addi	sp,sp,-320
ffffffffc02045f0:	fa22                	sd	s0,304(sp)
ffffffffc02045f2:	f626                	sd	s1,296(sp)
ffffffffc02045f4:	f24a                	sd	s2,288(sp)
ffffffffc02045f6:	84ae                	mv	s1,a1
ffffffffc02045f8:	892a                	mv	s2,a0
ffffffffc02045fa:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02045fc:	4581                	li	a1,0
ffffffffc02045fe:	12000613          	li	a2,288
ffffffffc0204602:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc0204604:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0204606:	06f000ef          	jal	ra,ffffffffc0204e74 <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc020460a:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc020460c:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc020460e:	100027f3          	csrr	a5,sstatus
ffffffffc0204612:	edd7f793          	andi	a5,a5,-291
ffffffffc0204616:	1207e793          	ori	a5,a5,288
ffffffffc020461a:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020461c:	860a                	mv	a2,sp
ffffffffc020461e:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0204622:	00000797          	auipc	a5,0x0
ffffffffc0204626:	c2278793          	addi	a5,a5,-990 # ffffffffc0204244 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020462a:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc020462c:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc020462e:	d63ff0ef          	jal	ra,ffffffffc0204390 <do_fork>
}
ffffffffc0204632:	70f2                	ld	ra,312(sp)
ffffffffc0204634:	7452                	ld	s0,304(sp)
ffffffffc0204636:	74b2                	ld	s1,296(sp)
ffffffffc0204638:	7912                	ld	s2,288(sp)
ffffffffc020463a:	6131                	addi	sp,sp,320
ffffffffc020463c:	8082                	ret

ffffffffc020463e <do_exit>:
do_exit(int error_code) {
ffffffffc020463e:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc0204640:	00002617          	auipc	a2,0x2
ffffffffc0204644:	61860613          	addi	a2,a2,1560 # ffffffffc0206c58 <default_pmm_manager+0x1040>
ffffffffc0204648:	17000593          	li	a1,368
ffffffffc020464c:	00002517          	auipc	a0,0x2
ffffffffc0204650:	5f450513          	addi	a0,a0,1524 # ffffffffc0206c40 <default_pmm_manager+0x1028>
do_exit(int error_code) {
...
ffffffffc020468e:	bbfff0ef          	jal	ra,ffffffffc020424c <alloc_proc>
...
ffffffffc02046b0:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046b2:	7c2000ef          	jal	ra,ffffffffc0204e74 <memset>
...
ffffffffc02046c4:	7da000ef          	jal	ra,ffffffffc0204e9e <memcmp>
...
ffffffffc02046d4:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc02046d6:	79e000ef          	jal	ra,ffffffffc0204e74 <memset>
...
ffffffffc02046e6:	7b8000ef          	jal	ra,ffffffffc0204e9e <memcmp>
...
ffffffffc0204718:	75c000ef          	jal	ra,ffffffffc0204e74 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc020471c:	463d                	li	a2,15
ffffffffc020471e:	00002597          	auipc	a1,0x2
ffffffffc0204722:	58258593          	addi	a1,a1,1410 # ffffffffc0206ca0 <default_pmm_manager+0x1088>
ffffffffc0204726:	8522                	mv	a0,s0
ffffffffc0204728:	75e000ef          	jal	ra,ffffffffc0204e86 <memcpy>
...
ffffffffc0204742:	56a58593          	addi	a1,a1,1386 # ffffffffc0206ca8 <default_pmm_manager+0x1090>
ffffffffc0204746:	00000517          	auipc	a0,0x0
ffffffffc020474a:	b7650513          	addi	a0,a0,-1162 # ffffffffc02042bc <init_main>
    nr_process ++;
...
ffffffffc0204754:	e6d7b023          	sd	a3,-416(a5) # ffffffffc02155b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204758:	e97ff0ef          	jal	ra,ffffffffc02045ee <kernel_thread>
ffffffffc020475c:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc020475e:	0ea05963          	blez	a0,ffffffffc0204850 <proc_init+0x1f6>
...
ffffffffc0204772:	282000ef          	jal	ra,ffffffffc02049f4 <hash32>
...
ffffffffc02047a6:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047a8:	6cc000ef          	jal	ra,ffffffffc0204e74 <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02047ac:	463d                	li	a2,15
ffffffffc02047ae:	00002597          	auipc	a1,0x2
ffffffffc02047b2:	52a58593          	addi	a1,a1,1322 # ffffffffc0206cd8 <default_pmm_manager+0x10c0>
ffffffffc02047b6:	8526                	mv	a0,s1
ffffffffc02047b8:	6ce000ef          	jal	ra,ffffffffc0204e86 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc02047bc:	00093783          	ld	a5,0(s2)
ffffffffc02047c0:	c7e1                	beqz	a5,ffffffffc0204888 <proc_init+0x22e>
ffffffffc02047c2:	43dc                	lw	a5,4(a5)
ffffffffc02047c4:	e3f1                	bnez	a5,ffffffffc0204888 <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02047c6:	601c                	ld	a5,0(s0)
ffffffffc02047c8:	c3c5                	beqz	a5,ffffffffc0204868 <proc_init+0x20e>
ffffffffc02047ca:	43d8                	lw	a4,4(a5)
ffffffffc02047cc:	4785                	li	a5,1
ffffffffc02047ce:	08f71d63          	bne	a4,a5,ffffffffc0204868 <proc_init+0x20e>
}
...
ffffffffc0204824:	46850513          	addi	a0,a0,1128 # ffffffffc0206c88 <default_pmm_manager+0x1070>
...
ffffffffc020483c:	43860613          	addi	a2,a2,1080 # ffffffffc0206c70 <default_pmm_manager+0x1058>
ffffffffc0204840:	18800593          	li	a1,392
ffffffffc0204844:	00002517          	auipc	a0,0x2
ffffffffc0204848:	3fc50513          	addi	a0,a0,1020 # ffffffffc0206c40 <default_pmm_manager+0x1028>
ffffffffc020484c:	bfbfb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc0204850:	00002617          	auipc	a2,0x2
ffffffffc0204854:	46860613          	addi	a2,a2,1128 # ffffffffc0206cb8 <default_pmm_manager+0x10a0>
ffffffffc0204858:	1a800593          	li	a1,424
ffffffffc020485c:	00002517          	auipc	a0,0x2
ffffffffc0204860:	3e450513          	addi	a0,a0,996 # ffffffffc0206c40 <default_pmm_manager+0x1028>
ffffffffc0204864:	be3fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204868:	00002697          	auipc	a3,0x2
ffffffffc020486c:	4a068693          	addi	a3,a3,1184 # ffffffffc0206d08 <default_pmm_manager+0x10f0>
ffffffffc0204870:	00001617          	auipc	a2,0x1
ffffffffc0204874:	ff860613          	addi	a2,a2,-8 # ffffffffc0205868 <commands+0x738>
ffffffffc0204878:	1af00593          	li	a1,431
ffffffffc020487c:	00002517          	auipc	a0,0x2
ffffffffc0204880:	3c450513          	addi	a0,a0,964 # ffffffffc0206c40 <default_pmm_manager+0x1028>
ffffffffc0204884:	bc3fb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204888:	00002697          	auipc	a3,0x2
ffffffffc020488c:	45868693          	addi	a3,a3,1112 # ffffffffc0206ce0 <default_pmm_manager+0x10c8>
ffffffffc0204890:	00001617          	auipc	a2,0x1
ffffffffc0204894:	fd860613          	addi	a2,a2,-40 # ffffffffc0205868 <commands+0x738>
ffffffffc0204898:	1ae00593          	li	a1,430
ffffffffc020489c:	00002517          	auipc	a0,0x2
ffffffffc02048a0:	3a450513          	addi	a0,a0,932 # ffffffffc0206c40 <default_pmm_manager+0x1028>
ffffffffc02048a4:	ba3fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02048a8 <cpu_idle>:
...
ffffffffc02048ae:	00011417          	auipc	s0,0x11
ffffffffc02048b2:	d0240413          	addi	s0,s0,-766 # ffffffffc02155b0 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc02048b6:	6018                	ld	a4,0(s0)
ffffffffc02048b8:	4f1c                	lw	a5,24(a4)
ffffffffc02048ba:	2781                	sext.w	a5,a5
ffffffffc02048bc:	dff5                	beqz	a5,ffffffffc02048b8 <cpu_idle+0x10>
            schedule();
ffffffffc02048be:	0a2000ef          	jal	ra,ffffffffc0204960 <schedule>
ffffffffc02048c2:	bfd5                	j	ffffffffc02048b6 <cpu_idle+0xe>
...
ffffffffc0204944:	3f068693          	addi	a3,a3,1008 # ffffffffc0206d30 <default_pmm_manager+0x1118>
ffffffffc0204948:	00001617          	auipc	a2,0x1
ffffffffc020494c:	f2060613          	addi	a2,a2,-224 # ffffffffc0205868 <commands+0x738>
ffffffffc0204950:	45a5                	li	a1,9
ffffffffc0204952:	00002517          	auipc	a0,0x2
ffffffffc0204956:	41e50513          	addi	a0,a0,1054 # ffffffffc0206d70 <default_pmm_manager+0x1158>
wakeup_proc(struct proc_struct *proc) {
ffffffffc020495a:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc020495c:	aebfb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc0204970:	00011897          	auipc	a7,0x11
ffffffffc0204974:	c408b883          	ld	a7,-960(a7) # ffffffffc02155b0 <current>
ffffffffc0204978:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc020497c:	00011517          	auipc	a0,0x11
ffffffffc0204980:	c3c53503          	ld	a0,-964(a0) # ffffffffc02155b8 <idleproc>
ffffffffc0204984:	04a88e63          	beq	a7,a0,ffffffffc02049e0 <schedule+0x80>
ffffffffc0204988:	0c888693          	addi	a3,a7,200
ffffffffc020498c:	00011617          	auipc	a2,0x11
ffffffffc0204990:	b9c60613          	addi	a2,a2,-1124 # ffffffffc0215528 <proc_list>
        le = last;
...
ffffffffc02049b8:	00a88463          	beq	a7,a0,ffffffffc02049c0 <schedule+0x60>
            proc_run(next);
ffffffffc02049bc:	973ff0ef          	jal	ra,ffffffffc020432e <proc_run>
    if (flag) {
...
ffffffffc02049da:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc02049dc:	be1fb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049e0:	00011617          	auipc	a2,0x11
ffffffffc02049e4:	b4860613          	addi	a2,a2,-1208 # ffffffffc0215528 <proc_list>
ffffffffc02049e8:	86b2                	mv	a3,a2
ffffffffc02049ea:	b76d                	j	ffffffffc0204994 <schedule+0x34>
        intr_disable();
ffffffffc02049ec:	bd7fb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
...
ffffffffc02049fa:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc02049fe:	02000793          	li	a5,32
ffffffffc0204a02:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a04:	00f5553b          	srlw	a0,a0,a5
...
ffffffffc0204a2c:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204a2e:	03067e63          	bgeu	a2,a6,ffffffffc0204a6a <printnum+0x60>
...
ffffffffc0204a48:	34478793          	addi	a5,a5,836 # ffffffffc0206d88 <default_pmm_manager+0x1170>
ffffffffc0204a4c:	020a5a13          	srli	s4,s4,0x20
...
ffffffffc0204a7c:	ecce                	sd	s3,88(sp)
ffffffffc0204a7e:	e8d2                	sd	s4,80(sp)
ffffffffc0204a80:	e4d6                	sd	s5,72(sp)
ffffffffc0204a82:	e0da                	sd	s6,64(sp)
ffffffffc0204a84:	fc5e                	sd	s7,56(sp)
ffffffffc0204a86:	f06a                	sd	s10,32(sp)
ffffffffc0204a88:	fc86                	sd	ra,120(sp)
ffffffffc0204a8a:	f8a2                	sd	s0,112(sp)
ffffffffc0204a8c:	f862                	sd	s8,48(sp)
...
ffffffffc0204a98:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204a9a:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204a9e:	5b7d                	li	s6,-1
ffffffffc0204aa0:	00002a97          	auipc	s5,0x2
ffffffffc0204aa4:	314a8a93          	addi	s5,s5,788 # ffffffffc0206db4 <default_pmm_manager+0x119c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204aa8:	00002b97          	auipc	s7,0x2
ffffffffc0204aac:	4e8b8b93          	addi	s7,s7,1256 # ffffffffc0206f90 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204ab0:	000d4503          	lbu	a0,0(s10)
ffffffffc0204ab4:	001d0413          	addi	s0,s10,1
ffffffffc0204ab8:	01350a63          	beq	a0,s3,ffffffffc0204acc <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204abc:	c121                	beqz	a0,ffffffffc0204afc <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0204abe:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204ac0:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0204ac2:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204ac4:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204ac8:	ff351ae3          	bne	a0,s3,ffffffffc0204abc <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204acc:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204ad0:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204ad4:	4c81                	li	s9,0
ffffffffc0204ad6:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204ad8:	5c7d                	li	s8,-1
ffffffffc0204ada:	5dfd                	li	s11,-1
ffffffffc0204adc:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204ae0:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ae2:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204ae6:	0ff5f593          	zext.b	a1,a1
ffffffffc0204aea:	00140d13          	addi	s10,s0,1
ffffffffc0204aee:	04b56263          	bltu	a0,a1,ffffffffc0204b32 <vprintfmt+0xbc>
ffffffffc0204af2:	058a                	slli	a1,a1,0x2
ffffffffc0204af4:	95d6                	add	a1,a1,s5
ffffffffc0204af6:	4194                	lw	a3,0(a1)
ffffffffc0204af8:	96d6                	add	a3,a3,s5
ffffffffc0204afa:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204afc:	70e6                	ld	ra,120(sp)
ffffffffc0204afe:	7446                	ld	s0,112(sp)
ffffffffc0204b00:	74a6                	ld	s1,104(sp)
ffffffffc0204b02:	7906                	ld	s2,96(sp)
ffffffffc0204b04:	69e6                	ld	s3,88(sp)
ffffffffc0204b06:	6a46                	ld	s4,80(sp)
ffffffffc0204b08:	6aa6                	ld	s5,72(sp)
ffffffffc0204b0a:	6b06                	ld	s6,64(sp)
ffffffffc0204b0c:	7be2                	ld	s7,56(sp)
ffffffffc0204b0e:	7c42                	ld	s8,48(sp)
ffffffffc0204b10:	7ca2                	ld	s9,40(sp)
ffffffffc0204b12:	7d02                	ld	s10,32(sp)
ffffffffc0204b14:	6de2                	ld	s11,24(sp)
ffffffffc0204b16:	6109                	addi	sp,sp,128
ffffffffc0204b18:	8082                	ret
            padc = '0';
ffffffffc0204b1a:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204b1c:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b20:	846a                	mv	s0,s10
ffffffffc0204b22:	00140d13          	addi	s10,s0,1
ffffffffc0204b26:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b2a:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b2e:	fcb572e3          	bgeu	a0,a1,ffffffffc0204af2 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204b32:	85a6                	mv	a1,s1
ffffffffc0204b34:	02500513          	li	a0,37
ffffffffc0204b38:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204b3a:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204b3e:	8d22                	mv	s10,s0
ffffffffc0204b40:	f73788e3          	beq	a5,s3,ffffffffc0204ab0 <vprintfmt+0x3a>
ffffffffc0204b44:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204b48:	1d7d                	addi	s10,s10,-1
ffffffffc0204b4a:	ff379de3          	bne	a5,s3,ffffffffc0204b44 <vprintfmt+0xce>
ffffffffc0204b4e:	b78d                	j	ffffffffc0204ab0 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204b50:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204b54:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b58:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204b5a:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204b5e:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b62:	02d86463          	bltu	a6,a3,ffffffffc0204b8a <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204b66:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204b6a:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204b6e:	0186873b          	addw	a4,a3,s8
ffffffffc0204b72:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204b76:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204b78:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204b7c:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204b7e:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204b82:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204b86:	fed870e3          	bgeu	a6,a3,ffffffffc0204b66 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204b8a:	f40ddce3          	bgez	s11,ffffffffc0204ae2 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204b8e:	8de2                	mv	s11,s8
ffffffffc0204b90:	5c7d                	li	s8,-1
ffffffffc0204b92:	bf81                	j	ffffffffc0204ae2 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204b94:	fffdc693          	not	a3,s11
ffffffffc0204b98:	96fd                	srai	a3,a3,0x3f
ffffffffc0204b9a:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b9e:	00144603          	lbu	a2,1(s0)
ffffffffc0204ba2:	2d81                	sext.w	s11,s11
ffffffffc0204ba4:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204ba6:	bf35                	j	ffffffffc0204ae2 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204ba8:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bac:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204bb0:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bb2:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204bb4:	bfd9                	j	ffffffffc0204b8a <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204bb6:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204bb8:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204bbc:	01174463          	blt	a4,a7,ffffffffc0204bc4 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204bc0:	1a088e63          	beqz	a7,ffffffffc0204d7c <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204bc4:	000a3603          	ld	a2,0(s4)
ffffffffc0204bc8:	46c1                	li	a3,16
ffffffffc0204bca:	8a2e                	mv	s4,a1
...
ffffffffc0204bd4:	e37ff0ef          	jal	ra,ffffffffc0204a0a <printnum>
            break;
ffffffffc0204bd8:	bde1                	j	ffffffffc0204ab0 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204bda:	000a2503          	lw	a0,0(s4)
ffffffffc0204bde:	85a6                	mv	a1,s1
ffffffffc0204be0:	0a21                	addi	s4,s4,8
ffffffffc0204be2:	9902                	jalr	s2
            break;
ffffffffc0204be4:	b5f1                	j	ffffffffc0204ab0 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204be6:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204be8:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204bec:	01174463          	blt	a4,a7,ffffffffc0204bf4 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204bf0:	18088163          	beqz	a7,ffffffffc0204d72 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204bf4:	000a3603          	ld	a2,0(s4)
ffffffffc0204bf8:	46a9                	li	a3,10
ffffffffc0204bfa:	8a2e                	mv	s4,a1
ffffffffc0204bfc:	bfc1                	j	ffffffffc0204bcc <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bfe:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204c02:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c04:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c06:	bdf1                	j	ffffffffc0204ae2 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204c08:	85a6                	mv	a1,s1
ffffffffc0204c0a:	02500513          	li	a0,37
ffffffffc0204c0e:	9902                	jalr	s2
            break;
ffffffffc0204c10:	b545                	j	ffffffffc0204ab0 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c12:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204c16:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c18:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c1a:	b5e1                	j	ffffffffc0204ae2 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204c1c:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c1e:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c22:	01174463          	blt	a4,a7,ffffffffc0204c2a <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204c26:	14088163          	beqz	a7,ffffffffc0204d68 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204c2a:	000a3603          	ld	a2,0(s4)
ffffffffc0204c2e:	46a1                	li	a3,8
ffffffffc0204c30:	8a2e                	mv	s4,a1
ffffffffc0204c32:	bf69                	j	ffffffffc0204bcc <vprintfmt+0x156>
            putch('0', putdat);
...
ffffffffc0204c46:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204c48:	6782                	ld	a5,0(sp)
ffffffffc0204c4a:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c4c:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204c50:	bfb5                	j	ffffffffc0204bcc <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c52:	000a3403          	ld	s0,0(s4)
ffffffffc0204c56:	008a0713          	addi	a4,s4,8
ffffffffc0204c5a:	e03a                	sd	a4,0(sp)
ffffffffc0204c5c:	14040263          	beqz	s0,ffffffffc0204da0 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204c60:	0fb05763          	blez	s11,ffffffffc0204d4e <vprintfmt+0x2d8>
ffffffffc0204c64:	02d00693          	li	a3,45
ffffffffc0204c68:	0cd79163          	bne	a5,a3,ffffffffc0204d2a <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c6c:	00044783          	lbu	a5,0(s0)
ffffffffc0204c70:	0007851b          	sext.w	a0,a5
ffffffffc0204c74:	cf85                	beqz	a5,ffffffffc0204cac <vprintfmt+0x236>
ffffffffc0204c76:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c7a:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c7e:	000c4563          	bltz	s8,ffffffffc0204c88 <vprintfmt+0x212>
ffffffffc0204c82:	3c7d                	addiw	s8,s8,-1
ffffffffc0204c84:	036c0263          	beq	s8,s6,ffffffffc0204ca8 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204c88:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c8a:	0e0c8e63          	beqz	s9,ffffffffc0204d86 <vprintfmt+0x310>
ffffffffc0204c8e:	3781                	addiw	a5,a5,-32
ffffffffc0204c90:	0ef47b63          	bgeu	s0,a5,ffffffffc0204d86 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204c94:	03f00513          	li	a0,63
ffffffffc0204c98:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c9a:	000a4783          	lbu	a5,0(s4)
ffffffffc0204c9e:	3dfd                	addiw	s11,s11,-1
ffffffffc0204ca0:	0a05                	addi	s4,s4,1
ffffffffc0204ca2:	0007851b          	sext.w	a0,a5
ffffffffc0204ca6:	ffe1                	bnez	a5,ffffffffc0204c7e <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204ca8:	01b05963          	blez	s11,ffffffffc0204cba <vprintfmt+0x244>
...
ffffffffc0204cb4:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204cb6:	fe0d9be3          	bnez	s11,ffffffffc0204cac <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204cba:	6a02                	ld	s4,0(sp)
ffffffffc0204cbc:	bbd5                	j	ffffffffc0204ab0 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204cbe:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204cc0:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204cc4:	01174463          	blt	a4,a7,ffffffffc0204ccc <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204cc8:	08088d63          	beqz	a7,ffffffffc0204d62 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204ccc:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204cd0:	0a044d63          	bltz	s0,ffffffffc0204d8a <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204cd4:	8622                	mv	a2,s0
ffffffffc0204cd6:	8a66                	mv	s4,s9
ffffffffc0204cd8:	46a9                	li	a3,10
ffffffffc0204cda:	bdcd                	j	ffffffffc0204bcc <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204cdc:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204ce0:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204ce2:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204ce4:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204ce8:	8fb5                	xor	a5,a5,a3
ffffffffc0204cea:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204cee:	02d74163          	blt	a4,a3,ffffffffc0204d10 <vprintfmt+0x29a>
ffffffffc0204cf2:	00369793          	slli	a5,a3,0x3
ffffffffc0204cf6:	97de                	add	a5,a5,s7
ffffffffc0204cf8:	639c                	ld	a5,0(a5)
ffffffffc0204cfa:	cb99                	beqz	a5,ffffffffc0204d10 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204cfc:	86be                	mv	a3,a5
ffffffffc0204cfe:	00000617          	auipc	a2,0x0
ffffffffc0204d02:	1f260613          	addi	a2,a2,498 # ffffffffc0204ef0 <etext+0x2e>
ffffffffc0204d06:	85a6                	mv	a1,s1
ffffffffc0204d08:	854a                	mv	a0,s2
ffffffffc0204d0a:	0ce000ef          	jal	ra,ffffffffc0204dd8 <printfmt>
ffffffffc0204d0e:	b34d                	j	ffffffffc0204ab0 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d10:	00002617          	auipc	a2,0x2
ffffffffc0204d14:	09860613          	addi	a2,a2,152 # ffffffffc0206da8 <default_pmm_manager+0x1190>
ffffffffc0204d18:	85a6                	mv	a1,s1
ffffffffc0204d1a:	854a                	mv	a0,s2
ffffffffc0204d1c:	0bc000ef          	jal	ra,ffffffffc0204dd8 <printfmt>
ffffffffc0204d20:	bb41                	j	ffffffffc0204ab0 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204d22:	00002417          	auipc	s0,0x2
ffffffffc0204d26:	07e40413          	addi	s0,s0,126 # ffffffffc0206da0 <default_pmm_manager+0x1188>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d2a:	85e2                	mv	a1,s8
ffffffffc0204d2c:	8522                	mv	a0,s0
ffffffffc0204d2e:	e43e                	sd	a5,8(sp)
ffffffffc0204d30:	0e2000ef          	jal	ra,ffffffffc0204e12 <strnlen>
ffffffffc0204d34:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204d38:	01b05b63          	blez	s11,ffffffffc0204d4e <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204d3c:	67a2                	ld	a5,8(sp)
ffffffffc0204d3e:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d42:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204d44:	85a6                	mv	a1,s1
ffffffffc0204d46:	8552                	mv	a0,s4
ffffffffc0204d48:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d4a:	fe0d9ce3          	bnez	s11,ffffffffc0204d42 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d4e:	00044783          	lbu	a5,0(s0)
ffffffffc0204d52:	00140a13          	addi	s4,s0,1
ffffffffc0204d56:	0007851b          	sext.w	a0,a5
ffffffffc0204d5a:	d3a5                	beqz	a5,ffffffffc0204cba <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204d5c:	05e00413          	li	s0,94
ffffffffc0204d60:	bf39                	j	ffffffffc0204c7e <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204d62:	000a2403          	lw	s0,0(s4)
ffffffffc0204d66:	b7ad                	j	ffffffffc0204cd0 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204d68:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d6c:	46a1                	li	a3,8
ffffffffc0204d6e:	8a2e                	mv	s4,a1
ffffffffc0204d70:	bdb1                	j	ffffffffc0204bcc <vprintfmt+0x156>
ffffffffc0204d72:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d76:	46a9                	li	a3,10
ffffffffc0204d78:	8a2e                	mv	s4,a1
ffffffffc0204d7a:	bd89                	j	ffffffffc0204bcc <vprintfmt+0x156>
ffffffffc0204d7c:	000a6603          	lwu	a2,0(s4)
ffffffffc0204d80:	46c1                	li	a3,16
ffffffffc0204d82:	8a2e                	mv	s4,a1
ffffffffc0204d84:	b5a1                	j	ffffffffc0204bcc <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204d86:	9902                	jalr	s2
ffffffffc0204d88:	bf09                	j	ffffffffc0204c9a <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204d8a:	85a6                	mv	a1,s1
ffffffffc0204d8c:	02d00513          	li	a0,45
ffffffffc0204d90:	e03e                	sd	a5,0(sp)
ffffffffc0204d92:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204d94:	6782                	ld	a5,0(sp)
ffffffffc0204d96:	8a66                	mv	s4,s9
ffffffffc0204d98:	40800633          	neg	a2,s0
ffffffffc0204d9c:	46a9                	li	a3,10
ffffffffc0204d9e:	b53d                	j	ffffffffc0204bcc <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204da0:	03b05163          	blez	s11,ffffffffc0204dc2 <vprintfmt+0x34c>
ffffffffc0204da4:	02d00693          	li	a3,45
ffffffffc0204da8:	f6d79de3          	bne	a5,a3,ffffffffc0204d22 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204dac:	00002417          	auipc	s0,0x2
ffffffffc0204db0:	ff440413          	addi	s0,s0,-12 # ffffffffc0206da0 <default_pmm_manager+0x1188>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204db4:	02800793          	li	a5,40
ffffffffc0204db8:	02800513          	li	a0,40
ffffffffc0204dbc:	00140a13          	addi	s4,s0,1
ffffffffc0204dc0:	bd6d                	j	ffffffffc0204c7a <vprintfmt+0x204>
ffffffffc0204dc2:	00002a17          	auipc	s4,0x2
ffffffffc0204dc6:	fdfa0a13          	addi	s4,s4,-33 # ffffffffc0206da1 <default_pmm_manager+0x1189>
ffffffffc0204dca:	02800513          	li	a0,40
ffffffffc0204dce:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204dd2:	05e00413          	li	s0,94
ffffffffc0204dd6:	b565                	j	ffffffffc0204c7e <vprintfmt+0x208>

ffffffffc0204dd8 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204dd8:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204dda:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204dde:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204de0:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204de2:	ec06                	sd	ra,24(sp)
ffffffffc0204de4:	f83a                	sd	a4,48(sp)
ffffffffc0204de6:	fc3e                	sd	a5,56(sp)
ffffffffc0204de8:	e0c2                	sd	a6,64(sp)
ffffffffc0204dea:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204dec:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204dee:	c89ff0ef          	jal	ra,ffffffffc0204a76 <vprintfmt>
}
ffffffffc0204df2:	60e2                	ld	ra,24(sp)
ffffffffc0204df4:	6161                	addi	sp,sp,80
ffffffffc0204df6:	8082                	ret

ffffffffc0204df8 <strlen>:
...
strlen(const char *s) {
ffffffffc0204dfc:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204dfe:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204e00:	cb81                	beqz	a5,ffffffffc0204e10 <strlen+0x18>
        cnt ++;
ffffffffc0204e02:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204e04:	00a707b3          	add	a5,a4,a0
ffffffffc0204e08:	0007c783          	lbu	a5,0(a5)
ffffffffc0204e0c:	fbfd                	bnez	a5,ffffffffc0204e02 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204e12:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e14:	e589                	bnez	a1,ffffffffc0204e1e <strnlen+0xc>
ffffffffc0204e16:	a811                	j	ffffffffc0204e2a <strnlen+0x18>
        cnt ++;
ffffffffc0204e18:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e1a:	00f58863          	beq	a1,a5,ffffffffc0204e2a <strnlen+0x18>
ffffffffc0204e1e:	00f50733          	add	a4,a0,a5
ffffffffc0204e22:	00074703          	lbu	a4,0(a4)
ffffffffc0204e26:	fb6d                	bnez	a4,ffffffffc0204e18 <strnlen+0x6>
ffffffffc0204e28:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204e2a:	852e                	mv	a0,a1
ffffffffc0204e2c:	8082                	ret

ffffffffc0204e2e <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0204e2e:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204e30:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e34:	0785                	addi	a5,a5,1
ffffffffc0204e36:	0585                	addi	a1,a1,1
ffffffffc0204e38:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204e3c:	fb75                	bnez	a4,ffffffffc0204e30 <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e40:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e44:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e48:	cb89                	beqz	a5,ffffffffc0204e5a <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204e4a:	0505                	addi	a0,a0,1
ffffffffc0204e4c:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e4e:	fee789e3          	beq	a5,a4,ffffffffc0204e40 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e52:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204e56:	9d19                	subw	a0,a0,a4
ffffffffc0204e58:	8082                	ret
ffffffffc0204e5a:	4501                	li	a0,0
ffffffffc0204e5c:	bfed                	j	ffffffffc0204e56 <strcmp+0x16>

ffffffffc0204e5e <strchr>:
...
ffffffffc0204e62:	c799                	beqz	a5,ffffffffc0204e70 <strchr+0x12>
        if (*s == c) {
ffffffffc0204e64:	00f58763          	beq	a1,a5,ffffffffc0204e72 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204e68:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204e6c:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204e6e:	fbfd                	bnez	a5,ffffffffc0204e64 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204e74:	ca01                	beqz	a2,ffffffffc0204e84 <memset+0x10>
ffffffffc0204e76:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204e78:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204e7a:	0785                	addi	a5,a5,1
ffffffffc0204e7c:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204e80:	fec79de3          	bne	a5,a2,ffffffffc0204e7a <memset+0x6>
    }
    return s;
...
ffffffffc0204e86 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204e86:	ca19                	beqz	a2,ffffffffc0204e9c <memcpy+0x16>
...
ffffffffc0204e94:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204e98:	fec59ae3          	bne	a1,a2,ffffffffc0204e8c <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204e9e:	c205                	beqz	a2,ffffffffc0204ebe <memcmp+0x20>
ffffffffc0204ea0:	962e                	add	a2,a2,a1
ffffffffc0204ea2:	a019                	j	ffffffffc0204ea8 <memcmp+0xa>
ffffffffc0204ea4:	00c58d63          	beq	a1,a2,ffffffffc0204ebe <memcmp+0x20>
        if (*s1 != *s2) {
...
ffffffffc0204eb2:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204eb4:	fee788e3          	beq	a5,a4,ffffffffc0204ea4 <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
