...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200432:	3e700793          	li	a5,999
    80200436:	02e7e563          	bltu	a5,a4,80200460 <interrupt_handler+0x9c>
            break;
        default:
            print_trapframe(tf);
            break;
    ...
    80200446:	afe50513          	addi	a0,a0,-1282 # 80200f40 <etext+0x524>
    ...
    80200456:	ade50513          	addi	a0,a0,-1314 # 80200f30 <etext+0x514>
...
void exception_handler(struct trapframe *tf) {
    ...
    80200480:	02e79563          	bne	a5,a4,802004aa <exception_handler+0x42>
             /* LAB1 CHALLENGE3   2211630 :  */
            /*(1)输出指令异常类型（ Illegal instruction）
             *(2)输出异常指令地址
             *(3)更新 tf->epc寄存器
            */
            cprintf("Illegal instruction caught at 0x%08x\n", tf->epc);
    80200484:	10853583          	ld	a1,264(a0)
    80200488:	00001517          	auipc	a0,0x1
    8020048c:	b0850513          	addi	a0,a0,-1272 # 80200f90 <etext+0x574>
    ...
    802004ca:	b1a50513          	addi	a0,a0,-1254 # 80200fe0 <etext+0x5c4>
