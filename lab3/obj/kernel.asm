...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	3d6040ef          	jal	ra,ffffffffc0204420 <memset>

    const char *message = "(THU.CST) os is loading ...";
    cprintf("%s\n\n", message);
ffffffffc020004e:	00004597          	auipc	a1,0x4
ffffffffc0200052:	40258593          	addi	a1,a1,1026 # ffffffffc0204450 <etext+0x6>
ffffffffc0200056:	00004517          	auipc	a0,0x4
ffffffffc020005a:	41a50513          	addi	a0,a0,1050 # ffffffffc0204470 <etext+0x26>
...
ffffffffc020006e:	660030ef          	jal	ra,ffffffffc02036ce <vmm_init>
...
ffffffffc0200108:	37450513          	addi	a0,a0,884 # ffffffffc0204478 <etext+0x2e>
void print_kerninfo(void) {
...
ffffffffc020011e:	37e50513          	addi	a0,a0,894 # ffffffffc0204498 <etext+0x4e>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	32458593          	addi	a1,a1,804 # ffffffffc020444a <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	38a50513          	addi	a0,a0,906 # ffffffffc02044b8 <etext+0x6e>
...
ffffffffc0200146:	39650513          	addi	a0,a0,918 # ffffffffc02044d8 <etext+0x8e>
...
ffffffffc020015a:	3a250513          	addi	a0,a0,930 # ffffffffc02044f8 <etext+0xae>
...
ffffffffc0200188:	39450513          	addi	a0,a0,916 # ffffffffc0204518 <etext+0xce>
}
...
ffffffffc0200196:	3b660613          	addi	a2,a2,950 # ffffffffc0204548 <etext+0xfe>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	3c250513          	addi	a0,a0,962 # ffffffffc0204560 <etext+0x116>
void print_stackframe(void) {
...
ffffffffc02001b2:	3ca60613          	addi	a2,a2,970 # ffffffffc0204578 <etext+0x12e>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	3e258593          	addi	a1,a1,994 # ffffffffc0204598 <etext+0x14e>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	3e250513          	addi	a0,a0,994 # ffffffffc02045a0 <etext+0x156>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	3e460613          	addi	a2,a2,996 # ffffffffc02045b0 <etext+0x166>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	40458593          	addi	a1,a1,1028 # ffffffffc02045d8 <etext+0x18e>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	3c450513          	addi	a0,a0,964 # ffffffffc02045a0 <etext+0x156>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	40060613          	addi	a2,a2,1024 # ffffffffc02045e8 <etext+0x19e>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	41858593          	addi	a1,a1,1048 # ffffffffc0204608 <etext+0x1be>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	3a850513          	addi	a0,a0,936 # ffffffffc02045a0 <etext+0x156>
...
ffffffffc0200236:	3e650513          	addi	a0,a0,998 # ffffffffc0204618 <etext+0x1ce>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	3ec50513          	addi	a0,a0,1004 # ffffffffc0204640 <etext+0x1f6>
...
ffffffffc0200276:	84690913          	addi	s2,s2,-1978 # ffffffffc0205ab8 <default_pmm_manager+0x928>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020027a:	00004497          	auipc	s1,0x4
ffffffffc020027e:	3ee48493          	addi	s1,s1,1006 # ffffffffc0204668 <etext+0x21e>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	3ecb0b13          	addi	s6,s6,1004 # ffffffffc0204670 <etext+0x226>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	30ca0a13          	addi	s4,s4,780 # ffffffffc0204598 <etext+0x14e>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	058040ef          	jal	ra,ffffffffc02042f0 <readline>
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	130040ef          	jal	ra,ffffffffc02043ec <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	11c040ef          	jal	ra,ffffffffc02043ec <strcmp>
...
ffffffffc020030e:	0fc040ef          	jal	ra,ffffffffc020440a <strchr>
...
ffffffffc020034c:	0be040ef          	jal	ra,ffffffffc020440a <strchr>
...
ffffffffc020036a:	32a50513          	addi	a0,a0,810 # ffffffffc0204690 <etext+0x246>
...
ffffffffc02003bc:	25050513          	addi	a0,a0,592 # ffffffffc0205608 <default_pmm_manager+0x478>
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	77b030ef          	jal	ra,ffffffffc0204432 <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	757030ef          	jal	ra,ffffffffc0204432 <memcpy>
    return 0;
}
...
ffffffffc0200546:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200548:	75e0306f          	j	ffffffffc0203ca6 <do_pgfault>
    panic("unhandled page fault.\n");
...
ffffffffc020082a:	36250513          	addi	a0,a0,866 # ffffffffc0204b88 <commands+0x4e0>
...
ffffffffc020083e:	33e50513          	addi	a0,a0,830 # ffffffffc0204b78 <commands+0x4d0>
}
...
ffffffffc0200860:	53470713          	addi	a4,a4,1332 # ffffffffc0204d90 <commands+0x6e8>
...
ffffffffc0200872:	50a50513          	addi	a0,a0,1290 # ffffffffc0204d78 <commands+0x6d0>
...
ffffffffc0200894:	34850513          	addi	a0,a0,840 # ffffffffc0204bd8 <commands+0x530>
}
...
ffffffffc02008a8:	35450513          	addi	a0,a0,852 # ffffffffc0204bf8 <commands+0x550>
ffffffffc02008ac:	b7f5                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Illegal instruction\n");
ffffffffc02008ae:	00004517          	auipc	a0,0x4
ffffffffc02008b2:	36a50513          	addi	a0,a0,874 # ffffffffc0204c18 <commands+0x570>
ffffffffc02008b6:	b7cd                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Breakpoint\n");
ffffffffc02008b8:	00004517          	auipc	a0,0x4
ffffffffc02008bc:	37850513          	addi	a0,a0,888 # ffffffffc0204c30 <commands+0x588>
ffffffffc02008c0:	bfe1                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load address misaligned\n");
ffffffffc02008c2:	00004517          	auipc	a0,0x4
ffffffffc02008c6:	37e50513          	addi	a0,a0,894 # ffffffffc0204c40 <commands+0x598>
ffffffffc02008ca:	b7f9                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc02008cc:	00004517          	auipc	a0,0x4
ffffffffc02008d0:	39450513          	addi	a0,a0,916 # ffffffffc0204c60 <commands+0x5b8>
...
ffffffffc02008ee:	38e60613          	addi	a2,a2,910 # ffffffffc0204c78 <commands+0x5d0>
ffffffffc02008f2:	0ca00593          	li	a1,202
ffffffffc02008f6:	00004517          	auipc	a0,0x4
ffffffffc02008fa:	e7250513          	addi	a0,a0,-398 # ffffffffc0204768 <commands+0xc0>
ffffffffc02008fe:	a77ff0ef          	jal	ra,ffffffffc0200374 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc0200902:	00004517          	auipc	a0,0x4
ffffffffc0200906:	39650513          	addi	a0,a0,918 # ffffffffc0204c98 <commands+0x5f0>
ffffffffc020090a:	b779                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc020090c:	00004517          	auipc	a0,0x4
ffffffffc0200910:	3a450513          	addi	a0,a0,932 # ffffffffc0204cb0 <commands+0x608>
...
ffffffffc0200998:	2e460613          	addi	a2,a2,740 # ffffffffc0204c78 <commands+0x5d0>
ffffffffc020099c:	0ea00593          	li	a1,234
ffffffffc02009a0:	00004517          	auipc	a0,0x4
ffffffffc02009a4:	dc850513          	addi	a0,a0,-568 # ffffffffc0204768 <commands+0xc0>
...
ffffffffc02009c4:	2b860613          	addi	a2,a2,696 # ffffffffc0204c78 <commands+0x5d0>
ffffffffc02009c8:	0f100593          	li	a1,241
ffffffffc02009cc:	00004517          	auipc	a0,0x4
ffffffffc02009d0:	d9c50513          	addi	a0,a0,-612 # ffffffffc0204768 <commands+0xc0>
...
ffffffffc0200dc6:	00e68693          	addi	a3,a3,14 # ffffffffc0204dd0 <commands+0x728>
ffffffffc0200dca:	00004617          	auipc	a2,0x4
ffffffffc0200dce:	01660613          	addi	a2,a2,22 # ffffffffc0204de0 <commands+0x738>
ffffffffc0200dd2:	0f000593          	li	a1,240
ffffffffc0200dd6:	00004517          	auipc	a0,0x4
ffffffffc0200dda:	02250513          	addi	a0,a0,34 # ffffffffc0204df8 <commands+0x750>
ffffffffc0200dde:	d96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200de2:	00004697          	auipc	a3,0x4
ffffffffc0200de6:	0ae68693          	addi	a3,a3,174 # ffffffffc0204e90 <commands+0x7e8>
ffffffffc0200dea:	00004617          	auipc	a2,0x4
ffffffffc0200dee:	ff660613          	addi	a2,a2,-10 # ffffffffc0204de0 <commands+0x738>
ffffffffc0200df2:	0bd00593          	li	a1,189
ffffffffc0200df6:	00004517          	auipc	a0,0x4
ffffffffc0200dfa:	00250513          	addi	a0,a0,2 # ffffffffc0204df8 <commands+0x750>
ffffffffc0200dfe:	d76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200e02:	00004697          	auipc	a3,0x4
ffffffffc0200e06:	0b668693          	addi	a3,a3,182 # ffffffffc0204eb8 <commands+0x810>
ffffffffc0200e0a:	00004617          	auipc	a2,0x4
ffffffffc0200e0e:	fd660613          	addi	a2,a2,-42 # ffffffffc0204de0 <commands+0x738>
ffffffffc0200e12:	0be00593          	li	a1,190
ffffffffc0200e16:	00004517          	auipc	a0,0x4
ffffffffc0200e1a:	fe250513          	addi	a0,a0,-30 # ffffffffc0204df8 <commands+0x750>
ffffffffc0200e1e:	d56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200e22:	00004697          	auipc	a3,0x4
ffffffffc0200e26:	0d668693          	addi	a3,a3,214 # ffffffffc0204ef8 <commands+0x850>
ffffffffc0200e2a:	00004617          	auipc	a2,0x4
ffffffffc0200e2e:	fb660613          	addi	a2,a2,-74 # ffffffffc0204de0 <commands+0x738>
ffffffffc0200e32:	0c000593          	li	a1,192
ffffffffc0200e36:	00004517          	auipc	a0,0x4
ffffffffc0200e3a:	fc250513          	addi	a0,a0,-62 # ffffffffc0204df8 <commands+0x750>
ffffffffc0200e3e:	d36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200e42:	00004697          	auipc	a3,0x4
ffffffffc0200e46:	13e68693          	addi	a3,a3,318 # ffffffffc0204f80 <commands+0x8d8>
ffffffffc0200e4a:	00004617          	auipc	a2,0x4
ffffffffc0200e4e:	f9660613          	addi	a2,a2,-106 # ffffffffc0204de0 <commands+0x738>
ffffffffc0200e52:	0d900593          	li	a1,217
ffffffffc0200e56:	00004517          	auipc	a0,0x4
ffffffffc0200e5a:	fa250513          	addi	a0,a0,-94 # ffffffffc0204df8 <commands+0x750>
ffffffffc0200e5e:	d16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200e62:	00004697          	auipc	a3,0x4
ffffffffc0200e66:	fce68693          	addi	a3,a3,-50 # ffffffffc0204e30 <commands+0x788>
ffffffffc0200e6a:	00004617          	auipc	a2,0x4
ffffffffc0200e6e:	f7660613          	addi	a2,a2,-138 # ffffffffc0204de0 <commands+0x738>
ffffffffc0200e72:	0d200593          	li	a1,210
ffffffffc0200e76:	00004517          	auipc	a0,0x4
ffffffffc0200e7a:	f8250513          	addi	a0,a0,-126 # ffffffffc0204df8 <commands+0x750>
ffffffffc0200e7e:	cf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 3);
ffffffffc0200e82:	00004697          	auipc	a3,0x4
ffffffffc0200e86:	0ee68693          	addi	a3,a3,238 # ffffffffc0204f70 <commands+0x8c8>
ffffffffc0200e8a:	00004617          	auipc	a2,0x4
ffffffffc0200e8e:	f5660613          	addi	a2,a2,-170 # ffffffffc0204de0 <commands+0x738>
ffffffffc0200e92:	0d000593          	li	a1,208
ffffffffc0200e96:	00004517          	auipc	a0,0x4
ffffffffc0200e9a:	f6250513          	addi	a0,a0,-158 # ffffffffc0204df8 <commands+0x750>
ffffffffc0200e9e:	cd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200ea2:	00004697          	auipc	a3,0x4
ffffffffc0200ea6:	0b668693          	addi	a3,a3,182 # ffffffffc0204f58 <commands+0x8b0>
ffffffffc0200eaa:	00004617          	auipc	a2,0x4
ffffffffc0200eae:	f3660613          	addi	a2,a2,-202 # ffffffffc0204de0 <commands+0x738>
ffffffffc0200eb2:	0cb00593          	li	a1,203
ffffffffc0200eb6:	00004517          	auipc	a0,0x4
ffffffffc0200eba:	f4250513          	addi	a0,a0,-190 # ffffffffc0204df8 <commands+0x750>
ffffffffc0200ebe:	cb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200ec2:	00004697          	auipc	a3,0x4
ffffffffc0200ec6:	07668693          	addi	a3,a3,118 # ffffffffc0204f38 <commands+0x890>
ffffffffc0200eca:	00004617          	auipc	a2,0x4
ffffffffc0200ece:	f1660613          	addi	a2,a2,-234 # ffffffffc0204de0 <commands+0x738>
ffffffffc0200ed2:	0c200593          	li	a1,194
ffffffffc0200ed6:	00004517          	auipc	a0,0x4
ffffffffc0200eda:	f2250513          	addi	a0,a0,-222 # ffffffffc0204df8 <commands+0x750>
ffffffffc0200ede:	c96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != NULL);
ffffffffc0200ee2:	00004697          	auipc	a3,0x4
ffffffffc0200ee6:	0e668693          	addi	a3,a3,230 # ffffffffc0204fc8 <commands+0x920>
ffffffffc0200eea:	00004617          	auipc	a2,0x4
ffffffffc0200eee:	ef660613          	addi	a2,a2,-266 # ffffffffc0204de0 <commands+0x738>
ffffffffc0200ef2:	0f800593          	li	a1,248
ffffffffc0200ef6:	00004517          	auipc	a0,0x4
ffffffffc0200efa:	f0250513          	addi	a0,a0,-254 # ffffffffc0204df8 <commands+0x750>
ffffffffc0200efe:	c76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0200f02:	00004697          	auipc	a3,0x4
ffffffffc0200f06:	0b668693          	addi	a3,a3,182 # ffffffffc0204fb8 <commands+0x910>
ffffffffc0200f0a:	00004617          	auipc	a2,0x4
ffffffffc0200f0e:	ed660613          	addi	a2,a2,-298 # ffffffffc0204de0 <commands+0x738>
ffffffffc0200f12:	0df00593          	li	a1,223
ffffffffc0200f16:	00004517          	auipc	a0,0x4
ffffffffc0200f1a:	ee250513          	addi	a0,a0,-286 # ffffffffc0204df8 <commands+0x750>
ffffffffc0200f1e:	c56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f22:	00004697          	auipc	a3,0x4
ffffffffc0200f26:	03668693          	addi	a3,a3,54 # ffffffffc0204f58 <commands+0x8b0>
ffffffffc0200f2a:	00004617          	auipc	a2,0x4
ffffffffc0200f2e:	eb660613          	addi	a2,a2,-330 # ffffffffc0204de0 <commands+0x738>
ffffffffc0200f32:	0dd00593          	li	a1,221
ffffffffc0200f36:	00004517          	auipc	a0,0x4
ffffffffc0200f3a:	ec250513          	addi	a0,a0,-318 # ffffffffc0204df8 <commands+0x750>
ffffffffc0200f3e:	c36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200f42:	00004697          	auipc	a3,0x4
ffffffffc0200f46:	05668693          	addi	a3,a3,86 # ffffffffc0204f98 <commands+0x8f0>
ffffffffc0200f4a:	00004617          	auipc	a2,0x4
ffffffffc0200f4e:	e9660613          	addi	a2,a2,-362 # ffffffffc0204de0 <commands+0x738>
ffffffffc0200f52:	0dc00593          	li	a1,220
ffffffffc0200f56:	00004517          	auipc	a0,0x4
ffffffffc0200f5a:	ea250513          	addi	a0,a0,-350 # ffffffffc0204df8 <commands+0x750>
ffffffffc0200f5e:	c16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f62:	00004697          	auipc	a3,0x4
ffffffffc0200f66:	ece68693          	addi	a3,a3,-306 # ffffffffc0204e30 <commands+0x788>
ffffffffc0200f6a:	00004617          	auipc	a2,0x4
ffffffffc0200f6e:	e7660613          	addi	a2,a2,-394 # ffffffffc0204de0 <commands+0x738>
ffffffffc0200f72:	0b900593          	li	a1,185
ffffffffc0200f76:	00004517          	auipc	a0,0x4
ffffffffc0200f7a:	e8250513          	addi	a0,a0,-382 # ffffffffc0204df8 <commands+0x750>
ffffffffc0200f7e:	bf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f82:	00004697          	auipc	a3,0x4
ffffffffc0200f86:	fd668693          	addi	a3,a3,-42 # ffffffffc0204f58 <commands+0x8b0>
ffffffffc0200f8a:	00004617          	auipc	a2,0x4
ffffffffc0200f8e:	e5660613          	addi	a2,a2,-426 # ffffffffc0204de0 <commands+0x738>
ffffffffc0200f92:	0d600593          	li	a1,214
ffffffffc0200f96:	00004517          	auipc	a0,0x4
ffffffffc0200f9a:	e6250513          	addi	a0,a0,-414 # ffffffffc0204df8 <commands+0x750>
ffffffffc0200f9e:	bd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fa2:	00004697          	auipc	a3,0x4
ffffffffc0200fa6:	ece68693          	addi	a3,a3,-306 # ffffffffc0204e70 <commands+0x7c8>
ffffffffc0200faa:	00004617          	auipc	a2,0x4
ffffffffc0200fae:	e3660613          	addi	a2,a2,-458 # ffffffffc0204de0 <commands+0x738>
ffffffffc0200fb2:	0d400593          	li	a1,212
ffffffffc0200fb6:	00004517          	auipc	a0,0x4
ffffffffc0200fba:	e4250513          	addi	a0,a0,-446 # ffffffffc0204df8 <commands+0x750>
ffffffffc0200fbe:	bb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0200fc2:	00004697          	auipc	a3,0x4
ffffffffc0200fc6:	e8e68693          	addi	a3,a3,-370 # ffffffffc0204e50 <commands+0x7a8>
ffffffffc0200fca:	00004617          	auipc	a2,0x4
ffffffffc0200fce:	e1660613          	addi	a2,a2,-490 # ffffffffc0204de0 <commands+0x738>
ffffffffc0200fd2:	0d300593          	li	a1,211
ffffffffc0200fd6:	00004517          	auipc	a0,0x4
ffffffffc0200fda:	e2250513          	addi	a0,a0,-478 # ffffffffc0204df8 <commands+0x750>
ffffffffc0200fde:	b96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fe2:	00004697          	auipc	a3,0x4
ffffffffc0200fe6:	e8e68693          	addi	a3,a3,-370 # ffffffffc0204e70 <commands+0x7c8>
ffffffffc0200fea:	00004617          	auipc	a2,0x4
ffffffffc0200fee:	df660613          	addi	a2,a2,-522 # ffffffffc0204de0 <commands+0x738>
ffffffffc0200ff2:	0bb00593          	li	a1,187
ffffffffc0200ff6:	00004517          	auipc	a0,0x4
ffffffffc0200ffa:	e0250513          	addi	a0,a0,-510 # ffffffffc0204df8 <commands+0x750>
ffffffffc0200ffe:	b76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(count == 0);
ffffffffc0201002:	00004697          	auipc	a3,0x4
ffffffffc0201006:	11668693          	addi	a3,a3,278 # ffffffffc0205118 <commands+0xa70>
ffffffffc020100a:	00004617          	auipc	a2,0x4
ffffffffc020100e:	dd660613          	addi	a2,a2,-554 # ffffffffc0204de0 <commands+0x738>
ffffffffc0201012:	12500593          	li	a1,293
ffffffffc0201016:	00004517          	auipc	a0,0x4
ffffffffc020101a:	de250513          	addi	a0,a0,-542 # ffffffffc0204df8 <commands+0x750>
ffffffffc020101e:	b56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0201022:	00004697          	auipc	a3,0x4
ffffffffc0201026:	f9668693          	addi	a3,a3,-106 # ffffffffc0204fb8 <commands+0x910>
ffffffffc020102a:	00004617          	auipc	a2,0x4
ffffffffc020102e:	db660613          	addi	a2,a2,-586 # ffffffffc0204de0 <commands+0x738>
ffffffffc0201032:	11a00593          	li	a1,282
ffffffffc0201036:	00004517          	auipc	a0,0x4
ffffffffc020103a:	dc250513          	addi	a0,a0,-574 # ffffffffc0204df8 <commands+0x750>
ffffffffc020103e:	b36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201042:	00004697          	auipc	a3,0x4
ffffffffc0201046:	f1668693          	addi	a3,a3,-234 # ffffffffc0204f58 <commands+0x8b0>
ffffffffc020104a:	00004617          	auipc	a2,0x4
ffffffffc020104e:	d9660613          	addi	a2,a2,-618 # ffffffffc0204de0 <commands+0x738>
ffffffffc0201052:	11800593          	li	a1,280
ffffffffc0201056:	00004517          	auipc	a0,0x4
ffffffffc020105a:	da250513          	addi	a0,a0,-606 # ffffffffc0204df8 <commands+0x750>
ffffffffc020105e:	b16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201062:	00004697          	auipc	a3,0x4
ffffffffc0201066:	eb668693          	addi	a3,a3,-330 # ffffffffc0204f18 <commands+0x870>
ffffffffc020106a:	00004617          	auipc	a2,0x4
ffffffffc020106e:	d7660613          	addi	a2,a2,-650 # ffffffffc0204de0 <commands+0x738>
ffffffffc0201072:	0c100593          	li	a1,193
ffffffffc0201076:	00004517          	auipc	a0,0x4
ffffffffc020107a:	d8250513          	addi	a0,a0,-638 # ffffffffc0204df8 <commands+0x750>
ffffffffc020107e:	af6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201082:	00004697          	auipc	a3,0x4
ffffffffc0201086:	05668693          	addi	a3,a3,86 # ffffffffc02050d8 <commands+0xa30>
ffffffffc020108a:	00004617          	auipc	a2,0x4
ffffffffc020108e:	d5660613          	addi	a2,a2,-682 # ffffffffc0204de0 <commands+0x738>
ffffffffc0201092:	11200593          	li	a1,274
ffffffffc0201096:	00004517          	auipc	a0,0x4
ffffffffc020109a:	d6250513          	addi	a0,a0,-670 # ffffffffc0204df8 <commands+0x750>
ffffffffc020109e:	ad6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02010a2:	00004697          	auipc	a3,0x4
ffffffffc02010a6:	01668693          	addi	a3,a3,22 # ffffffffc02050b8 <commands+0xa10>
ffffffffc02010aa:	00004617          	auipc	a2,0x4
ffffffffc02010ae:	d3660613          	addi	a2,a2,-714 # ffffffffc0204de0 <commands+0x738>
ffffffffc02010b2:	11000593          	li	a1,272
ffffffffc02010b6:	00004517          	auipc	a0,0x4
ffffffffc02010ba:	d4250513          	addi	a0,a0,-702 # ffffffffc0204df8 <commands+0x750>
ffffffffc02010be:	ab6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02010c2:	00004697          	auipc	a3,0x4
ffffffffc02010c6:	fce68693          	addi	a3,a3,-50 # ffffffffc0205090 <commands+0x9e8>
ffffffffc02010ca:	00004617          	auipc	a2,0x4
ffffffffc02010ce:	d1660613          	addi	a2,a2,-746 # ffffffffc0204de0 <commands+0x738>
ffffffffc02010d2:	10e00593          	li	a1,270
ffffffffc02010d6:	00004517          	auipc	a0,0x4
ffffffffc02010da:	d2250513          	addi	a0,a0,-734 # ffffffffc0204df8 <commands+0x750>
ffffffffc02010de:	a96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02010e2:	00004697          	auipc	a3,0x4
ffffffffc02010e6:	f8668693          	addi	a3,a3,-122 # ffffffffc0205068 <commands+0x9c0>
ffffffffc02010ea:	00004617          	auipc	a2,0x4
ffffffffc02010ee:	cf660613          	addi	a2,a2,-778 # ffffffffc0204de0 <commands+0x738>
ffffffffc02010f2:	10d00593          	li	a1,269
ffffffffc02010f6:	00004517          	auipc	a0,0x4
ffffffffc02010fa:	d0250513          	addi	a0,a0,-766 # ffffffffc0204df8 <commands+0x750>
ffffffffc02010fe:	a76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201102:	00004697          	auipc	a3,0x4
ffffffffc0201106:	f5668693          	addi	a3,a3,-170 # ffffffffc0205058 <commands+0x9b0>
ffffffffc020110a:	00004617          	auipc	a2,0x4
ffffffffc020110e:	cd660613          	addi	a2,a2,-810 # ffffffffc0204de0 <commands+0x738>
ffffffffc0201112:	10800593          	li	a1,264
ffffffffc0201116:	00004517          	auipc	a0,0x4
ffffffffc020111a:	ce250513          	addi	a0,a0,-798 # ffffffffc0204df8 <commands+0x750>
ffffffffc020111e:	a56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201122:	00004697          	auipc	a3,0x4
ffffffffc0201126:	e3668693          	addi	a3,a3,-458 # ffffffffc0204f58 <commands+0x8b0>
ffffffffc020112a:	00004617          	auipc	a2,0x4
ffffffffc020112e:	cb660613          	addi	a2,a2,-842 # ffffffffc0204de0 <commands+0x738>
ffffffffc0201132:	10700593          	li	a1,263
ffffffffc0201136:	00004517          	auipc	a0,0x4
ffffffffc020113a:	cc250513          	addi	a0,a0,-830 # ffffffffc0204df8 <commands+0x750>
ffffffffc020113e:	a36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201142:	00004697          	auipc	a3,0x4
ffffffffc0201146:	ef668693          	addi	a3,a3,-266 # ffffffffc0205038 <commands+0x990>
ffffffffc020114a:	00004617          	auipc	a2,0x4
ffffffffc020114e:	c9660613          	addi	a2,a2,-874 # ffffffffc0204de0 <commands+0x738>
ffffffffc0201152:	10600593          	li	a1,262
ffffffffc0201156:	00004517          	auipc	a0,0x4
ffffffffc020115a:	ca250513          	addi	a0,a0,-862 # ffffffffc0204df8 <commands+0x750>
ffffffffc020115e:	a16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201162:	00004697          	auipc	a3,0x4
ffffffffc0201166:	ea668693          	addi	a3,a3,-346 # ffffffffc0205008 <commands+0x960>
ffffffffc020116a:	00004617          	auipc	a2,0x4
ffffffffc020116e:	c7660613          	addi	a2,a2,-906 # ffffffffc0204de0 <commands+0x738>
ffffffffc0201172:	10500593          	li	a1,261
ffffffffc0201176:	00004517          	auipc	a0,0x4
ffffffffc020117a:	c8250513          	addi	a0,a0,-894 # ffffffffc0204df8 <commands+0x750>
ffffffffc020117e:	9f6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201182:	00004697          	auipc	a3,0x4
ffffffffc0201186:	e6e68693          	addi	a3,a3,-402 # ffffffffc0204ff0 <commands+0x948>
ffffffffc020118a:	00004617          	auipc	a2,0x4
ffffffffc020118e:	c5660613          	addi	a2,a2,-938 # ffffffffc0204de0 <commands+0x738>
ffffffffc0201192:	10400593          	li	a1,260
ffffffffc0201196:	00004517          	auipc	a0,0x4
ffffffffc020119a:	c6250513          	addi	a0,a0,-926 # ffffffffc0204df8 <commands+0x750>
ffffffffc020119e:	9d6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011a2:	00004697          	auipc	a3,0x4
ffffffffc02011a6:	db668693          	addi	a3,a3,-586 # ffffffffc0204f58 <commands+0x8b0>
ffffffffc02011aa:	00004617          	auipc	a2,0x4
ffffffffc02011ae:	c3660613          	addi	a2,a2,-970 # ffffffffc0204de0 <commands+0x738>
ffffffffc02011b2:	0fe00593          	li	a1,254
ffffffffc02011b6:	00004517          	auipc	a0,0x4
ffffffffc02011ba:	c4250513          	addi	a0,a0,-958 # ffffffffc0204df8 <commands+0x750>
ffffffffc02011be:	9b6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!PageProperty(p0));
ffffffffc02011c2:	00004697          	auipc	a3,0x4
ffffffffc02011c6:	e1668693          	addi	a3,a3,-490 # ffffffffc0204fd8 <commands+0x930>
ffffffffc02011ca:	00004617          	auipc	a2,0x4
ffffffffc02011ce:	c1660613          	addi	a2,a2,-1002 # ffffffffc0204de0 <commands+0x738>
ffffffffc02011d2:	0f900593          	li	a1,249
ffffffffc02011d6:	00004517          	auipc	a0,0x4
ffffffffc02011da:	c2250513          	addi	a0,a0,-990 # ffffffffc0204df8 <commands+0x750>
ffffffffc02011de:	996ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02011e2:	00004697          	auipc	a3,0x4
ffffffffc02011e6:	f1668693          	addi	a3,a3,-234 # ffffffffc02050f8 <commands+0xa50>
ffffffffc02011ea:	00004617          	auipc	a2,0x4
ffffffffc02011ee:	bf660613          	addi	a2,a2,-1034 # ffffffffc0204de0 <commands+0x738>
ffffffffc02011f2:	11700593          	li	a1,279
ffffffffc02011f6:	00004517          	auipc	a0,0x4
ffffffffc02011fa:	c0250513          	addi	a0,a0,-1022 # ffffffffc0204df8 <commands+0x750>
ffffffffc02011fe:	976ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == 0);
ffffffffc0201202:	00004697          	auipc	a3,0x4
ffffffffc0201206:	f2668693          	addi	a3,a3,-218 # ffffffffc0205128 <commands+0xa80>
ffffffffc020120a:	00004617          	auipc	a2,0x4
ffffffffc020120e:	bd660613          	addi	a2,a2,-1066 # ffffffffc0204de0 <commands+0x738>
ffffffffc0201212:	12600593          	li	a1,294
ffffffffc0201216:	00004517          	auipc	a0,0x4
ffffffffc020121a:	be250513          	addi	a0,a0,-1054 # ffffffffc0204df8 <commands+0x750>
ffffffffc020121e:	956ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == nr_free_pages());
ffffffffc0201222:	00004697          	auipc	a3,0x4
ffffffffc0201226:	bee68693          	addi	a3,a3,-1042 # ffffffffc0204e10 <commands+0x768>
ffffffffc020122a:	00004617          	auipc	a2,0x4
ffffffffc020122e:	bb660613          	addi	a2,a2,-1098 # ffffffffc0204de0 <commands+0x738>
ffffffffc0201232:	0f300593          	li	a1,243
ffffffffc0201236:	00004517          	auipc	a0,0x4
ffffffffc020123a:	bc250513          	addi	a0,a0,-1086 # ffffffffc0204df8 <commands+0x750>
ffffffffc020123e:	936ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201242:	00004697          	auipc	a3,0x4
ffffffffc0201246:	c0e68693          	addi	a3,a3,-1010 # ffffffffc0204e50 <commands+0x7a8>
ffffffffc020124a:	00004617          	auipc	a2,0x4
ffffffffc020124e:	b9660613          	addi	a2,a2,-1130 # ffffffffc0204de0 <commands+0x738>
ffffffffc0201252:	0ba00593          	li	a1,186
ffffffffc0201256:	00004517          	auipc	a0,0x4
ffffffffc020125a:	ba250513          	addi	a0,a0,-1118 # ffffffffc0204df8 <commands+0x750>
...
ffffffffc020139e:	da668693          	addi	a3,a3,-602 # ffffffffc0205140 <commands+0xa98>
ffffffffc02013a2:	00004617          	auipc	a2,0x4
ffffffffc02013a6:	a3e60613          	addi	a2,a2,-1474 # ffffffffc0204de0 <commands+0x738>
ffffffffc02013aa:	08300593          	li	a1,131
ffffffffc02013ae:	00004517          	auipc	a0,0x4
ffffffffc02013b2:	a4a50513          	addi	a0,a0,-1462 # ffffffffc0204df8 <commands+0x750>
ffffffffc02013b6:	fbffe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc02013ba:	00004697          	auipc	a3,0x4
ffffffffc02013be:	d7e68693          	addi	a3,a3,-642 # ffffffffc0205138 <commands+0xa90>
ffffffffc02013c2:	00004617          	auipc	a2,0x4
ffffffffc02013c6:	a1e60613          	addi	a2,a2,-1506 # ffffffffc0204de0 <commands+0x738>
ffffffffc02013ca:	08000593          	li	a1,128
ffffffffc02013ce:	00004517          	auipc	a0,0x4
ffffffffc02013d2:	a2a50513          	addi	a0,a0,-1494 # ffffffffc0204df8 <commands+0x750>
...
ffffffffc0201476:	cc668693          	addi	a3,a3,-826 # ffffffffc0205138 <commands+0xa90>
ffffffffc020147a:	00004617          	auipc	a2,0x4
ffffffffc020147e:	96660613          	addi	a2,a2,-1690 # ffffffffc0204de0 <commands+0x738>
ffffffffc0201482:	06200593          	li	a1,98
ffffffffc0201486:	00004517          	auipc	a0,0x4
ffffffffc020148a:	97250513          	addi	a0,a0,-1678 # ffffffffc0204df8 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc020154c:	c2068693          	addi	a3,a3,-992 # ffffffffc0205168 <commands+0xac0>
ffffffffc0201550:	00004617          	auipc	a2,0x4
ffffffffc0201554:	89060613          	addi	a2,a2,-1904 # ffffffffc0204de0 <commands+0x738>
ffffffffc0201558:	04900593          	li	a1,73
ffffffffc020155c:	00004517          	auipc	a0,0x4
ffffffffc0201560:	89c50513          	addi	a0,a0,-1892 # ffffffffc0204df8 <commands+0x750>
ffffffffc0201564:	e11fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc0201568:	00004697          	auipc	a3,0x4
ffffffffc020156c:	bd068693          	addi	a3,a3,-1072 # ffffffffc0205138 <commands+0xa90>
ffffffffc0201570:	00004617          	auipc	a2,0x4
ffffffffc0201574:	87060613          	addi	a2,a2,-1936 # ffffffffc0204de0 <commands+0x738>
ffffffffc0201578:	04600593          	li	a1,70
ffffffffc020157c:	00004517          	auipc	a0,0x4
ffffffffc0201580:	87c50513          	addi	a0,a0,-1924 # ffffffffc0204df8 <commands+0x750>
...
ffffffffc020158e:	c3e60613          	addi	a2,a2,-962 # ffffffffc02051c8 <default_pmm_manager+0x38>
ffffffffc0201592:	06500593          	li	a1,101
ffffffffc0201596:	00004517          	auipc	a0,0x4
ffffffffc020159a:	c5250513          	addi	a0,a0,-942 # ffffffffc02051e8 <default_pmm_manager+0x58>
static inline struct Page *pa2page(uintptr_t pa) {
...
ffffffffc02015aa:	c5260613          	addi	a2,a2,-942 # ffffffffc02051f8 <default_pmm_manager+0x68>
ffffffffc02015ae:	07000593          	li	a1,112
ffffffffc02015b2:	00004517          	auipc	a0,0x4
ffffffffc02015b6:	c3650513          	addi	a0,a0,-970 # ffffffffc02051e8 <default_pmm_manager+0x58>
static inline struct Page *pte2page(pte_t pte) {
...
ffffffffc0201760:	4c1020ef          	jal	ra,ffffffffc0204420 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201802:	41f020ef          	jal	ra,ffffffffc0204420 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201862:	9c260613          	addi	a2,a2,-1598 # ffffffffc0205220 <default_pmm_manager+0x90>
ffffffffc0201866:	10200593          	li	a1,258
ffffffffc020186a:	00004517          	auipc	a0,0x4
ffffffffc020186e:	9de50513          	addi	a0,a0,-1570 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc0201872:	b03fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201876:	00004617          	auipc	a2,0x4
ffffffffc020187a:	9aa60613          	addi	a2,a2,-1622 # ffffffffc0205220 <default_pmm_manager+0x90>
ffffffffc020187e:	10f00593          	li	a1,271
ffffffffc0201882:	00004517          	auipc	a0,0x4
ffffffffc0201886:	9c650513          	addi	a0,a0,-1594 # ffffffffc0205248 <default_pmm_manager+0xb8>
...
ffffffffc0201894:	99060613          	addi	a2,a2,-1648 # ffffffffc0205220 <default_pmm_manager+0x90>
ffffffffc0201898:	10b00593          	li	a1,267
ffffffffc020189c:	00004517          	auipc	a0,0x4
ffffffffc02018a0:	9ac50513          	addi	a0,a0,-1620 # ffffffffc0205248 <default_pmm_manager+0xb8>
...
ffffffffc02018ae:	97660613          	addi	a2,a2,-1674 # ffffffffc0205220 <default_pmm_manager+0x90>
ffffffffc02018b2:	0ff00593          	li	a1,255
ffffffffc02018b6:	00004517          	auipc	a0,0x4
ffffffffc02018ba:	99250513          	addi	a0,a0,-1646 # ffffffffc0205248 <default_pmm_manager+0xb8>
...
ffffffffc0201aba:	6da78793          	addi	a5,a5,1754 # ffffffffc0205190 <default_pmm_manager>
...
ffffffffc0201ac8:	79450513          	addi	a0,a0,1940 # ffffffffc0205258 <default_pmm_manager+0xc8>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201b24:	75050513          	addi	a0,a0,1872 # ffffffffc0205270 <default_pmm_manager+0xe0>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201b34:	77050513          	addi	a0,a0,1904 # ffffffffc02052a0 <default_pmm_manager+0x110>
...
ffffffffc0201b4e:	76e50513          	addi	a0,a0,1902 # ffffffffc02052b8 <default_pmm_manager+0x128>
...
ffffffffc0201bda:	73250513          	addi	a0,a0,1842 # ffffffffc0205308 <default_pmm_manager+0x178>
...
ffffffffc0201ea2:	75250513          	addi	a0,a0,1874 # ffffffffc02055f0 <default_pmm_manager+0x460>
...
ffffffffc0201f58:	7d458593          	addi	a1,a1,2004 # ffffffffc0205728 <default_pmm_manager+0x598>
ffffffffc0201f5c:	10000513          	li	a0,256
ffffffffc0201f60:	47a020ef          	jal	ra,ffffffffc02043da <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	480020ef          	jal	ra,ffffffffc02043ec <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb94>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	3fe020ef          	jal	ra,ffffffffc02043a4 <strlen>
...
ffffffffc020209c:	70850513          	addi	a0,a0,1800 # ffffffffc02057a0 <default_pmm_manager+0x610>
}
...
ffffffffc02021a2:	4b268693          	addi	a3,a3,1202 # ffffffffc0205650 <default_pmm_manager+0x4c0>
ffffffffc02021a6:	00003617          	auipc	a2,0x3
ffffffffc02021aa:	c3a60613          	addi	a2,a2,-966 # ffffffffc0204de0 <commands+0x738>
ffffffffc02021ae:	1ce00593          	li	a1,462
ffffffffc02021b2:	00003517          	auipc	a0,0x3
ffffffffc02021b6:	09650513          	addi	a0,a0,150 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc02021ba:	9bafe0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc02021be:	00003697          	auipc	a3,0x3
ffffffffc02021c2:	45268693          	addi	a3,a3,1106 # ffffffffc0205610 <default_pmm_manager+0x480>
ffffffffc02021c6:	00003617          	auipc	a2,0x3
ffffffffc02021ca:	c1a60613          	addi	a2,a2,-998 # ffffffffc0204de0 <commands+0x738>
ffffffffc02021ce:	1cd00593          	li	a1,461
ffffffffc02021d2:	00003517          	auipc	a0,0x3
ffffffffc02021d6:	07650513          	addi	a0,a0,118 # ffffffffc0205248 <default_pmm_manager+0xb8>
...
ffffffffc02021e4:	04060613          	addi	a2,a2,64 # ffffffffc0205220 <default_pmm_manager+0x90>
ffffffffc02021e8:	1cd00593          	li	a1,461
ffffffffc02021ec:	00003517          	auipc	a0,0x3
ffffffffc02021f0:	05c50513          	addi	a0,a0,92 # ffffffffc0205248 <default_pmm_manager+0xb8>
...
ffffffffc0202200:	0e460613          	addi	a2,a2,228 # ffffffffc02052e0 <default_pmm_manager+0x150>
ffffffffc0202204:	07700593          	li	a1,119
ffffffffc0202208:	00003517          	auipc	a0,0x3
ffffffffc020220c:	04050513          	addi	a0,a0,64 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc0202210:	964fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202214:	00003617          	auipc	a2,0x3
ffffffffc0202218:	0cc60613          	addi	a2,a2,204 # ffffffffc02052e0 <default_pmm_manager+0x150>
ffffffffc020221c:	0bd00593          	li	a1,189
ffffffffc0202220:	00003517          	auipc	a0,0x3
ffffffffc0202224:	02850513          	addi	a0,a0,40 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc0202228:	94cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc020222c:	00003697          	auipc	a3,0x3
ffffffffc0202230:	11c68693          	addi	a3,a3,284 # ffffffffc0205348 <default_pmm_manager+0x1b8>
ffffffffc0202234:	00003617          	auipc	a2,0x3
ffffffffc0202238:	bac60613          	addi	a2,a2,-1108 # ffffffffc0204de0 <commands+0x738>
ffffffffc020223c:	19300593          	li	a1,403
ffffffffc0202240:	00003517          	auipc	a0,0x3
ffffffffc0202244:	00850513          	addi	a0,a0,8 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc0202248:	92cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020224c:	00003697          	auipc	a3,0x3
ffffffffc0202250:	0dc68693          	addi	a3,a3,220 # ffffffffc0205328 <default_pmm_manager+0x198>
ffffffffc0202254:	00003617          	auipc	a2,0x3
ffffffffc0202258:	b8c60613          	addi	a2,a2,-1140 # ffffffffc0204de0 <commands+0x738>
ffffffffc020225c:	19200593          	li	a1,402
ffffffffc0202260:	00003517          	auipc	a0,0x3
ffffffffc0202264:	fe850513          	addi	a0,a0,-24 # ffffffffc0205248 <default_pmm_manager+0xb8>
...
ffffffffc0202274:	16868693          	addi	a3,a3,360 # ffffffffc02053d8 <default_pmm_manager+0x248>
ffffffffc0202278:	00003617          	auipc	a2,0x3
ffffffffc020227c:	b6860613          	addi	a2,a2,-1176 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202280:	19a00593          	li	a1,410
ffffffffc0202284:	00003517          	auipc	a0,0x3
ffffffffc0202288:	fc450513          	addi	a0,a0,-60 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc020228c:	8e8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202290:	00003697          	auipc	a3,0x3
ffffffffc0202294:	11868693          	addi	a3,a3,280 # ffffffffc02053a8 <default_pmm_manager+0x218>
ffffffffc0202298:	00003617          	auipc	a2,0x3
ffffffffc020229c:	b4860613          	addi	a2,a2,-1208 # ffffffffc0204de0 <commands+0x738>
ffffffffc02022a0:	19800593          	li	a1,408
ffffffffc02022a4:	00003517          	auipc	a0,0x3
ffffffffc02022a8:	fa450513          	addi	a0,a0,-92 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc02022ac:	8c8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc02022b0:	00003697          	auipc	a3,0x3
ffffffffc02022b4:	0d068693          	addi	a3,a3,208 # ffffffffc0205380 <default_pmm_manager+0x1f0>
ffffffffc02022b8:	00003617          	auipc	a2,0x3
ffffffffc02022bc:	b2860613          	addi	a2,a2,-1240 # ffffffffc0204de0 <commands+0x738>
ffffffffc02022c0:	19400593          	li	a1,404
ffffffffc02022c4:	00003517          	auipc	a0,0x3
ffffffffc02022c8:	f8450513          	addi	a0,a0,-124 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc02022cc:	8a8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02022d0:	00003697          	auipc	a3,0x3
ffffffffc02022d4:	19068693          	addi	a3,a3,400 # ffffffffc0205460 <default_pmm_manager+0x2d0>
ffffffffc02022d8:	00003617          	auipc	a2,0x3
ffffffffc02022dc:	b0860613          	addi	a2,a2,-1272 # ffffffffc0204de0 <commands+0x738>
ffffffffc02022e0:	1a300593          	li	a1,419
ffffffffc02022e4:	00003517          	auipc	a0,0x3
ffffffffc02022e8:	f6450513          	addi	a0,a0,-156 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc02022ec:	888fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02022f0:	00003697          	auipc	a3,0x3
ffffffffc02022f4:	21068693          	addi	a3,a3,528 # ffffffffc0205500 <default_pmm_manager+0x370>
ffffffffc02022f8:	00003617          	auipc	a2,0x3
ffffffffc02022fc:	ae860613          	addi	a2,a2,-1304 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202300:	1a800593          	li	a1,424
ffffffffc0202304:	00003517          	auipc	a0,0x3
ffffffffc0202308:	f4450513          	addi	a0,a0,-188 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc020230c:	868fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202310:	00003697          	auipc	a3,0x3
ffffffffc0202314:	12868693          	addi	a3,a3,296 # ffffffffc0205438 <default_pmm_manager+0x2a8>
ffffffffc0202318:	00003617          	auipc	a2,0x3
ffffffffc020231c:	ac860613          	addi	a2,a2,-1336 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202320:	1a000593          	li	a1,416
ffffffffc0202324:	00003517          	auipc	a0,0x3
ffffffffc0202328:	f2450513          	addi	a0,a0,-220 # ffffffffc0205248 <default_pmm_manager+0xb8>
...
ffffffffc0202336:	eee60613          	addi	a2,a2,-274 # ffffffffc0205220 <default_pmm_manager+0x90>
ffffffffc020233a:	19f00593          	li	a1,415
ffffffffc020233e:	00003517          	auipc	a0,0x3
ffffffffc0202342:	f0a50513          	addi	a0,a0,-246 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc0202346:	82efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020234a:	00003697          	auipc	a3,0x3
ffffffffc020234e:	14e68693          	addi	a3,a3,334 # ffffffffc0205498 <default_pmm_manager+0x308>
ffffffffc0202352:	00003617          	auipc	a2,0x3
ffffffffc0202356:	a8e60613          	addi	a2,a2,-1394 # ffffffffc0204de0 <commands+0x738>
ffffffffc020235a:	1ad00593          	li	a1,429
ffffffffc020235e:	00003517          	auipc	a0,0x3
ffffffffc0202362:	eea50513          	addi	a0,a0,-278 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc0202366:	80efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020236a:	00003697          	auipc	a3,0x3
ffffffffc020236e:	1f668693          	addi	a3,a3,502 # ffffffffc0205560 <default_pmm_manager+0x3d0>
ffffffffc0202372:	00003617          	auipc	a2,0x3
ffffffffc0202376:	a6e60613          	addi	a2,a2,-1426 # ffffffffc0204de0 <commands+0x738>
ffffffffc020237a:	1ac00593          	li	a1,428
ffffffffc020237e:	00003517          	auipc	a0,0x3
ffffffffc0202382:	eca50513          	addi	a0,a0,-310 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc0202386:	feffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020238a:	00003697          	auipc	a3,0x3
ffffffffc020238e:	1be68693          	addi	a3,a3,446 # ffffffffc0205548 <default_pmm_manager+0x3b8>
ffffffffc0202392:	00003617          	auipc	a2,0x3
ffffffffc0202396:	a4e60613          	addi	a2,a2,-1458 # ffffffffc0204de0 <commands+0x738>
ffffffffc020239a:	1ab00593          	li	a1,427
ffffffffc020239e:	00003517          	auipc	a0,0x3
ffffffffc02023a2:	eaa50513          	addi	a0,a0,-342 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc02023a6:	fcffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc02023aa:	00003697          	auipc	a3,0x3
ffffffffc02023ae:	16e68693          	addi	a3,a3,366 # ffffffffc0205518 <default_pmm_manager+0x388>
ffffffffc02023b2:	00003617          	auipc	a2,0x3
ffffffffc02023b6:	a2e60613          	addi	a2,a2,-1490 # ffffffffc0204de0 <commands+0x738>
ffffffffc02023ba:	1aa00593          	li	a1,426
ffffffffc02023be:	00003517          	auipc	a0,0x3
ffffffffc02023c2:	e8a50513          	addi	a0,a0,-374 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc02023c6:	faffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc02023ca:	00003697          	auipc	a3,0x3
ffffffffc02023ce:	30668693          	addi	a3,a3,774 # ffffffffc02056d0 <default_pmm_manager+0x540>
ffffffffc02023d2:	00003617          	auipc	a2,0x3
ffffffffc02023d6:	a0e60613          	addi	a2,a2,-1522 # ffffffffc0204de0 <commands+0x738>
ffffffffc02023da:	1d800593          	li	a1,472
ffffffffc02023de:	00003517          	auipc	a0,0x3
ffffffffc02023e2:	e6a50513          	addi	a0,a0,-406 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc02023e6:	f8ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02023ea:	00003697          	auipc	a3,0x3
ffffffffc02023ee:	0fe68693          	addi	a3,a3,254 # ffffffffc02054e8 <default_pmm_manager+0x358>
ffffffffc02023f2:	00003617          	auipc	a2,0x3
ffffffffc02023f6:	9ee60613          	addi	a2,a2,-1554 # ffffffffc0204de0 <commands+0x738>
ffffffffc02023fa:	1a700593          	li	a1,423
ffffffffc02023fe:	00003517          	auipc	a0,0x3
ffffffffc0202402:	e4a50513          	addi	a0,a0,-438 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc0202406:	f6ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_W);
ffffffffc020240a:	00003697          	auipc	a3,0x3
ffffffffc020240e:	0ce68693          	addi	a3,a3,206 # ffffffffc02054d8 <default_pmm_manager+0x348>
ffffffffc0202412:	00003617          	auipc	a2,0x3
ffffffffc0202416:	9ce60613          	addi	a2,a2,-1586 # ffffffffc0204de0 <commands+0x738>
ffffffffc020241a:	1a600593          	li	a1,422
ffffffffc020241e:	00003517          	auipc	a0,0x3
ffffffffc0202422:	e2a50513          	addi	a0,a0,-470 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc0202426:	f4ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020242a:	00003697          	auipc	a3,0x3
ffffffffc020242e:	1a668693          	addi	a3,a3,422 # ffffffffc02055d0 <default_pmm_manager+0x440>
ffffffffc0202432:	00003617          	auipc	a2,0x3
ffffffffc0202436:	9ae60613          	addi	a2,a2,-1618 # ffffffffc0204de0 <commands+0x738>
ffffffffc020243a:	1e800593          	li	a1,488
ffffffffc020243e:	00003517          	auipc	a0,0x3
ffffffffc0202442:	e0a50513          	addi	a0,a0,-502 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc0202446:	f2ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020244a:	00003697          	auipc	a3,0x3
ffffffffc020244e:	07e68693          	addi	a3,a3,126 # ffffffffc02054c8 <default_pmm_manager+0x338>
ffffffffc0202452:	00003617          	auipc	a2,0x3
ffffffffc0202456:	98e60613          	addi	a2,a2,-1650 # ffffffffc0204de0 <commands+0x738>
ffffffffc020245a:	1a500593          	li	a1,421
ffffffffc020245e:	00003517          	auipc	a0,0x3
ffffffffc0202462:	dea50513          	addi	a0,a0,-534 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc0202466:	f0ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020246a:	00003697          	auipc	a3,0x3
ffffffffc020246e:	fb668693          	addi	a3,a3,-74 # ffffffffc0205420 <default_pmm_manager+0x290>
ffffffffc0202472:	00003617          	auipc	a2,0x3
ffffffffc0202476:	96e60613          	addi	a2,a2,-1682 # ffffffffc0204de0 <commands+0x738>
ffffffffc020247a:	1b200593          	li	a1,434
ffffffffc020247e:	00003517          	auipc	a0,0x3
ffffffffc0202482:	dca50513          	addi	a0,a0,-566 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc0202486:	eeffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020248a:	00003697          	auipc	a3,0x3
ffffffffc020248e:	0ee68693          	addi	a3,a3,238 # ffffffffc0205578 <default_pmm_manager+0x3e8>
ffffffffc0202492:	00003617          	auipc	a2,0x3
ffffffffc0202496:	94e60613          	addi	a2,a2,-1714 # ffffffffc0204de0 <commands+0x738>
ffffffffc020249a:	1af00593          	li	a1,431
ffffffffc020249e:	00003517          	auipc	a0,0x3
ffffffffc02024a2:	daa50513          	addi	a0,a0,-598 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc02024a6:	ecffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02024aa:	00003697          	auipc	a3,0x3
ffffffffc02024ae:	f5e68693          	addi	a3,a3,-162 # ffffffffc0205408 <default_pmm_manager+0x278>
ffffffffc02024b2:	00003617          	auipc	a2,0x3
ffffffffc02024b6:	92e60613          	addi	a2,a2,-1746 # ffffffffc0204de0 <commands+0x738>
ffffffffc02024ba:	1ae00593          	li	a1,430
ffffffffc02024be:	00003517          	auipc	a0,0x3
ffffffffc02024c2:	d8a50513          	addi	a0,a0,-630 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc02024c6:	eaffd0ef          	jal	ra,ffffffffc0200374 <__panic>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc02024ca:	00003617          	auipc	a2,0x3
ffffffffc02024ce:	d5660613          	addi	a2,a2,-682 # ffffffffc0205220 <default_pmm_manager+0x90>
ffffffffc02024d2:	06a00593          	li	a1,106
ffffffffc02024d6:	00003517          	auipc	a0,0x3
ffffffffc02024da:	d1250513          	addi	a0,a0,-750 # ffffffffc02051e8 <default_pmm_manager+0x58>
ffffffffc02024de:	e97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02024e2:	00003697          	auipc	a3,0x3
ffffffffc02024e6:	0c668693          	addi	a3,a3,198 # ffffffffc02055a8 <default_pmm_manager+0x418>
ffffffffc02024ea:	00003617          	auipc	a2,0x3
ffffffffc02024ee:	8f660613          	addi	a2,a2,-1802 # ffffffffc0204de0 <commands+0x738>
ffffffffc02024f2:	1b900593          	li	a1,441
ffffffffc02024f6:	00003517          	auipc	a0,0x3
ffffffffc02024fa:	d5250513          	addi	a0,a0,-686 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc02024fe:	e77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202502:	00003697          	auipc	a3,0x3
ffffffffc0202506:	05e68693          	addi	a3,a3,94 # ffffffffc0205560 <default_pmm_manager+0x3d0>
ffffffffc020250a:	00003617          	auipc	a2,0x3
ffffffffc020250e:	8d660613          	addi	a2,a2,-1834 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202512:	1b700593          	li	a1,439
ffffffffc0202516:	00003517          	auipc	a0,0x3
ffffffffc020251a:	d3250513          	addi	a0,a0,-718 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc020251e:	e57fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202522:	00003697          	auipc	a3,0x3
ffffffffc0202526:	06e68693          	addi	a3,a3,110 # ffffffffc0205590 <default_pmm_manager+0x400>
ffffffffc020252a:	00003617          	auipc	a2,0x3
ffffffffc020252e:	8b660613          	addi	a2,a2,-1866 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202532:	1b600593          	li	a1,438
ffffffffc0202536:	00003517          	auipc	a0,0x3
ffffffffc020253a:	d1250513          	addi	a0,a0,-750 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc020253e:	e37fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202542:	00003697          	auipc	a3,0x3
ffffffffc0202546:	01e68693          	addi	a3,a3,30 # ffffffffc0205560 <default_pmm_manager+0x3d0>
ffffffffc020254a:	00003617          	auipc	a2,0x3
ffffffffc020254e:	89660613          	addi	a2,a2,-1898 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202552:	1b300593          	li	a1,435
ffffffffc0202556:	00003517          	auipc	a0,0x3
ffffffffc020255a:	cf250513          	addi	a0,a0,-782 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc020255e:	e17fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202562:	00003697          	auipc	a3,0x3
ffffffffc0202566:	15668693          	addi	a3,a3,342 # ffffffffc02056b8 <default_pmm_manager+0x528>
ffffffffc020256a:	00003617          	auipc	a2,0x3
ffffffffc020256e:	87660613          	addi	a2,a2,-1930 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202572:	1d700593          	li	a1,471
ffffffffc0202576:	00003517          	auipc	a0,0x3
ffffffffc020257a:	cd250513          	addi	a0,a0,-814 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc020257e:	df7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202582:	00003697          	auipc	a3,0x3
ffffffffc0202586:	0fe68693          	addi	a3,a3,254 # ffffffffc0205680 <default_pmm_manager+0x4f0>
ffffffffc020258a:	00003617          	auipc	a2,0x3
ffffffffc020258e:	85660613          	addi	a2,a2,-1962 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202592:	1d600593          	li	a1,470
ffffffffc0202596:	00003517          	auipc	a0,0x3
ffffffffc020259a:	cb250513          	addi	a0,a0,-846 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc020259e:	dd7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc02025a2:	00003697          	auipc	a3,0x3
ffffffffc02025a6:	0c668693          	addi	a3,a3,198 # ffffffffc0205668 <default_pmm_manager+0x4d8>
ffffffffc02025aa:	00003617          	auipc	a2,0x3
ffffffffc02025ae:	83660613          	addi	a2,a2,-1994 # ffffffffc0204de0 <commands+0x738>
ffffffffc02025b2:	1d200593          	li	a1,466
ffffffffc02025b6:	00003517          	auipc	a0,0x3
ffffffffc02025ba:	c9250513          	addi	a0,a0,-878 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc02025be:	db7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02025c2:	00003697          	auipc	a3,0x3
ffffffffc02025c6:	00e68693          	addi	a3,a3,14 # ffffffffc02055d0 <default_pmm_manager+0x440>
ffffffffc02025ca:	00003617          	auipc	a2,0x3
ffffffffc02025ce:	81660613          	addi	a2,a2,-2026 # ffffffffc0204de0 <commands+0x738>
ffffffffc02025d2:	1c000593          	li	a1,448
ffffffffc02025d6:	00003517          	auipc	a0,0x3
ffffffffc02025da:	c7250513          	addi	a0,a0,-910 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc02025de:	d97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02025e2:	00003697          	auipc	a3,0x3
ffffffffc02025e6:	e2668693          	addi	a3,a3,-474 # ffffffffc0205408 <default_pmm_manager+0x278>
ffffffffc02025ea:	00002617          	auipc	a2,0x2
ffffffffc02025ee:	7f660613          	addi	a2,a2,2038 # ffffffffc0204de0 <commands+0x738>
ffffffffc02025f2:	19b00593          	li	a1,411
ffffffffc02025f6:	00003517          	auipc	a0,0x3
ffffffffc02025fa:	c5250513          	addi	a0,a0,-942 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc02025fe:	d77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc0202602:	00003617          	auipc	a2,0x3
ffffffffc0202606:	c1e60613          	addi	a2,a2,-994 # ffffffffc0205220 <default_pmm_manager+0x90>
ffffffffc020260a:	19e00593          	li	a1,414
ffffffffc020260e:	00003517          	auipc	a0,0x3
ffffffffc0202612:	c3a50513          	addi	a0,a0,-966 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc0202616:	d5ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020261a:	00003697          	auipc	a3,0x3
ffffffffc020261e:	e0668693          	addi	a3,a3,-506 # ffffffffc0205420 <default_pmm_manager+0x290>
ffffffffc0202622:	00002617          	auipc	a2,0x2
ffffffffc0202626:	7be60613          	addi	a2,a2,1982 # ffffffffc0204de0 <commands+0x738>
ffffffffc020262a:	19c00593          	li	a1,412
ffffffffc020262e:	00003517          	auipc	a0,0x3
ffffffffc0202632:	c1a50513          	addi	a0,a0,-998 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc0202636:	d3ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020263a:	00003697          	auipc	a3,0x3
ffffffffc020263e:	e5e68693          	addi	a3,a3,-418 # ffffffffc0205498 <default_pmm_manager+0x308>
ffffffffc0202642:	00002617          	auipc	a2,0x2
ffffffffc0202646:	79e60613          	addi	a2,a2,1950 # ffffffffc0204de0 <commands+0x738>
ffffffffc020264a:	1a400593          	li	a1,420
ffffffffc020264e:	00003517          	auipc	a0,0x3
ffffffffc0202652:	bfa50513          	addi	a0,a0,-1030 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc0202656:	d1ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020265a:	00003697          	auipc	a3,0x3
ffffffffc020265e:	11e68693          	addi	a3,a3,286 # ffffffffc0205778 <default_pmm_manager+0x5e8>
ffffffffc0202662:	00002617          	auipc	a2,0x2
ffffffffc0202666:	77e60613          	addi	a2,a2,1918 # ffffffffc0204de0 <commands+0x738>
ffffffffc020266a:	1e000593          	li	a1,480
ffffffffc020266e:	00003517          	auipc	a0,0x3
ffffffffc0202672:	bda50513          	addi	a0,a0,-1062 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc0202676:	cfffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020267a:	00003697          	auipc	a3,0x3
ffffffffc020267e:	0c668693          	addi	a3,a3,198 # ffffffffc0205740 <default_pmm_manager+0x5b0>
ffffffffc0202682:	00002617          	auipc	a2,0x2
ffffffffc0202686:	75e60613          	addi	a2,a2,1886 # ffffffffc0204de0 <commands+0x738>
ffffffffc020268a:	1dd00593          	li	a1,477
ffffffffc020268e:	00003517          	auipc	a0,0x3
ffffffffc0202692:	bba50513          	addi	a0,a0,-1094 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc0202696:	cdffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 2);
ffffffffc020269a:	00003697          	auipc	a3,0x3
ffffffffc020269e:	07668693          	addi	a3,a3,118 # ffffffffc0205710 <default_pmm_manager+0x580>
ffffffffc02026a2:	00002617          	auipc	a2,0x2
ffffffffc02026a6:	73e60613          	addi	a2,a2,1854 # ffffffffc0204de0 <commands+0x738>
ffffffffc02026aa:	1d900593          	li	a1,473
ffffffffc02026ae:	00003517          	auipc	a0,0x3
ffffffffc02026b2:	b9a50513          	addi	a0,a0,-1126 # ffffffffc0205248 <default_pmm_manager+0xb8>
...
ffffffffc0202724:	0a068693          	addi	a3,a3,160 # ffffffffc02057c0 <default_pmm_manager+0x630>
ffffffffc0202728:	00002617          	auipc	a2,0x2
ffffffffc020272c:	6b860613          	addi	a2,a2,1720 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202730:	17a00593          	li	a1,378
ffffffffc0202734:	00003517          	auipc	a0,0x3
ffffffffc0202738:	b1450513          	addi	a0,a0,-1260 # ffffffffc0205248 <default_pmm_manager+0xb8>
...
ffffffffc02027dc:	00068693          	mv	a3,a3
ffffffffc02027e0:	00002617          	auipc	a2,0x2
ffffffffc02027e4:	60060613          	addi	a2,a2,1536 # ffffffffc0204de0 <commands+0x738>
ffffffffc02027e8:	1f000593          	li	a1,496
ffffffffc02027ec:	00003517          	auipc	a0,0x3
ffffffffc02027f0:	a5c50513          	addi	a0,a0,-1444 # ffffffffc0205248 <default_pmm_manager+0xb8>
...
ffffffffc02027fe:	a2660613          	addi	a2,a2,-1498 # ffffffffc0205220 <default_pmm_manager+0x90>
ffffffffc0202802:	06a00593          	li	a1,106
ffffffffc0202806:	00003517          	auipc	a0,0x3
ffffffffc020280a:	9e250513          	addi	a0,a0,-1566 # ffffffffc02051e8 <default_pmm_manager+0x58>
ffffffffc020280e:	b67fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(base != NULL);
ffffffffc0202812:	00003697          	auipc	a3,0x3
ffffffffc0202816:	fe668693          	addi	a3,a3,-26 # ffffffffc02057f8 <default_pmm_manager+0x668>
ffffffffc020281a:	00002617          	auipc	a2,0x2
ffffffffc020281e:	5c660613          	addi	a2,a2,1478 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202822:	1f300593          	li	a1,499
ffffffffc0202826:	00003517          	auipc	a0,0x3
ffffffffc020282a:	a2250513          	addi	a0,a0,-1502 # ffffffffc0205248 <default_pmm_manager+0xb8>
...
ffffffffc02028c6:	a1e60613          	addi	a2,a2,-1506 # ffffffffc02052e0 <default_pmm_manager+0x150>
ffffffffc02028ca:	06c00593          	li	a1,108
ffffffffc02028ce:	00003517          	auipc	a0,0x3
ffffffffc02028d2:	91a50513          	addi	a0,a0,-1766 # ffffffffc02051e8 <default_pmm_manager+0x58>
ffffffffc02028d6:	a9ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(ptr != NULL);
ffffffffc02028da:	00003697          	auipc	a3,0x3
ffffffffc02028de:	f2e68693          	addi	a3,a3,-210 # ffffffffc0205808 <default_pmm_manager+0x678>
ffffffffc02028e2:	00002617          	auipc	a2,0x2
ffffffffc02028e6:	4fe60613          	addi	a2,a2,1278 # ffffffffc0204de0 <commands+0x738>
ffffffffc02028ea:	1fa00593          	li	a1,506
ffffffffc02028ee:	00003517          	auipc	a0,0x3
ffffffffc02028f2:	95a50513          	addi	a0,a0,-1702 # ffffffffc0205248 <default_pmm_manager+0xb8>
ffffffffc02028f6:	a7ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0 && n < 1024 * 0124);
ffffffffc02028fa:	00003697          	auipc	a3,0x3
ffffffffc02028fe:	ede68693          	addi	a3,a3,-290 # ffffffffc02057d8 <default_pmm_manager+0x648>
ffffffffc0202902:	00002617          	auipc	a2,0x2
ffffffffc0202906:	4de60613          	addi	a2,a2,1246 # ffffffffc0204de0 <commands+0x738>
ffffffffc020290a:	1f900593          	li	a1,505
ffffffffc020290e:	00003517          	auipc	a0,0x3
ffffffffc0202912:	93a50513          	addi	a0,a0,-1734 # ffffffffc0205248 <default_pmm_manager+0xb8>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	460010ef          	jal	ra,ffffffffc0203d96 <swapfs_init>
...
ffffffffc0202994:	eb850513          	addi	a0,a0,-328 # ffffffffc0205848 <default_pmm_manager+0x6b8>
    return listelm->next;
...
ffffffffc02029e4:	e8050513          	addi	a0,a0,-384 # ffffffffc0205860 <default_pmm_manager+0x6d0>
ffffffffc02029e8:	ed2fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
ffffffffc02029ec:	327000ef          	jal	ra,ffffffffc0203512 <mm_create>
...
ffffffffc0202a20:	33b000ef          	jal	ra,ffffffffc020355a <vma_create>
...
ffffffffc0202a2c:	39d000ef          	jal	ra,ffffffffc02035c8 <insert_vma_struct>

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
ffffffffc0202a30:	00003517          	auipc	a0,0x3
ffffffffc0202a34:	ea050513          	addi	a0,a0,-352 # ffffffffc02058d0 <default_pmm_manager+0x740>
...
ffffffffc0202a50:	ed450513          	addi	a0,a0,-300 # ffffffffc0205920 <default_pmm_manager+0x790>
...
ffffffffc0202ac4:	ee850513          	addi	a0,a0,-280 # ffffffffc02059a8 <default_pmm_manager+0x818>
...
ffffffffc0202c10:	e4450513          	addi	a0,a0,-444 # ffffffffc0205a50 <default_pmm_manager+0x8c0>
...
ffffffffc0202c36:	263000ef          	jal	ra,ffffffffc0203698 <mm_destroy>
...
ffffffffc0202c62:	e2250513          	addi	a0,a0,-478 # ffffffffc0205a80 <default_pmm_manager+0x8f0>
ffffffffc0202c66:	c54fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
ffffffffc0202c6a:	00003517          	auipc	a0,0x3
ffffffffc0202c6e:	e3650513          	addi	a0,a0,-458 # ffffffffc0205aa0 <default_pmm_manager+0x910>
...
ffffffffc0202c80:	15468693          	addi	a3,a3,340 # ffffffffc0204dd0 <commands+0x728>
ffffffffc0202c84:	00002617          	auipc	a2,0x2
ffffffffc0202c88:	15c60613          	addi	a2,a2,348 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202c8c:	0bb00593          	li	a1,187
ffffffffc0202c90:	00003517          	auipc	a0,0x3
ffffffffc0202c94:	ba850513          	addi	a0,a0,-1112 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202c98:	edcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202c9c:	00003697          	auipc	a3,0x3
ffffffffc0202ca0:	d8c68693          	addi	a3,a3,-628 # ffffffffc0205a28 <default_pmm_manager+0x898>
ffffffffc0202ca4:	00002617          	auipc	a2,0x2
ffffffffc0202ca8:	13c60613          	addi	a2,a2,316 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202cac:	0fb00593          	li	a1,251
ffffffffc0202cb0:	00003517          	auipc	a0,0x3
ffffffffc0202cb4:	b8850513          	addi	a0,a0,-1144 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202cb8:	ebcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202cbc:	00002617          	auipc	a2,0x2
ffffffffc0202cc0:	53c60613          	addi	a2,a2,1340 # ffffffffc02051f8 <default_pmm_manager+0x68>
ffffffffc0202cc4:	07000593          	li	a1,112
ffffffffc0202cc8:	00002517          	auipc	a0,0x2
ffffffffc0202ccc:	52050513          	addi	a0,a0,1312 # ffffffffc02051e8 <default_pmm_manager+0x58>
ffffffffc0202cd0:	ea4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202cd4:	00002617          	auipc	a2,0x2
ffffffffc0202cd8:	4f460613          	addi	a2,a2,1268 # ffffffffc02051c8 <default_pmm_manager+0x38>
ffffffffc0202cdc:	06500593          	li	a1,101
ffffffffc0202ce0:	00002517          	auipc	a0,0x2
ffffffffc0202ce4:	50850513          	addi	a0,a0,1288 # ffffffffc02051e8 <default_pmm_manager+0x58>
ffffffffc0202ce8:	e8cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202cec:	00003697          	auipc	a3,0x3
ffffffffc0202cf0:	c7468693          	addi	a3,a3,-908 # ffffffffc0205960 <default_pmm_manager+0x7d0>
ffffffffc0202cf4:	00002617          	auipc	a2,0x2
ffffffffc0202cf8:	0ec60613          	addi	a2,a2,236 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202cfc:	0dc00593          	li	a1,220
ffffffffc0202d00:	00003517          	auipc	a0,0x3
ffffffffc0202d04:	b3850513          	addi	a0,a0,-1224 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202d08:	e6cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202d0c:	00003697          	auipc	a3,0x3
ffffffffc0202d10:	c3c68693          	addi	a3,a3,-964 # ffffffffc0205948 <default_pmm_manager+0x7b8>
ffffffffc0202d14:	00002617          	auipc	a2,0x2
ffffffffc0202d18:	0cc60613          	addi	a2,a2,204 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202d1c:	0db00593          	li	a1,219
ffffffffc0202d20:	00003517          	auipc	a0,0x3
ffffffffc0202d24:	b1850513          	addi	a0,a0,-1256 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202d28:	e4cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202d2c:	00003617          	auipc	a2,0x3
ffffffffc0202d30:	aec60613          	addi	a2,a2,-1300 # ffffffffc0205818 <default_pmm_manager+0x688>
ffffffffc0202d34:	02800593          	li	a1,40
ffffffffc0202d38:	00003517          	auipc	a0,0x3
ffffffffc0202d3c:	b0050513          	addi	a0,a0,-1280 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202d40:	e34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202d44:	00003697          	auipc	a3,0x3
ffffffffc0202d48:	ccc68693          	addi	a3,a3,-820 # ffffffffc0205a10 <default_pmm_manager+0x880>
ffffffffc0202d4c:	00002617          	auipc	a2,0x2
ffffffffc0202d50:	09460613          	addi	a2,a2,148 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202d54:	0fa00593          	li	a1,250
ffffffffc0202d58:	00003517          	auipc	a0,0x3
ffffffffc0202d5c:	ae050513          	addi	a0,a0,-1312 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202d60:	e14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d64:	00003697          	auipc	a3,0x3
ffffffffc0202d68:	c9c68693          	addi	a3,a3,-868 # ffffffffc0205a00 <default_pmm_manager+0x870>
ffffffffc0202d6c:	00002617          	auipc	a2,0x2
ffffffffc0202d70:	07460613          	addi	a2,a2,116 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202d74:	09e00593          	li	a1,158
ffffffffc0202d78:	00003517          	auipc	a0,0x3
ffffffffc0202d7c:	ac050513          	addi	a0,a0,-1344 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202d80:	df4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d84:	00003697          	auipc	a3,0x3
ffffffffc0202d88:	c7c68693          	addi	a3,a3,-900 # ffffffffc0205a00 <default_pmm_manager+0x870>
ffffffffc0202d8c:	00002617          	auipc	a2,0x2
ffffffffc0202d90:	05460613          	addi	a2,a2,84 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202d94:	0a000593          	li	a1,160
ffffffffc0202d98:	00003517          	auipc	a0,0x3
ffffffffc0202d9c:	aa050513          	addi	a0,a0,-1376 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202da0:	dd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert( nr_free == 0);         
ffffffffc0202da4:	00002697          	auipc	a3,0x2
ffffffffc0202da8:	21468693          	addi	a3,a3,532 # ffffffffc0204fb8 <commands+0x910>
ffffffffc0202dac:	00002617          	auipc	a2,0x2
ffffffffc0202db0:	03460613          	addi	a2,a2,52 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202db4:	0f200593          	li	a1,242
ffffffffc0202db8:	00003517          	auipc	a0,0x3
ffffffffc0202dbc:	a8050513          	addi	a0,a0,-1408 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202dc0:	db4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(ret==0);
ffffffffc0202dc4:	00003697          	auipc	a3,0x3
ffffffffc0202dc8:	cb468693          	addi	a3,a3,-844 # ffffffffc0205a78 <default_pmm_manager+0x8e8>
ffffffffc0202dcc:	00002617          	auipc	a2,0x2
ffffffffc0202dd0:	01460613          	addi	a2,a2,20 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202dd4:	10100593          	li	a1,257
ffffffffc0202dd8:	00003517          	auipc	a0,0x3
ffffffffc0202ddc:	a6050513          	addi	a0,a0,-1440 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202de0:	d94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0202de4:	00003697          	auipc	a3,0x3
ffffffffc0202de8:	acc68693          	addi	a3,a3,-1332 # ffffffffc02058b0 <default_pmm_manager+0x720>
ffffffffc0202dec:	00002617          	auipc	a2,0x2
ffffffffc0202df0:	ff460613          	addi	a2,a2,-12 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202df4:	0cb00593          	li	a1,203
ffffffffc0202df8:	00003517          	auipc	a0,0x3
ffffffffc0202dfc:	a4050513          	addi	a0,a0,-1472 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202e00:	d74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(vma != NULL);
ffffffffc0202e04:	00003697          	auipc	a3,0x3
ffffffffc0202e08:	abc68693          	addi	a3,a3,-1348 # ffffffffc02058c0 <default_pmm_manager+0x730>
ffffffffc0202e0c:	00002617          	auipc	a2,0x2
ffffffffc0202e10:	fd460613          	addi	a2,a2,-44 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202e14:	0ce00593          	li	a1,206
ffffffffc0202e18:	00003517          	auipc	a0,0x3
ffffffffc0202e1c:	a2050513          	addi	a0,a0,-1504 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202e20:	d54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0202e24:	00003697          	auipc	a3,0x3
ffffffffc0202e28:	ae468693          	addi	a3,a3,-1308 # ffffffffc0205908 <default_pmm_manager+0x778>
ffffffffc0202e2c:	00002617          	auipc	a2,0x2
ffffffffc0202e30:	fb460613          	addi	a2,a2,-76 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202e34:	0d600593          	li	a1,214
ffffffffc0202e38:	00003517          	auipc	a0,0x3
ffffffffc0202e3c:	a0050513          	addi	a0,a0,-1536 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202e40:	d34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(total == nr_free_pages());
ffffffffc0202e44:	00002697          	auipc	a3,0x2
ffffffffc0202e48:	fcc68693          	addi	a3,a3,-52 # ffffffffc0204e10 <commands+0x768>
ffffffffc0202e4c:	00002617          	auipc	a2,0x2
ffffffffc0202e50:	f9460613          	addi	a2,a2,-108 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202e54:	0be00593          	li	a1,190
ffffffffc0202e58:	00003517          	auipc	a0,0x3
ffffffffc0202e5c:	9e050513          	addi	a0,a0,-1568 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202e60:	d14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e64:	00003697          	auipc	a3,0x3
ffffffffc0202e68:	b7c68693          	addi	a3,a3,-1156 # ffffffffc02059e0 <default_pmm_manager+0x850>
ffffffffc0202e6c:	00002617          	auipc	a2,0x2
ffffffffc0202e70:	f7460613          	addi	a2,a2,-140 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202e74:	09600593          	li	a1,150
ffffffffc0202e78:	00003517          	auipc	a0,0x3
ffffffffc0202e7c:	9c050513          	addi	a0,a0,-1600 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202e80:	cf4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e84:	00003697          	auipc	a3,0x3
ffffffffc0202e88:	b5c68693          	addi	a3,a3,-1188 # ffffffffc02059e0 <default_pmm_manager+0x850>
ffffffffc0202e8c:	00002617          	auipc	a2,0x2
ffffffffc0202e90:	f5460613          	addi	a2,a2,-172 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202e94:	09800593          	li	a1,152
ffffffffc0202e98:	00003517          	auipc	a0,0x3
ffffffffc0202e9c:	9a050513          	addi	a0,a0,-1632 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202ea0:	cd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ea4:	00003697          	auipc	a3,0x3
ffffffffc0202ea8:	b4c68693          	addi	a3,a3,-1204 # ffffffffc02059f0 <default_pmm_manager+0x860>
ffffffffc0202eac:	00002617          	auipc	a2,0x2
ffffffffc0202eb0:	f3460613          	addi	a2,a2,-204 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202eb4:	09a00593          	li	a1,154
ffffffffc0202eb8:	00003517          	auipc	a0,0x3
ffffffffc0202ebc:	98050513          	addi	a0,a0,-1664 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202ec0:	cb4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ec4:	00003697          	auipc	a3,0x3
ffffffffc0202ec8:	b2c68693          	addi	a3,a3,-1236 # ffffffffc02059f0 <default_pmm_manager+0x860>
ffffffffc0202ecc:	00002617          	auipc	a2,0x2
ffffffffc0202ed0:	f1460613          	addi	a2,a2,-236 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202ed4:	09c00593          	li	a1,156
ffffffffc0202ed8:	00003517          	auipc	a0,0x3
ffffffffc0202edc:	96050513          	addi	a0,a0,-1696 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202ee0:	c94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202ee4:	00003697          	auipc	a3,0x3
ffffffffc0202ee8:	aec68693          	addi	a3,a3,-1300 # ffffffffc02059d0 <default_pmm_manager+0x840>
ffffffffc0202eec:	00002617          	auipc	a2,0x2
ffffffffc0202ef0:	ef460613          	addi	a2,a2,-268 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202ef4:	09200593          	li	a1,146
ffffffffc0202ef8:	00003517          	auipc	a0,0x3
ffffffffc0202efc:	94050513          	addi	a0,a0,-1728 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202f00:	c74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202f04:	00003697          	auipc	a3,0x3
ffffffffc0202f08:	acc68693          	addi	a3,a3,-1332 # ffffffffc02059d0 <default_pmm_manager+0x840>
ffffffffc0202f0c:	00002617          	auipc	a2,0x2
ffffffffc0202f10:	ed460613          	addi	a2,a2,-300 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202f14:	09400593          	li	a1,148
ffffffffc0202f18:	00003517          	auipc	a0,0x3
ffffffffc0202f1c:	92050513          	addi	a0,a0,-1760 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202f20:	c54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(mm != NULL);
ffffffffc0202f24:	00003697          	auipc	a3,0x3
ffffffffc0202f28:	96468693          	addi	a3,a3,-1692 # ffffffffc0205888 <default_pmm_manager+0x6f8>
ffffffffc0202f2c:	00002617          	auipc	a2,0x2
ffffffffc0202f30:	eb460613          	addi	a2,a2,-332 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202f34:	0c300593          	li	a1,195
ffffffffc0202f38:	00003517          	auipc	a0,0x3
ffffffffc0202f3c:	90050513          	addi	a0,a0,-1792 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202f40:	c34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0202f44:	00003697          	auipc	a3,0x3
ffffffffc0202f48:	95468693          	addi	a3,a3,-1708 # ffffffffc0205898 <default_pmm_manager+0x708>
ffffffffc0202f4c:	00002617          	auipc	a2,0x2
ffffffffc0202f50:	e9460613          	addi	a2,a2,-364 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202f54:	0c600593          	li	a1,198
ffffffffc0202f58:	00003517          	auipc	a0,0x3
ffffffffc0202f5c:	8e050513          	addi	a0,a0,-1824 # ffffffffc0205838 <default_pmm_manager+0x6a8>
ffffffffc0202f60:	c14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0202f64:	00003697          	auipc	a3,0x3
ffffffffc0202f68:	a1c68693          	addi	a3,a3,-1508 # ffffffffc0205980 <default_pmm_manager+0x7f0>
ffffffffc0202f6c:	00002617          	auipc	a2,0x2
ffffffffc0202f70:	e7460613          	addi	a2,a2,-396 # ffffffffc0204de0 <commands+0x738>
ffffffffc0202f74:	0e900593          	li	a1,233
ffffffffc0202f78:	00003517          	auipc	a0,0x3
ffffffffc0202f7c:	8c050513          	addi	a0,a0,-1856 # ffffffffc0205838 <default_pmm_manager+0x6a8>
...
ffffffffc0202fc8:	b5cb0b13          	addi	s6,s6,-1188 # ffffffffc0205b20 <default_pmm_manager+0x990>
                    cprintf("SWAP: failed to save\n");
ffffffffc0202fcc:	00003b97          	auipc	s7,0x3
ffffffffc0202fd0:	b3cb8b93          	addi	s7,s7,-1220 # ffffffffc0205b08 <default_pmm_manager+0x978>
...
ffffffffc0203040:	629000ef          	jal	ra,ffffffffc0203e68 <swapfs_write>
...
ffffffffc0203082:	a4250513          	addi	a0,a0,-1470 # ffffffffc0205ac0 <default_pmm_manager+0x930>
...
ffffffffc0203094:	a6068693          	addi	a3,a3,-1440 # ffffffffc0205af0 <default_pmm_manager+0x960>
ffffffffc0203098:	00002617          	auipc	a2,0x2
ffffffffc020309c:	d4860613          	addi	a2,a2,-696 # ffffffffc0204de0 <commands+0x738>
ffffffffc02030a0:	06700593          	li	a1,103
ffffffffc02030a4:	00002517          	auipc	a0,0x2
ffffffffc02030a8:	79450513          	addi	a0,a0,1940 # ffffffffc0205838 <default_pmm_manager+0x6a8>
...
ffffffffc02030de:	4f1000ef          	jal	ra,ffffffffc0203dce <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc02030e2:	00093583          	ld	a1,0(s2)
ffffffffc02030e6:	8626                	mv	a2,s1
ffffffffc02030e8:	00003517          	auipc	a0,0x3
ffffffffc02030ec:	a8850513          	addi	a0,a0,-1400 # ffffffffc0205b70 <default_pmm_manager+0x9e0>
...
ffffffffc020310e:	a5668693          	addi	a3,a3,-1450 # ffffffffc0205b60 <default_pmm_manager+0x9d0>
ffffffffc0203112:	00002617          	auipc	a2,0x2
ffffffffc0203116:	cce60613          	addi	a2,a2,-818 # ffffffffc0204de0 <commands+0x738>
ffffffffc020311a:	07d00593          	li	a1,125
ffffffffc020311e:	00002517          	auipc	a0,0x2
ffffffffc0203122:	71a50513          	addi	a0,a0,1818 # ffffffffc0205838 <default_pmm_manager+0x6a8>
...
ffffffffc02031f6:	80e68693          	addi	a3,a3,-2034 # ffffffffc0205a00 <default_pmm_manager+0x870>
ffffffffc02031fa:	00002617          	auipc	a2,0x2
ffffffffc02031fe:	be660613          	addi	a2,a2,-1050 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203202:	09100593          	li	a1,145
ffffffffc0203206:	00003517          	auipc	a0,0x3
ffffffffc020320a:	9aa50513          	addi	a0,a0,-1622 # ffffffffc0205bb0 <default_pmm_manager+0xa20>
ffffffffc020320e:	966fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==6);
ffffffffc0203212:	00003697          	auipc	a3,0x3
ffffffffc0203216:	9ee68693          	addi	a3,a3,-1554 # ffffffffc0205c00 <default_pmm_manager+0xa70>
ffffffffc020321a:	00002617          	auipc	a2,0x2
ffffffffc020321e:	bc660613          	addi	a2,a2,-1082 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203222:	0a800593          	li	a1,168
ffffffffc0203226:	00003517          	auipc	a0,0x3
ffffffffc020322a:	98a50513          	addi	a0,a0,-1654 # ffffffffc0205bb0 <default_pmm_manager+0xa20>
ffffffffc020322e:	946fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203232:	00003697          	auipc	a3,0x3
ffffffffc0203236:	9a668693          	addi	a3,a3,-1626 # ffffffffc0205bd8 <default_pmm_manager+0xa48>
ffffffffc020323a:	00002617          	auipc	a2,0x2
ffffffffc020323e:	ba660613          	addi	a2,a2,-1114 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203242:	0a600593          	li	a1,166
ffffffffc0203246:	00003517          	auipc	a0,0x3
ffffffffc020324a:	96a50513          	addi	a0,a0,-1686 # ffffffffc0205bb0 <default_pmm_manager+0xa20>
ffffffffc020324e:	926fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203252:	00003697          	auipc	a3,0x3
ffffffffc0203256:	97668693          	addi	a3,a3,-1674 # ffffffffc0205bc8 <default_pmm_manager+0xa38>
ffffffffc020325a:	00002617          	auipc	a2,0x2
ffffffffc020325e:	b8660613          	addi	a2,a2,-1146 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203262:	0a500593          	li	a1,165
ffffffffc0203266:	00003517          	auipc	a0,0x3
ffffffffc020326a:	94a50513          	addi	a0,a0,-1718 # ffffffffc0205bb0 <default_pmm_manager+0xa20>
ffffffffc020326e:	906fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203272:	00003697          	auipc	a3,0x3
ffffffffc0203276:	95668693          	addi	a3,a3,-1706 # ffffffffc0205bc8 <default_pmm_manager+0xa38>
ffffffffc020327a:	00002617          	auipc	a2,0x2
ffffffffc020327e:	b6660613          	addi	a2,a2,-1178 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203282:	0a300593          	li	a1,163
ffffffffc0203286:	00003517          	auipc	a0,0x3
ffffffffc020328a:	92a50513          	addi	a0,a0,-1750 # ffffffffc0205bb0 <default_pmm_manager+0xa20>
ffffffffc020328e:	8e6fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203292:	00003697          	auipc	a3,0x3
ffffffffc0203296:	93668693          	addi	a3,a3,-1738 # ffffffffc0205bc8 <default_pmm_manager+0xa38>
ffffffffc020329a:	00002617          	auipc	a2,0x2
ffffffffc020329e:	b4660613          	addi	a2,a2,-1210 # ffffffffc0204de0 <commands+0x738>
ffffffffc02032a2:	0a100593          	li	a1,161
ffffffffc02032a6:	00003517          	auipc	a0,0x3
ffffffffc02032aa:	90a50513          	addi	a0,a0,-1782 # ffffffffc0205bb0 <default_pmm_manager+0xa20>
ffffffffc02032ae:	8c6fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032b2:	00003697          	auipc	a3,0x3
ffffffffc02032b6:	91668693          	addi	a3,a3,-1770 # ffffffffc0205bc8 <default_pmm_manager+0xa38>
ffffffffc02032ba:	00002617          	auipc	a2,0x2
ffffffffc02032be:	b2660613          	addi	a2,a2,-1242 # ffffffffc0204de0 <commands+0x738>
ffffffffc02032c2:	09f00593          	li	a1,159
ffffffffc02032c6:	00003517          	auipc	a0,0x3
ffffffffc02032ca:	8ea50513          	addi	a0,a0,-1814 # ffffffffc0205bb0 <default_pmm_manager+0xa20>
ffffffffc02032ce:	8a6fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032d2:	00003697          	auipc	a3,0x3
ffffffffc02032d6:	8f668693          	addi	a3,a3,-1802 # ffffffffc0205bc8 <default_pmm_manager+0xa38>
ffffffffc02032da:	00002617          	auipc	a2,0x2
ffffffffc02032de:	b0660613          	addi	a2,a2,-1274 # ffffffffc0204de0 <commands+0x738>
ffffffffc02032e2:	09d00593          	li	a1,157
ffffffffc02032e6:	00003517          	auipc	a0,0x3
ffffffffc02032ea:	8ca50513          	addi	a0,a0,-1846 # ffffffffc0205bb0 <default_pmm_manager+0xa20>
ffffffffc02032ee:	886fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032f2:	00003697          	auipc	a3,0x3
ffffffffc02032f6:	8d668693          	addi	a3,a3,-1834 # ffffffffc0205bc8 <default_pmm_manager+0xa38>
ffffffffc02032fa:	00002617          	auipc	a2,0x2
ffffffffc02032fe:	ae660613          	addi	a2,a2,-1306 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203302:	09b00593          	li	a1,155
ffffffffc0203306:	00003517          	auipc	a0,0x3
ffffffffc020330a:	8aa50513          	addi	a0,a0,-1878 # ffffffffc0205bb0 <default_pmm_manager+0xa20>
ffffffffc020330e:	866fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203312:	00003697          	auipc	a3,0x3
ffffffffc0203316:	8b668693          	addi	a3,a3,-1866 # ffffffffc0205bc8 <default_pmm_manager+0xa38>
ffffffffc020331a:	00002617          	auipc	a2,0x2
ffffffffc020331e:	ac660613          	addi	a2,a2,-1338 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203322:	09900593          	li	a1,153
ffffffffc0203326:	00003517          	auipc	a0,0x3
ffffffffc020332a:	88a50513          	addi	a0,a0,-1910 # ffffffffc0205bb0 <default_pmm_manager+0xa20>
ffffffffc020332e:	846fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc0203332:	00002697          	auipc	a3,0x2
ffffffffc0203336:	6ce68693          	addi	a3,a3,1742 # ffffffffc0205a00 <default_pmm_manager+0x870>
ffffffffc020333a:	00002617          	auipc	a2,0x2
ffffffffc020333e:	aa660613          	addi	a2,a2,-1370 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203342:	09700593          	li	a1,151
ffffffffc0203346:	00003517          	auipc	a0,0x3
ffffffffc020334a:	86a50513          	addi	a0,a0,-1942 # ffffffffc0205bb0 <default_pmm_manager+0xa20>
ffffffffc020334e:	826fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc0203352:	00002697          	auipc	a3,0x2
ffffffffc0203356:	6ae68693          	addi	a3,a3,1710 # ffffffffc0205a00 <default_pmm_manager+0x870>
ffffffffc020335a:	00002617          	auipc	a2,0x2
ffffffffc020335e:	a8660613          	addi	a2,a2,-1402 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203362:	09500593          	li	a1,149
ffffffffc0203366:	00003517          	auipc	a0,0x3
ffffffffc020336a:	84a50513          	addi	a0,a0,-1974 # ffffffffc0205bb0 <default_pmm_manager+0xa20>
ffffffffc020336e:	806fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc0203372:	00002697          	auipc	a3,0x2
ffffffffc0203376:	68e68693          	addi	a3,a3,1678 # ffffffffc0205a00 <default_pmm_manager+0x870>
ffffffffc020337a:	00002617          	auipc	a2,0x2
ffffffffc020337e:	a6660613          	addi	a2,a2,-1434 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203382:	09300593          	li	a1,147
ffffffffc0203386:	00003517          	auipc	a0,0x3
ffffffffc020338a:	82a50513          	addi	a0,a0,-2006 # ffffffffc0205bb0 <default_pmm_manager+0xa20>
...
ffffffffc0203394:	e84a                	sd	s2,16(sp)
     list_entry_t *head=(list_entry_t*) mm->sm_priv;
ffffffffc0203396:	02853903          	ld	s2,40(a0)
{
...
ffffffffc02033a2:	e052                	sd	s4,0(sp)
         assert(head != NULL);
ffffffffc02033a4:	06090563          	beqz	s2,ffffffffc020340e <_clock_swap_out_victim+0x7c>
     assert(in_tick==0);
ffffffffc02033a8:	e259                	bnez	a2,ffffffffc020342e <_clock_swap_out_victim+0x9c>
ffffffffc02033aa:	00893403          	ld	s0,8(s2)
ffffffffc02033ae:	8a2e                	mv	s4,a1
ffffffffc02033b0:	0000e497          	auipc	s1,0xe
ffffffffc02033b4:	1a848493          	addi	s1,s1,424 # ffffffffc0211558 <curr_ptr>
            cprintf("curr_ptr %p\n", curr_ptr); 
ffffffffc02033b8:	00003997          	auipc	s3,0x3
ffffffffc02033bc:	87898993          	addi	s3,s3,-1928 # ffffffffc0205c30 <default_pmm_manager+0xaa0>
        curr_ptr = list_next(head);
ffffffffc02033c0:	e080                	sd	s0,0(s1)
        while (curr_ptr != head) {
ffffffffc02033c2:	00891a63          	bne	s2,s0,ffffffffc02033d6 <_clock_swap_out_victim+0x44>
ffffffffc02033c6:	bfed                	j	ffffffffc02033c0 <_clock_swap_out_victim+0x2e>
ffffffffc02033c8:	609c                	ld	a5,0(s1)
            page->visited = 0;
ffffffffc02033ca:	fe043023          	sd	zero,-32(s0)
ffffffffc02033ce:	6780                	ld	s0,8(a5)
            curr_ptr = list_next(curr_ptr);
ffffffffc02033d0:	e080                	sd	s0,0(s1)
        while (curr_ptr != head) {
ffffffffc02033d2:	02890b63          	beq	s2,s0,ffffffffc0203408 <_clock_swap_out_victim+0x76>
            cprintf("curr_ptr %p\n", curr_ptr); 
ffffffffc02033d6:	85a2                	mv	a1,s0
ffffffffc02033d8:	854e                	mv	a0,s3
ffffffffc02033da:	ce1fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
            if (page->visited == 0) {
ffffffffc02033de:	fe043783          	ld	a5,-32(s0)
ffffffffc02033e2:	f3fd                	bnez	a5,ffffffffc02033c8 <_clock_swap_out_victim+0x36>
                list_del(curr_ptr);
ffffffffc02033e4:	609c                	ld	a5,0(s1)
            struct Page *page = le2page(curr_ptr, pra_page_link);
ffffffffc02033e6:	fd040413          	addi	s0,s0,-48
}
ffffffffc02033ea:	70a2                	ld	ra,40(sp)
    __list_del(listelm->prev, listelm->next);
ffffffffc02033ec:	6398                	ld	a4,0(a5)
ffffffffc02033ee:	679c                	ld	a5,8(a5)
ffffffffc02033f0:	64e2                	ld	s1,24(sp)
ffffffffc02033f2:	6942                	ld	s2,16(sp)
    prev->next = next;
ffffffffc02033f4:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02033f6:	e398                	sd	a4,0(a5)
                *ptr_page = page;
ffffffffc02033f8:	008a3023          	sd	s0,0(s4)
}
ffffffffc02033fc:	7402                	ld	s0,32(sp)
ffffffffc02033fe:	69a2                	ld	s3,8(sp)
ffffffffc0203400:	6a02                	ld	s4,0(sp)
ffffffffc0203402:	4501                	li	a0,0
ffffffffc0203404:	6145                	addi	sp,sp,48
ffffffffc0203406:	8082                	ret
    return listelm->next;
ffffffffc0203408:	00893403          	ld	s0,8(s2)
ffffffffc020340c:	bf55                	j	ffffffffc02033c0 <_clock_swap_out_victim+0x2e>
         assert(head != NULL);
ffffffffc020340e:	00003697          	auipc	a3,0x3
ffffffffc0203412:	80268693          	addi	a3,a3,-2046 # ffffffffc0205c10 <default_pmm_manager+0xa80>
ffffffffc0203416:	00002617          	auipc	a2,0x2
ffffffffc020341a:	9ca60613          	addi	a2,a2,-1590 # ffffffffc0204de0 <commands+0x738>
ffffffffc020341e:	04b00593          	li	a1,75
ffffffffc0203422:	00002517          	auipc	a0,0x2
ffffffffc0203426:	78e50513          	addi	a0,a0,1934 # ffffffffc0205bb0 <default_pmm_manager+0xa20>
ffffffffc020342a:	f4bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(in_tick==0);
ffffffffc020342e:	00002697          	auipc	a3,0x2
ffffffffc0203432:	7f268693          	addi	a3,a3,2034 # ffffffffc0205c20 <default_pmm_manager+0xa90>
ffffffffc0203436:	00002617          	auipc	a2,0x2
ffffffffc020343a:	9aa60613          	addi	a2,a2,-1622 # ffffffffc0204de0 <commands+0x738>
ffffffffc020343e:	04c00593          	li	a1,76
ffffffffc0203442:	00002517          	auipc	a0,0x2
ffffffffc0203446:	76e50513          	addi	a0,a0,1902 # ffffffffc0205bb0 <default_pmm_manager+0xa20>
ffffffffc020344a:	f2bfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020344e <_clock_init_mm>:
{     
ffffffffc020344e:	1141                	addi	sp,sp,-16
ffffffffc0203450:	e406                	sd	ra,8(sp)
    elm->prev = elm->next = elm;
ffffffffc0203452:	0000e797          	auipc	a5,0xe
ffffffffc0203456:	c9678793          	addi	a5,a5,-874 # ffffffffc02110e8 <pra_list_head>
     mm->sm_priv = &pra_list_head;
ffffffffc020345a:	f51c                	sd	a5,40(a0)
     cprintf("_clock_init_mm: pra_list_head initialized\n"); 
ffffffffc020345c:	00002517          	auipc	a0,0x2
ffffffffc0203460:	7e450513          	addi	a0,a0,2020 # ffffffffc0205c40 <default_pmm_manager+0xab0>
ffffffffc0203464:	e79c                	sd	a5,8(a5)
ffffffffc0203466:	e39c                	sd	a5,0(a5)
     curr_ptr = &pra_list_head;
ffffffffc0203468:	0000e717          	auipc	a4,0xe
ffffffffc020346c:	0ef73823          	sd	a5,240(a4) # ffffffffc0211558 <curr_ptr>
     cprintf("_clock_init_mm: pra_list_head initialized\n"); 
ffffffffc0203470:	c4bfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc0203474:	60a2                	ld	ra,8(sp)
...
ffffffffc020347e:	e022                	sd	s0,0(sp)
ffffffffc0203480:	8432                	mv	s0,a2
    cprintf("_clock_map_swappable: mapping page %p, addr %lx\n", page, addr);
ffffffffc0203482:	00002517          	auipc	a0,0x2
ffffffffc0203486:	7ee50513          	addi	a0,a0,2030 # ffffffffc0205c70 <default_pmm_manager+0xae0>
{    
ffffffffc020348a:	862e                	mv	a2,a1
    cprintf("_clock_map_swappable: mapping page %p, addr %lx\n", page, addr);
ffffffffc020348c:	85a2                	mv	a1,s0
{    
ffffffffc020348e:	e406                	sd	ra,8(sp)
    cprintf("_clock_map_swappable: mapping page %p, addr %lx\n", page, addr);
ffffffffc0203490:	c2bfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc0203494:	0000e597          	auipc	a1,0xe
ffffffffc0203498:	0c45b583          	ld	a1,196(a1) # ffffffffc0211558 <curr_ptr>
ffffffffc020349c:	c98d                	beqz	a1,ffffffffc02034ce <_clock_map_swappable+0x52>
    __list_add(elm, listelm->prev, listelm);
ffffffffc020349e:	0000e797          	auipc	a5,0xe
ffffffffc02034a2:	c4a78793          	addi	a5,a5,-950 # ffffffffc02110e8 <pra_list_head>
ffffffffc02034a6:	6394                	ld	a3,0(a5)
ffffffffc02034a8:	03040713          	addi	a4,s0,48
    cprintf("curr_ptr %p\n", curr_ptr); 
ffffffffc02034ac:	00002517          	auipc	a0,0x2
ffffffffc02034b0:	78450513          	addi	a0,a0,1924 # ffffffffc0205c30 <default_pmm_manager+0xaa0>
    prev->next = next->prev = elm;
ffffffffc02034b4:	e698                	sd	a4,8(a3)
    elm->prev = prev;
ffffffffc02034b6:	f814                	sd	a3,48(s0)
    page->visited = 1;
ffffffffc02034b8:	4685                	li	a3,1
    elm->next = next;
ffffffffc02034ba:	fc1c                	sd	a5,56(s0)
ffffffffc02034bc:	e814                	sd	a3,16(s0)
    prev->next = next->prev = elm;
...
ffffffffc02034cc:	8082                	ret
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02034ce:	00002697          	auipc	a3,0x2
ffffffffc02034d2:	7da68693          	addi	a3,a3,2010 # ffffffffc0205ca8 <default_pmm_manager+0xb18>
ffffffffc02034d6:	00002617          	auipc	a2,0x2
ffffffffc02034da:	90a60613          	addi	a2,a2,-1782 # ffffffffc0204de0 <commands+0x738>
ffffffffc02034de:	03800593          	li	a1,56
ffffffffc02034e2:	00002517          	auipc	a0,0x2
ffffffffc02034e6:	6ce50513          	addi	a0,a0,1742 # ffffffffc0205bb0 <default_pmm_manager+0xa20>
ffffffffc02034ea:	e8bfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02034ee <check_vma_overlap.part.0>:
}
...
ffffffffc02034ee:	1141                	addi	sp,sp,-16
    assert(prev->vm_start < prev->vm_end);
    assert(prev->vm_end <= next->vm_start);
    assert(next->vm_start < next->vm_end);
ffffffffc02034f0:	00002697          	auipc	a3,0x2
ffffffffc02034f4:	7f868693          	addi	a3,a3,2040 # ffffffffc0205ce8 <default_pmm_manager+0xb58>
ffffffffc02034f8:	00002617          	auipc	a2,0x2
ffffffffc02034fc:	8e860613          	addi	a2,a2,-1816 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203500:	07d00593          	li	a1,125
ffffffffc0203504:	00003517          	auipc	a0,0x3
ffffffffc0203508:	80450513          	addi	a0,a0,-2044 # ffffffffc0205d08 <default_pmm_manager+0xb78>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc020350c:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc020350e:	e67fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203512 <mm_create>:
mm_create(void) {
...
ffffffffc0203520:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc0203522:	c105                	beqz	a0,ffffffffc0203542 <mm_create+0x30>
    elm->prev = elm->next = elm;
...
ffffffffc0203534:	0000e797          	auipc	a5,0xe
ffffffffc0203538:	01c7a783          	lw	a5,28(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc020353c:	eb81                	bnez	a5,ffffffffc020354c <mm_create+0x3a>
        else mm->sm_priv = NULL;
ffffffffc020353e:	02053423          	sd	zero,40(a0)
}
ffffffffc0203542:	60a2                	ld	ra,8(sp)
ffffffffc0203544:	8522                	mv	a0,s0
ffffffffc0203546:	6402                	ld	s0,0(sp)
ffffffffc0203548:	0141                	addi	sp,sp,16
ffffffffc020354a:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020354c:	a39ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
}
...
ffffffffc020355a <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc020355a:	1101                	addi	sp,sp,-32
ffffffffc020355c:	e04a                	sd	s2,0(sp)
ffffffffc020355e:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203560:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc0203564:	e822                	sd	s0,16(sp)
ffffffffc0203566:	e426                	sd	s1,8(sp)
ffffffffc0203568:	ec06                	sd	ra,24(sp)
ffffffffc020356a:	84ae                	mv	s1,a1
ffffffffc020356c:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020356e:	a0aff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (vma != NULL) {
ffffffffc0203572:	c509                	beqz	a0,ffffffffc020357c <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc0203574:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203578:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc020357a:	ed00                	sd	s0,24(a0)
}
...
ffffffffc0203584:	6105                	addi	sp,sp,32
ffffffffc0203586:	8082                	ret

ffffffffc0203588 <find_vma>:
find_vma(struct mm_struct *mm, uintptr_t addr) {
ffffffffc0203588:	86aa                	mv	a3,a0
    if (mm != NULL) {
ffffffffc020358a:	c505                	beqz	a0,ffffffffc02035b2 <find_vma+0x2a>
        vma = mm->mmap_cache;
ffffffffc020358c:	6908                	ld	a0,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc020358e:	c501                	beqz	a0,ffffffffc0203596 <find_vma+0xe>
ffffffffc0203590:	651c                	ld	a5,8(a0)
ffffffffc0203592:	02f5f263          	bgeu	a1,a5,ffffffffc02035b6 <find_vma+0x2e>
    return listelm->next;
ffffffffc0203596:	669c                	ld	a5,8(a3)
                while ((le = list_next(le)) != list) {
ffffffffc0203598:	00f68d63          	beq	a3,a5,ffffffffc02035b2 <find_vma+0x2a>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc020359c:	fe87b703          	ld	a4,-24(a5)
ffffffffc02035a0:	00e5e663          	bltu	a1,a4,ffffffffc02035ac <find_vma+0x24>
ffffffffc02035a4:	ff07b703          	ld	a4,-16(a5)
ffffffffc02035a8:	00e5ec63          	bltu	a1,a4,ffffffffc02035c0 <find_vma+0x38>
ffffffffc02035ac:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc02035ae:	fef697e3          	bne	a3,a5,ffffffffc020359c <find_vma+0x14>
    struct vma_struct *vma = NULL;
ffffffffc02035b2:	4501                	li	a0,0
}
ffffffffc02035b4:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc02035b6:	691c                	ld	a5,16(a0)
ffffffffc02035b8:	fcf5ffe3          	bgeu	a1,a5,ffffffffc0203596 <find_vma+0xe>
            mm->mmap_cache = vma;
ffffffffc02035bc:	ea88                	sd	a0,16(a3)
ffffffffc02035be:	8082                	ret
                    vma = le2vma(le, list_link);
ffffffffc02035c0:	fe078513          	addi	a0,a5,-32
            mm->mmap_cache = vma;
ffffffffc02035c4:	ea88                	sd	a0,16(a3)
ffffffffc02035c6:	8082                	ret

ffffffffc02035c8 <insert_vma_struct>:
...
ffffffffc02035c8:	6590                	ld	a2,8(a1)
ffffffffc02035ca:	0105b803          	ld	a6,16(a1)
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc02035ce:	1141                	addi	sp,sp,-16
ffffffffc02035d0:	e406                	sd	ra,8(sp)
ffffffffc02035d2:	87aa                	mv	a5,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc02035d4:	01066763          	bltu	a2,a6,ffffffffc02035e2 <insert_vma_struct+0x1a>
ffffffffc02035d8:	a085                	j	ffffffffc0203638 <insert_vma_struct+0x70>
...
ffffffffc02035da:	fe87b703          	ld	a4,-24(a5)
ffffffffc02035de:	04e66863          	bltu	a2,a4,ffffffffc020362e <insert_vma_struct+0x66>
ffffffffc02035e2:	86be                	mv	a3,a5
ffffffffc02035e4:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02035e6:	fef51ae3          	bne	a0,a5,ffffffffc02035da <insert_vma_struct+0x12>
        }
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc02035ea:	02a68463          	beq	a3,a0,ffffffffc0203612 <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc02035ee:	ff06b703          	ld	a4,-16(a3)
    assert(prev->vm_start < prev->vm_end);
ffffffffc02035f2:	fe86b883          	ld	a7,-24(a3)
ffffffffc02035f6:	08e8f163          	bgeu	a7,a4,ffffffffc0203678 <insert_vma_struct+0xb0>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02035fa:	04e66f63          	bltu	a2,a4,ffffffffc0203658 <insert_vma_struct+0x90>
    }
    if (le_next != list) {
ffffffffc02035fe:	00f50a63          	beq	a0,a5,ffffffffc0203612 <insert_vma_struct+0x4a>
            if (mmap_prev->vm_start > vma->vm_start) {
ffffffffc0203602:	fe87b703          	ld	a4,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203606:	05076963          	bltu	a4,a6,ffffffffc0203658 <insert_vma_struct+0x90>
    assert(next->vm_start < next->vm_end);
ffffffffc020360a:	ff07b603          	ld	a2,-16(a5)
ffffffffc020360e:	02c77363          	bgeu	a4,a2,ffffffffc0203634 <insert_vma_struct+0x6c>
    }
    ...
    mm->map_count ++;
ffffffffc0203612:	5118                	lw	a4,32(a0)
    vma->vm_mm = mm;
ffffffffc0203614:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc0203616:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc020361a:	e390                	sd	a2,0(a5)
ffffffffc020361c:	e690                	sd	a2,8(a3)
}
ffffffffc020361e:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc0203620:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc0203622:	f194                	sd	a3,32(a1)
    mm->map_count ++;
ffffffffc0203624:	0017079b          	addiw	a5,a4,1
ffffffffc0203628:	d11c                	sw	a5,32(a0)
}
ffffffffc020362a:	0141                	addi	sp,sp,16
ffffffffc020362c:	8082                	ret
    if (le_prev != list) {
ffffffffc020362e:	fca690e3          	bne	a3,a0,ffffffffc02035ee <insert_vma_struct+0x26>
ffffffffc0203632:	bfd1                	j	ffffffffc0203606 <insert_vma_struct+0x3e>
ffffffffc0203634:	ebbff0ef          	jal	ra,ffffffffc02034ee <check_vma_overlap.part.0>
    assert(vma->vm_start < vma->vm_end);
ffffffffc0203638:	00002697          	auipc	a3,0x2
ffffffffc020363c:	6e068693          	addi	a3,a3,1760 # ffffffffc0205d18 <default_pmm_manager+0xb88>
ffffffffc0203640:	00001617          	auipc	a2,0x1
ffffffffc0203644:	7a060613          	addi	a2,a2,1952 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203648:	08400593          	li	a1,132
ffffffffc020364c:	00002517          	auipc	a0,0x2
ffffffffc0203650:	6bc50513          	addi	a0,a0,1724 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203654:	d21fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203658:	00002697          	auipc	a3,0x2
ffffffffc020365c:	70068693          	addi	a3,a3,1792 # ffffffffc0205d58 <default_pmm_manager+0xbc8>
ffffffffc0203660:	00001617          	auipc	a2,0x1
ffffffffc0203664:	78060613          	addi	a2,a2,1920 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203668:	07c00593          	li	a1,124
ffffffffc020366c:	00002517          	auipc	a0,0x2
ffffffffc0203670:	69c50513          	addi	a0,a0,1692 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203674:	d01fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203678:	00002697          	auipc	a3,0x2
ffffffffc020367c:	6c068693          	addi	a3,a3,1728 # ffffffffc0205d38 <default_pmm_manager+0xba8>
ffffffffc0203680:	00001617          	auipc	a2,0x1
ffffffffc0203684:	76060613          	addi	a2,a2,1888 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203688:	07b00593          	li	a1,123
ffffffffc020368c:	00002517          	auipc	a0,0x2
ffffffffc0203690:	67c50513          	addi	a0,a0,1660 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203694:	ce1fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203698 <mm_destroy>:

// mm_destroy - free mm and mm internal fields
void
mm_destroy(struct mm_struct *mm) {
ffffffffc0203698:	1141                	addi	sp,sp,-16
ffffffffc020369a:	e022                	sd	s0,0(sp)
ffffffffc020369c:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc020369e:	6508                	ld	a0,8(a0)
ffffffffc02036a0:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc02036a2:	00a40e63          	beq	s0,a0,ffffffffc02036be <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc02036a6:	6118                	ld	a4,0(a0)
ffffffffc02036a8:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc02036aa:	03000593          	li	a1,48
ffffffffc02036ae:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc02036b0:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02036b2:	e398                	sd	a4,0(a5)
ffffffffc02036b4:	97eff0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc02036b8:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc02036ba:	fea416e3          	bne	s0,a0,ffffffffc02036a6 <mm_destroy+0xe>
    }
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02036be:	8522                	mv	a0,s0
    mm=NULL;
}
ffffffffc02036c0:	6402                	ld	s0,0(sp)
...
ffffffffc02036c8:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02036ca:	968ff06f          	j	ffffffffc0202832 <kfree>

ffffffffc02036ce <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc02036ce:	715d                	addi	sp,sp,-80
ffffffffc02036d0:	e486                	sd	ra,72(sp)
ffffffffc02036d2:	f44e                	sd	s3,40(sp)
ffffffffc02036d4:	f052                	sd	s4,32(sp)
ffffffffc02036d6:	e0a2                	sd	s0,64(sp)
ffffffffc02036d8:	fc26                	sd	s1,56(sp)
ffffffffc02036da:	f84a                	sd	s2,48(sp)
ffffffffc02036dc:	ec56                	sd	s5,24(sp)
ffffffffc02036de:	e85a                	sd	s6,16(sp)
ffffffffc02036e0:	e45e                	sd	s7,8(sp)
}
...
ffffffffc02036e2:	fb1fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc02036e6:	89aa                	mv	s3,a0
...
check_vma_struct(void) {
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc02036e8:	fabfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc02036ec:	8a2a                	mv	s4,a0
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02036ee:	03000513          	li	a0,48
ffffffffc02036f2:	886ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
    if (mm != NULL) {
ffffffffc02036f6:	56050863          	beqz	a0,ffffffffc0203c66 <vmm_init+0x598>
    elm->prev = elm->next = elm;
...
ffffffffc0203706:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc020370a:	0000e797          	auipc	a5,0xe
ffffffffc020370e:	e467a783          	lw	a5,-442(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203712:	84aa                	mv	s1,a0
ffffffffc0203714:	e7b9                	bnez	a5,ffffffffc0203762 <vmm_init+0x94>
        else mm->sm_priv = NULL;
ffffffffc0203716:	02053423          	sd	zero,40(a0)
vmm_init(void) {
ffffffffc020371a:	03200413          	li	s0,50
ffffffffc020371e:	a811                	j	ffffffffc0203732 <vmm_init+0x64>
        vma->vm_start = vm_start;
...
ffffffffc0203724:	00053c23          	sd	zero,24(a0)
    ...
    int i;
    for (i = step1; i >= 1; i --) {
ffffffffc0203728:	146d                	addi	s0,s0,-5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc020372a:	8526                	mv	a0,s1
ffffffffc020372c:	e9dff0ef          	jal	ra,ffffffffc02035c8 <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc0203730:	cc05                	beqz	s0,ffffffffc0203768 <vmm_init+0x9a>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203732:	03000513          	li	a0,48
ffffffffc0203736:	842ff0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc020373a:	85aa                	mv	a1,a0
ffffffffc020373c:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203740:	f165                	bnez	a0,ffffffffc0203720 <vmm_init+0x52>
        assert(vma != NULL);
ffffffffc0203742:	00002697          	auipc	a3,0x2
ffffffffc0203746:	17e68693          	addi	a3,a3,382 # ffffffffc02058c0 <default_pmm_manager+0x730>
ffffffffc020374a:	00001617          	auipc	a2,0x1
ffffffffc020374e:	69660613          	addi	a2,a2,1686 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203752:	0ce00593          	li	a1,206
ffffffffc0203756:	00002517          	auipc	a0,0x2
ffffffffc020375a:	5b250513          	addi	a0,a0,1458 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc020375e:	c17fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203762:	823ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc0203766:	bf55                	j	ffffffffc020371a <vmm_init+0x4c>
ffffffffc0203768:	03700413          	li	s0,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc020376c:	1f900913          	li	s2,505
ffffffffc0203770:	a819                	j	ffffffffc0203786 <vmm_init+0xb8>
        vma->vm_start = vm_start;
ffffffffc0203772:	e500                	sd	s0,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203774:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203776:	00053c23          	sd	zero,24(a0)
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc020377a:	0415                	addi	s0,s0,5
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc020377c:	8526                	mv	a0,s1
ffffffffc020377e:	e4bff0ef          	jal	ra,ffffffffc02035c8 <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203782:	03240a63          	beq	s0,s2,ffffffffc02037b6 <vmm_init+0xe8>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
...
ffffffffc0203790:	00240793          	addi	a5,s0,2
    if (vma != NULL) {
ffffffffc0203794:	fd79                	bnez	a0,ffffffffc0203772 <vmm_init+0xa4>
        assert(vma != NULL);
ffffffffc0203796:	00002697          	auipc	a3,0x2
ffffffffc020379a:	12a68693          	addi	a3,a3,298 # ffffffffc02058c0 <default_pmm_manager+0x730>
ffffffffc020379e:	00001617          	auipc	a2,0x1
ffffffffc02037a2:	64260613          	addi	a2,a2,1602 # ffffffffc0204de0 <commands+0x738>
ffffffffc02037a6:	0d400593          	li	a1,212
ffffffffc02037aa:	00002517          	auipc	a0,0x2
ffffffffc02037ae:	55e50513          	addi	a0,a0,1374 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc02037b2:	bc3fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    return listelm->next;
ffffffffc02037b6:	649c                	ld	a5,8(s1)
ffffffffc02037b8:	471d                	li	a4,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc02037ba:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc02037be:	2ef48463          	beq	s1,a5,ffffffffc0203aa6 <vmm_init+0x3d8>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc02037c2:	fe87b603          	ld	a2,-24(a5)
ffffffffc02037c6:	ffe70693          	addi	a3,a4,-2
ffffffffc02037ca:	26d61e63          	bne	a2,a3,ffffffffc0203a46 <vmm_init+0x378>
ffffffffc02037ce:	ff07b683          	ld	a3,-16(a5)
ffffffffc02037d2:	26e69a63          	bne	a3,a4,ffffffffc0203a46 <vmm_init+0x378>
    for (i = 1; i <= step2; i ++) {
ffffffffc02037d6:	0715                	addi	a4,a4,5
ffffffffc02037d8:	679c                	ld	a5,8(a5)
ffffffffc02037da:	feb712e3          	bne	a4,a1,ffffffffc02037be <vmm_init+0xf0>
ffffffffc02037de:	4b1d                	li	s6,7
ffffffffc02037e0:	4415                	li	s0,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc02037e2:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc02037e6:	85a2                	mv	a1,s0
ffffffffc02037e8:	8526                	mv	a0,s1
ffffffffc02037ea:	d9fff0ef          	jal	ra,ffffffffc0203588 <find_vma>
ffffffffc02037ee:	892a                	mv	s2,a0
        assert(vma1 != NULL);
ffffffffc02037f0:	2c050b63          	beqz	a0,ffffffffc0203ac6 <vmm_init+0x3f8>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc02037f4:	00140593          	addi	a1,s0,1
ffffffffc02037f8:	8526                	mv	a0,s1
ffffffffc02037fa:	d8fff0ef          	jal	ra,ffffffffc0203588 <find_vma>
ffffffffc02037fe:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc0203800:	2e050363          	beqz	a0,ffffffffc0203ae6 <vmm_init+0x418>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc0203804:	85da                	mv	a1,s6
ffffffffc0203806:	8526                	mv	a0,s1
ffffffffc0203808:	d81ff0ef          	jal	ra,ffffffffc0203588 <find_vma>
        assert(vma3 == NULL);
ffffffffc020380c:	2e051d63          	bnez	a0,ffffffffc0203b06 <vmm_init+0x438>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc0203810:	00340593          	addi	a1,s0,3
ffffffffc0203814:	8526                	mv	a0,s1
ffffffffc0203816:	d73ff0ef          	jal	ra,ffffffffc0203588 <find_vma>
        assert(vma4 == NULL);
ffffffffc020381a:	30051663          	bnez	a0,ffffffffc0203b26 <vmm_init+0x458>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc020381e:	00440593          	addi	a1,s0,4
ffffffffc0203822:	8526                	mv	a0,s1
ffffffffc0203824:	d65ff0ef          	jal	ra,ffffffffc0203588 <find_vma>
        assert(vma5 == NULL);
ffffffffc0203828:	30051f63          	bnez	a0,ffffffffc0203b46 <vmm_init+0x478>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc020382c:	00893783          	ld	a5,8(s2)
ffffffffc0203830:	24879b63          	bne	a5,s0,ffffffffc0203a86 <vmm_init+0x3b8>
ffffffffc0203834:	01093783          	ld	a5,16(s2)
ffffffffc0203838:	25679763          	bne	a5,s6,ffffffffc0203a86 <vmm_init+0x3b8>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc020383c:	008ab783          	ld	a5,8(s5)
ffffffffc0203840:	22879363          	bne	a5,s0,ffffffffc0203a66 <vmm_init+0x398>
ffffffffc0203844:	010ab783          	ld	a5,16(s5)
ffffffffc0203848:	21679f63          	bne	a5,s6,ffffffffc0203a66 <vmm_init+0x398>
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc020384c:	0415                	addi	s0,s0,5
ffffffffc020384e:	0b15                	addi	s6,s6,5
ffffffffc0203850:	f9741be3          	bne	s0,s7,ffffffffc02037e6 <vmm_init+0x118>
ffffffffc0203854:	4411                	li	s0,4
    }

    for (i =4; i>=0; i--) {
ffffffffc0203856:	597d                	li	s2,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc0203858:	85a2                	mv	a1,s0
ffffffffc020385a:	8526                	mv	a0,s1
ffffffffc020385c:	d2dff0ef          	jal	ra,ffffffffc0203588 <find_vma>
ffffffffc0203860:	0004059b          	sext.w	a1,s0
        if (vma_below_5 != NULL ) {
ffffffffc0203864:	c90d                	beqz	a0,ffffffffc0203896 <vmm_init+0x1c8>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc0203866:	6914                	ld	a3,16(a0)
ffffffffc0203868:	6510                	ld	a2,8(a0)
ffffffffc020386a:	00002517          	auipc	a0,0x2
ffffffffc020386e:	60e50513          	addi	a0,a0,1550 # ffffffffc0205e78 <default_pmm_manager+0xce8>
ffffffffc0203872:	849fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203876:	00002697          	auipc	a3,0x2
ffffffffc020387a:	62a68693          	addi	a3,a3,1578 # ffffffffc0205ea0 <default_pmm_manager+0xd10>
ffffffffc020387e:	00001617          	auipc	a2,0x1
ffffffffc0203882:	56260613          	addi	a2,a2,1378 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203886:	0f600593          	li	a1,246
ffffffffc020388a:	00002517          	auipc	a0,0x2
ffffffffc020388e:	47e50513          	addi	a0,a0,1150 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203892:	ae3fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i =4; i>=0; i--) {
ffffffffc0203896:	147d                	addi	s0,s0,-1
ffffffffc0203898:	fd2410e3          	bne	s0,s2,ffffffffc0203858 <vmm_init+0x18a>
ffffffffc020389c:	a811                	j	ffffffffc02038b0 <vmm_init+0x1e2>
    __list_del(listelm->prev, listelm->next);
ffffffffc020389e:	6118                	ld	a4,0(a0)
ffffffffc02038a0:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc02038a2:	03000593          	li	a1,48
ffffffffc02038a6:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc02038a8:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02038aa:	e398                	sd	a4,0(a5)
ffffffffc02038ac:	f87fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc02038b0:	6488                	ld	a0,8(s1)
    while ((le = list_next(list)) != list) {
ffffffffc02038b2:	fea496e3          	bne	s1,a0,ffffffffc020389e <vmm_init+0x1d0>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02038b6:	03000593          	li	a1,48
ffffffffc02038ba:	8526                	mv	a0,s1
ffffffffc02038bc:	f77fe0ef          	jal	ra,ffffffffc0202832 <kfree>
    }

    mm_destroy(mm);

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02038c0:	dd3fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc02038c4:	3caa1163          	bne	s4,a0,ffffffffc0203c86 <vmm_init+0x5b8>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc02038c8:	00002517          	auipc	a0,0x2
ffffffffc02038cc:	61850513          	addi	a0,a0,1560 # ffffffffc0205ee0 <default_pmm_manager+0xd50>
ffffffffc02038d0:	feafc0ef          	jal	ra,ffffffffc02000ba <cprintf>
...
ffffffffc02038de:	e9bfe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc02038e2:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc02038e4:	2a050163          	beqz	a0,ffffffffc0203b86 <vmm_init+0x4b8>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02038e8:	0000e797          	auipc	a5,0xe
ffffffffc02038ec:	c687a783          	lw	a5,-920(a5) # ffffffffc0211550 <swap_init_ok>
    elm->prev = elm->next = elm;
ffffffffc02038f0:	e508                	sd	a0,8(a0)
ffffffffc02038f2:	e108                	sd	a0,0(a0)
        mm->mmap_cache = NULL;
ffffffffc02038f4:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02038f8:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc02038fc:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203900:	14079063          	bnez	a5,ffffffffc0203a40 <vmm_init+0x372>
        else mm->sm_priv = NULL;
ffffffffc0203904:	02053423          	sd	zero,40(a0)
    ...
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203908:	0000e917          	auipc	s2,0xe
ffffffffc020390c:	c1093903          	ld	s2,-1008(s2) # ffffffffc0211518 <boot_pgdir>
    assert(pgdir[0] == 0);
ffffffffc0203910:	00093783          	ld	a5,0(s2)
    check_mm_struct = mm_create();
ffffffffc0203914:	0000e717          	auipc	a4,0xe
ffffffffc0203918:	c4873623          	sd	s0,-948(a4) # ffffffffc0211560 <check_mm_struct>
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc020391c:	01243c23          	sd	s2,24(s0)
    assert(pgdir[0] == 0);
ffffffffc0203920:	24079363          	bnez	a5,ffffffffc0203b66 <vmm_init+0x498>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203924:	03000513          	li	a0,48
ffffffffc0203928:	e51fe0ef          	jal	ra,ffffffffc0202778 <kmalloc>
ffffffffc020392c:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc020392e:	28050063          	beqz	a0,ffffffffc0203bae <vmm_init+0x4e0>
        vma->vm_end = vm_end;
ffffffffc0203932:	002007b7          	lui	a5,0x200
ffffffffc0203936:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc020393a:	4789                	li	a5,2
...
ffffffffc020393c:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc020393e:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc0203942:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc0203944:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc0203948:	c81ff0ef          	jal	ra,ffffffffc02035c8 <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc020394c:	10000593          	li	a1,256
ffffffffc0203950:	8522                	mv	a0,s0
ffffffffc0203952:	c37ff0ef          	jal	ra,ffffffffc0203588 <find_vma>
ffffffffc0203956:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc020395a:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc020395e:	26aa1863          	bne	s4,a0,ffffffffc0203bce <vmm_init+0x500>
        *(char *)(addr + i) = i;
ffffffffc0203962:	00f78023          	sb	a5,0(a5) # 200000 <kern_entry-0xffffffffc0000000>
    for (i = 0; i < 100; i ++) {
ffffffffc0203966:	0785                	addi	a5,a5,1
ffffffffc0203968:	fee79de3          	bne	a5,a4,ffffffffc0203962 <vmm_init+0x294>
        sum += i;
ffffffffc020396c:	6705                	lui	a4,0x1
ffffffffc020396e:	10000793          	li	a5,256
ffffffffc0203972:	35670713          	addi	a4,a4,854 # 1356 <kern_entry-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc0203976:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc020397a:	0007c683          	lbu	a3,0(a5)
    for (i = 0; i < 100; i ++) {
ffffffffc020397e:	0785                	addi	a5,a5,1
        sum -= *(char *)(addr + i);
ffffffffc0203980:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc0203982:	fec79ce3          	bne	a5,a2,ffffffffc020397a <vmm_init+0x2ac>
    }
    assert(sum == 0);
ffffffffc0203986:	26071463          	bnez	a4,ffffffffc0203bee <vmm_init+0x520>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc020398a:	4581                	li	a1,0
ffffffffc020398c:	854a                	mv	a0,s2
ffffffffc020398e:	f8ffd0ef          	jal	ra,ffffffffc020191c <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc0203992:	00093783          	ld	a5,0(s2)
    if (PPN(pa) >= npage) {
ffffffffc0203996:	0000e717          	auipc	a4,0xe
ffffffffc020399a:	b8a73703          	ld	a4,-1142(a4) # ffffffffc0211520 <npage>
    return pa2page(PDE_ADDR(pde));
ffffffffc020399e:	078a                	slli	a5,a5,0x2
ffffffffc02039a0:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc02039a2:	26e7f663          	bgeu	a5,a4,ffffffffc0203c0e <vmm_init+0x540>
    return &pages[PPN(pa) - nbase];
ffffffffc02039a6:	00003717          	auipc	a4,0x3
ffffffffc02039aa:	92273703          	ld	a4,-1758(a4) # ffffffffc02062c8 <nbase>
...
ffffffffc02039b8:	0000e517          	auipc	a0,0xe
ffffffffc02039bc:	b7053503          	ld	a0,-1168(a0) # ffffffffc0211528 <pages>
ffffffffc02039c0:	953e                	add	a0,a0,a5
ffffffffc02039c2:	4585                	li	a1,1
ffffffffc02039c4:	c8ffd0ef          	jal	ra,ffffffffc0201652 <free_pages>
    return listelm->next;
ffffffffc02039c8:	6408                	ld	a0,8(s0)

    pgdir[0] = 0;
ffffffffc02039ca:	00093023          	sd	zero,0(s2)

    mm->pgdir = NULL;
ffffffffc02039ce:	00043c23          	sd	zero,24(s0)
    while ((le = list_next(list)) != list) {
ffffffffc02039d2:	00a40e63          	beq	s0,a0,ffffffffc02039ee <vmm_init+0x320>
    __list_del(listelm->prev, listelm->next);
ffffffffc02039d6:	6118                	ld	a4,0(a0)
ffffffffc02039d8:	651c                	ld	a5,8(a0)
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc02039da:	03000593          	li	a1,48
ffffffffc02039de:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc02039e0:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc02039e2:	e398                	sd	a4,0(a5)
ffffffffc02039e4:	e4ffe0ef          	jal	ra,ffffffffc0202832 <kfree>
    return listelm->next;
ffffffffc02039e8:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc02039ea:	fea416e3          	bne	s0,a0,ffffffffc02039d6 <vmm_init+0x308>
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc02039ee:	03000593          	li	a1,48
ffffffffc02039f2:	8522                	mv	a0,s0
ffffffffc02039f4:	e3ffe0ef          	jal	ra,ffffffffc0202832 <kfree>
    mm_destroy(mm);

    check_mm_struct = NULL;
    nr_free_pages_store--;	// szx : Sv39第二级页表多占了一个内存页，所以执行此操作
ffffffffc02039f8:	14fd                	addi	s1,s1,-1
    check_mm_struct = NULL;
ffffffffc02039fa:	0000e797          	auipc	a5,0xe
ffffffffc02039fe:	b607b323          	sd	zero,-1178(a5) # ffffffffc0211560 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a02:	c91fd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
ffffffffc0203a06:	22a49063          	bne	s1,a0,ffffffffc0203c26 <vmm_init+0x558>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc0203a0a:	00002517          	auipc	a0,0x2
ffffffffc0203a0e:	52650513          	addi	a0,a0,1318 # ffffffffc0205f30 <default_pmm_manager+0xda0>
ffffffffc0203a12:	ea8fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a16:	c7dfd0ef          	jal	ra,ffffffffc0201692 <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc0203a1a:	19fd                	addi	s3,s3,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a1c:	22a99563          	bne	s3,a0,ffffffffc0203c46 <vmm_init+0x578>
}
ffffffffc0203a20:	6406                	ld	s0,64(sp)
ffffffffc0203a22:	60a6                	ld	ra,72(sp)
ffffffffc0203a24:	74e2                	ld	s1,56(sp)
ffffffffc0203a26:	7942                	ld	s2,48(sp)
ffffffffc0203a28:	79a2                	ld	s3,40(sp)
ffffffffc0203a2a:	7a02                	ld	s4,32(sp)
ffffffffc0203a2c:	6ae2                	ld	s5,24(sp)
ffffffffc0203a2e:	6b42                	ld	s6,16(sp)
ffffffffc0203a30:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203a32:	00002517          	auipc	a0,0x2
ffffffffc0203a36:	51e50513          	addi	a0,a0,1310 # ffffffffc0205f50 <default_pmm_manager+0xdc0>
}
ffffffffc0203a3a:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203a3c:	e7efc06f          	j	ffffffffc02000ba <cprintf>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203a40:	d44ff0ef          	jal	ra,ffffffffc0202f84 <swap_init_mm>
ffffffffc0203a44:	b5d1                	j	ffffffffc0203908 <vmm_init+0x23a>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203a46:	00002697          	auipc	a3,0x2
ffffffffc0203a4a:	34a68693          	addi	a3,a3,842 # ffffffffc0205d90 <default_pmm_manager+0xc00>
ffffffffc0203a4e:	00001617          	auipc	a2,0x1
ffffffffc0203a52:	39260613          	addi	a2,a2,914 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203a56:	0dd00593          	li	a1,221
ffffffffc0203a5a:	00002517          	auipc	a0,0x2
ffffffffc0203a5e:	2ae50513          	addi	a0,a0,686 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203a62:	913fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203a66:	00002697          	auipc	a3,0x2
ffffffffc0203a6a:	3e268693          	addi	a3,a3,994 # ffffffffc0205e48 <default_pmm_manager+0xcb8>
ffffffffc0203a6e:	00001617          	auipc	a2,0x1
ffffffffc0203a72:	37260613          	addi	a2,a2,882 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203a76:	0ee00593          	li	a1,238
ffffffffc0203a7a:	00002517          	auipc	a0,0x2
ffffffffc0203a7e:	28e50513          	addi	a0,a0,654 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203a82:	8f3fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203a86:	00002697          	auipc	a3,0x2
ffffffffc0203a8a:	39268693          	addi	a3,a3,914 # ffffffffc0205e18 <default_pmm_manager+0xc88>
ffffffffc0203a8e:	00001617          	auipc	a2,0x1
ffffffffc0203a92:	35260613          	addi	a2,a2,850 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203a96:	0ed00593          	li	a1,237
ffffffffc0203a9a:	00002517          	auipc	a0,0x2
ffffffffc0203a9e:	26e50513          	addi	a0,a0,622 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203aa2:	8d3fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203aa6:	00002697          	auipc	a3,0x2
ffffffffc0203aaa:	2d268693          	addi	a3,a3,722 # ffffffffc0205d78 <default_pmm_manager+0xbe8>
ffffffffc0203aae:	00001617          	auipc	a2,0x1
ffffffffc0203ab2:	33260613          	addi	a2,a2,818 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203ab6:	0db00593          	li	a1,219
ffffffffc0203aba:	00002517          	auipc	a0,0x2
ffffffffc0203abe:	24e50513          	addi	a0,a0,590 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203ac2:	8b3fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203ac6:	00002697          	auipc	a3,0x2
ffffffffc0203aca:	30268693          	addi	a3,a3,770 # ffffffffc0205dc8 <default_pmm_manager+0xc38>
ffffffffc0203ace:	00001617          	auipc	a2,0x1
ffffffffc0203ad2:	31260613          	addi	a2,a2,786 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203ad6:	0e300593          	li	a1,227
ffffffffc0203ada:	00002517          	auipc	a0,0x2
ffffffffc0203ade:	22e50513          	addi	a0,a0,558 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203ae2:	893fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203ae6:	00002697          	auipc	a3,0x2
ffffffffc0203aea:	2f268693          	addi	a3,a3,754 # ffffffffc0205dd8 <default_pmm_manager+0xc48>
ffffffffc0203aee:	00001617          	auipc	a2,0x1
ffffffffc0203af2:	2f260613          	addi	a2,a2,754 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203af6:	0e500593          	li	a1,229
ffffffffc0203afa:	00002517          	auipc	a0,0x2
ffffffffc0203afe:	20e50513          	addi	a0,a0,526 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203b02:	873fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203b06:	00002697          	auipc	a3,0x2
ffffffffc0203b0a:	2e268693          	addi	a3,a3,738 # ffffffffc0205de8 <default_pmm_manager+0xc58>
ffffffffc0203b0e:	00001617          	auipc	a2,0x1
ffffffffc0203b12:	2d260613          	addi	a2,a2,722 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203b16:	0e700593          	li	a1,231
ffffffffc0203b1a:	00002517          	auipc	a0,0x2
ffffffffc0203b1e:	1ee50513          	addi	a0,a0,494 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203b22:	853fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203b26:	00002697          	auipc	a3,0x2
ffffffffc0203b2a:	2d268693          	addi	a3,a3,722 # ffffffffc0205df8 <default_pmm_manager+0xc68>
ffffffffc0203b2e:	00001617          	auipc	a2,0x1
ffffffffc0203b32:	2b260613          	addi	a2,a2,690 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203b36:	0e900593          	li	a1,233
ffffffffc0203b3a:	00002517          	auipc	a0,0x2
ffffffffc0203b3e:	1ce50513          	addi	a0,a0,462 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203b42:	833fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203b46:	00002697          	auipc	a3,0x2
ffffffffc0203b4a:	2c268693          	addi	a3,a3,706 # ffffffffc0205e08 <default_pmm_manager+0xc78>
ffffffffc0203b4e:	00001617          	auipc	a2,0x1
ffffffffc0203b52:	29260613          	addi	a2,a2,658 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203b56:	0eb00593          	li	a1,235
ffffffffc0203b5a:	00002517          	auipc	a0,0x2
ffffffffc0203b5e:	1ae50513          	addi	a0,a0,430 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203b62:	813fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203b66:	00002697          	auipc	a3,0x2
ffffffffc0203b6a:	d4a68693          	addi	a3,a3,-694 # ffffffffc02058b0 <default_pmm_manager+0x720>
ffffffffc0203b6e:	00001617          	auipc	a2,0x1
ffffffffc0203b72:	27260613          	addi	a2,a2,626 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203b76:	10d00593          	li	a1,269
ffffffffc0203b7a:	00002517          	auipc	a0,0x2
ffffffffc0203b7e:	18e50513          	addi	a0,a0,398 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203b82:	ff2fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203b86:	00002697          	auipc	a3,0x2
ffffffffc0203b8a:	3e268693          	addi	a3,a3,994 # ffffffffc0205f68 <default_pmm_manager+0xdd8>
ffffffffc0203b8e:	00001617          	auipc	a2,0x1
ffffffffc0203b92:	25260613          	addi	a2,a2,594 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203b96:	10a00593          	li	a1,266
ffffffffc0203b9a:	00002517          	auipc	a0,0x2
ffffffffc0203b9e:	16e50513          	addi	a0,a0,366 # ffffffffc0205d08 <default_pmm_manager+0xb78>
    check_mm_struct = mm_create();
ffffffffc0203ba2:	0000e797          	auipc	a5,0xe
ffffffffc0203ba6:	9a07bf23          	sd	zero,-1602(a5) # ffffffffc0211560 <check_mm_struct>
    assert(check_mm_struct != NULL);
ffffffffc0203baa:	fcafc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc0203bae:	00002697          	auipc	a3,0x2
ffffffffc0203bb2:	d1268693          	addi	a3,a3,-750 # ffffffffc02058c0 <default_pmm_manager+0x730>
ffffffffc0203bb6:	00001617          	auipc	a2,0x1
ffffffffc0203bba:	22a60613          	addi	a2,a2,554 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203bbe:	11100593          	li	a1,273
ffffffffc0203bc2:	00002517          	auipc	a0,0x2
ffffffffc0203bc6:	14650513          	addi	a0,a0,326 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203bca:	faafc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203bce:	00002697          	auipc	a3,0x2
ffffffffc0203bd2:	33268693          	addi	a3,a3,818 # ffffffffc0205f00 <default_pmm_manager+0xd70>
ffffffffc0203bd6:	00001617          	auipc	a2,0x1
ffffffffc0203bda:	20a60613          	addi	a2,a2,522 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203bde:	11600593          	li	a1,278
ffffffffc0203be2:	00002517          	auipc	a0,0x2
ffffffffc0203be6:	12650513          	addi	a0,a0,294 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203bea:	f8afc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203bee:	00002697          	auipc	a3,0x2
ffffffffc0203bf2:	33268693          	addi	a3,a3,818 # ffffffffc0205f20 <default_pmm_manager+0xd90>
ffffffffc0203bf6:	00001617          	auipc	a2,0x1
ffffffffc0203bfa:	1ea60613          	addi	a2,a2,490 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203bfe:	12000593          	li	a1,288
ffffffffc0203c02:	00002517          	auipc	a0,0x2
ffffffffc0203c06:	10650513          	addi	a0,a0,262 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203c0a:	f6afc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203c0e:	00001617          	auipc	a2,0x1
ffffffffc0203c12:	5ba60613          	addi	a2,a2,1466 # ffffffffc02051c8 <default_pmm_manager+0x38>
ffffffffc0203c16:	06500593          	li	a1,101
ffffffffc0203c1a:	00001517          	auipc	a0,0x1
ffffffffc0203c1e:	5ce50513          	addi	a0,a0,1486 # ffffffffc02051e8 <default_pmm_manager+0x58>
ffffffffc0203c22:	f52fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c26:	00002697          	auipc	a3,0x2
ffffffffc0203c2a:	29268693          	addi	a3,a3,658 # ffffffffc0205eb8 <default_pmm_manager+0xd28>
ffffffffc0203c2e:	00001617          	auipc	a2,0x1
ffffffffc0203c32:	1b260613          	addi	a2,a2,434 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203c36:	12e00593          	li	a1,302
ffffffffc0203c3a:	00002517          	auipc	a0,0x2
ffffffffc0203c3e:	0ce50513          	addi	a0,a0,206 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203c42:	f32fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c46:	00002697          	auipc	a3,0x2
ffffffffc0203c4a:	27268693          	addi	a3,a3,626 # ffffffffc0205eb8 <default_pmm_manager+0xd28>
ffffffffc0203c4e:	00001617          	auipc	a2,0x1
ffffffffc0203c52:	19260613          	addi	a2,a2,402 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203c56:	0bd00593          	li	a1,189
ffffffffc0203c5a:	00002517          	auipc	a0,0x2
ffffffffc0203c5e:	0ae50513          	addi	a0,a0,174 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203c62:	f12fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203c66:	00002697          	auipc	a3,0x2
ffffffffc0203c6a:	c2268693          	addi	a3,a3,-990 # ffffffffc0205888 <default_pmm_manager+0x6f8>
ffffffffc0203c6e:	00001617          	auipc	a2,0x1
ffffffffc0203c72:	17260613          	addi	a2,a2,370 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203c76:	0c700593          	li	a1,199
ffffffffc0203c7a:	00002517          	auipc	a0,0x2
ffffffffc0203c7e:	08e50513          	addi	a0,a0,142 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203c82:	ef2fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c86:	00002697          	auipc	a3,0x2
ffffffffc0203c8a:	23268693          	addi	a3,a3,562 # ffffffffc0205eb8 <default_pmm_manager+0xd28>
ffffffffc0203c8e:	00001617          	auipc	a2,0x1
ffffffffc0203c92:	15260613          	addi	a2,a2,338 # ffffffffc0204de0 <commands+0x738>
ffffffffc0203c96:	0fb00593          	li	a1,251
ffffffffc0203c9a:	00002517          	auipc	a0,0x2
ffffffffc0203c9e:	06e50513          	addi	a0,a0,110 # ffffffffc0205d08 <default_pmm_manager+0xb78>
ffffffffc0203ca2:	ed2fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203ca6 <do_pgfault>:
...
ffffffffc0203ca6:	7139                	addi	sp,sp,-64
    int ret = -E_INVAL;
    //try to find a vma which include addr
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203ca8:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203caa:	f822                	sd	s0,48(sp)
ffffffffc0203cac:	f426                	sd	s1,40(sp)
ffffffffc0203cae:	fc06                	sd	ra,56(sp)
ffffffffc0203cb0:	f04a                	sd	s2,32(sp)
ffffffffc0203cb2:	ec4e                	sd	s3,24(sp)
ffffffffc0203cb4:	8432                	mv	s0,a2
ffffffffc0203cb6:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203cb8:	8d1ff0ef          	jal	ra,ffffffffc0203588 <find_vma>

    pgfault_num++;
ffffffffc0203cbc:	0000e797          	auipc	a5,0xe
ffffffffc0203cc0:	8ac7a783          	lw	a5,-1876(a5) # ffffffffc0211568 <pgfault_num>
ffffffffc0203cc4:	2785                	addiw	a5,a5,1
ffffffffc0203cc6:	0000e717          	auipc	a4,0xe
ffffffffc0203cca:	8af72123          	sw	a5,-1886(a4) # ffffffffc0211568 <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203cce:	c15d                	beqz	a0,ffffffffc0203d74 <do_pgfault+0xce>
ffffffffc0203cd0:	651c                	ld	a5,8(a0)
ffffffffc0203cd2:	0af46163          	bltu	s0,a5,ffffffffc0203d74 <do_pgfault+0xce>
...
ffffffffc0203cd6:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203cd8:	49c1                	li	s3,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203cda:	8b89                	andi	a5,a5,2
ffffffffc0203cdc:	efa9                	bnez	a5,ffffffffc0203d36 <do_pgfault+0x90>
        perm |= (PTE_R | PTE_W);
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203cde:	75fd                	lui	a1,0xfffff
...
ffffffffc0203ce0:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203ce2:	8c6d                	and	s0,s0,a1
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203ce4:	85a2                	mv	a1,s0
ffffffffc0203ce6:	4605                	li	a2,1
ffffffffc0203ce8:	9e5fd0ef          	jal	ra,ffffffffc02016cc <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203cec:	610c                	ld	a1,0(a0)
ffffffffc0203cee:	c5a5                	beqz	a1,ffffffffc0203d56 <do_pgfault+0xb0>
        ...
        */
        if (swap_init_ok) {
ffffffffc0203cf0:	0000e797          	auipc	a5,0xe
ffffffffc0203cf4:	8607a783          	lw	a5,-1952(a5) # ffffffffc0211550 <swap_init_ok>
ffffffffc0203cf8:	c7d9                	beqz	a5,ffffffffc0203d86 <do_pgfault+0xe0>
...
ffffffffc0203cfa:	0030                	addi	a2,sp,8
ffffffffc0203cfc:	85a2                	mv	a1,s0
ffffffffc0203cfe:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203d00:	e402                	sd	zero,8(sp)
            ret=swap_in(mm,addr,&page);
ffffffffc0203d02:	baeff0ef          	jal	ra,ffffffffc02030b0 <swap_in>
ffffffffc0203d06:	892a                	mv	s2,a0
            if(ret!=0){
ffffffffc0203d08:	e90d                	bnez	a0,ffffffffc0203d3a <do_pgfault+0x94>
                cprintf("swap_in in do_pgfault failed\n");
                goto failed;
            }
            page_insert(mm->pgdir,page,addr,perm);
ffffffffc0203d0a:	65a2                	ld	a1,8(sp)
ffffffffc0203d0c:	6c88                	ld	a0,24(s1)
ffffffffc0203d0e:	86ce                	mv	a3,s3
ffffffffc0203d10:	8622                	mv	a2,s0
ffffffffc0203d12:	ca5fd0ef          	jal	ra,ffffffffc02019b6 <page_insert>
            swap_map_swappable(mm,addr,page,1);
ffffffffc0203d16:	6622                	ld	a2,8(sp)
ffffffffc0203d18:	4685                	li	a3,1
ffffffffc0203d1a:	85a2                	mv	a1,s0
ffffffffc0203d1c:	8526                	mv	a0,s1
ffffffffc0203d1e:	a72ff0ef          	jal	ra,ffffffffc0202f90 <swap_map_swappable>


            page->pra_vaddr = addr;
ffffffffc0203d22:	67a2                	ld	a5,8(sp)
ffffffffc0203d24:	e3a0                	sd	s0,64(a5)
   }
...
ffffffffc0203d28:	7442                	ld	s0,48(sp)
ffffffffc0203d2a:	74a2                	ld	s1,40(sp)
ffffffffc0203d2c:	69e2                	ld	s3,24(sp)
ffffffffc0203d2e:	854a                	mv	a0,s2
ffffffffc0203d30:	7902                	ld	s2,32(sp)
ffffffffc0203d32:	6121                	addi	sp,sp,64
ffffffffc0203d34:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203d36:	49d9                	li	s3,22
ffffffffc0203d38:	b75d                	j	ffffffffc0203cde <do_pgfault+0x38>
                cprintf("swap_in in do_pgfault failed\n");
ffffffffc0203d3a:	00002517          	auipc	a0,0x2
ffffffffc0203d3e:	29e50513          	addi	a0,a0,670 # ffffffffc0205fd8 <default_pmm_manager+0xe48>
ffffffffc0203d42:	b78fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc0203d46:	70e2                	ld	ra,56(sp)
ffffffffc0203d48:	7442                	ld	s0,48(sp)
ffffffffc0203d4a:	74a2                	ld	s1,40(sp)
ffffffffc0203d4c:	69e2                	ld	s3,24(sp)
ffffffffc0203d4e:	854a                	mv	a0,s2
ffffffffc0203d50:	7902                	ld	s2,32(sp)
ffffffffc0203d52:	6121                	addi	sp,sp,64
ffffffffc0203d54:	8082                	ret
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203d56:	6c88                	ld	a0,24(s1)
ffffffffc0203d58:	864e                	mv	a2,s3
ffffffffc0203d5a:	85a2                	mv	a1,s0
ffffffffc0203d5c:	965fe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
   ret = 0;
ffffffffc0203d60:	4901                	li	s2,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203d62:	f171                	bnez	a0,ffffffffc0203d26 <do_pgfault+0x80>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203d64:	00002517          	auipc	a0,0x2
ffffffffc0203d68:	24c50513          	addi	a0,a0,588 # ffffffffc0205fb0 <default_pmm_manager+0xe20>
ffffffffc0203d6c:	b4efc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d70:	5971                	li	s2,-4
            goto failed;
ffffffffc0203d72:	bf55                	j	ffffffffc0203d26 <do_pgfault+0x80>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203d74:	85a2                	mv	a1,s0
ffffffffc0203d76:	00002517          	auipc	a0,0x2
ffffffffc0203d7a:	20a50513          	addi	a0,a0,522 # ffffffffc0205f80 <default_pmm_manager+0xdf0>
ffffffffc0203d7e:	b3cfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203d82:	5975                	li	s2,-3
        goto failed;
ffffffffc0203d84:	b74d                	j	ffffffffc0203d26 <do_pgfault+0x80>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203d86:	00002517          	auipc	a0,0x2
ffffffffc0203d8a:	27250513          	addi	a0,a0,626 # ffffffffc0205ff8 <default_pmm_manager+0xe68>
ffffffffc0203d8e:	b2cfc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d92:	5971                	li	s2,-4
            goto failed;
ffffffffc0203d94:	bf49                	j	ffffffffc0203d26 <do_pgfault+0x80>

ffffffffc0203d96 <swapfs_init>:
#include <ide.h>
#include <pmm.h>
#include <assert.h>
...
ffffffffc0203d9a:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203d9c:	ef8fc0ef          	jal	ra,ffffffffc0200494 <ide_device_valid>
ffffffffc0203da0:	cd01                	beqz	a0,ffffffffc0203db8 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203da2:	4505                	li	a0,1
ffffffffc0203da4:	ef6fc0ef          	jal	ra,ffffffffc020049a <ide_device_size>
}
ffffffffc0203da8:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203daa:	810d                	srli	a0,a0,0x3
ffffffffc0203dac:	0000d797          	auipc	a5,0xd
ffffffffc0203db0:	78a7ba23          	sd	a0,1940(a5) # ffffffffc0211540 <max_swap_offset>
}
ffffffffc0203db4:	0141                	addi	sp,sp,16
ffffffffc0203db6:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0203db8:	00002617          	auipc	a2,0x2
ffffffffc0203dbc:	26860613          	addi	a2,a2,616 # ffffffffc0206020 <default_pmm_manager+0xe90>
ffffffffc0203dc0:	45b5                	li	a1,13
ffffffffc0203dc2:	00002517          	auipc	a0,0x2
ffffffffc0203dc6:	27e50513          	addi	a0,a0,638 # ffffffffc0206040 <default_pmm_manager+0xeb0>
ffffffffc0203dca:	daafc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203dce <swapfs_read>:

int
swapfs_read(swap_entry_t entry, struct Page *page) {
ffffffffc0203dce:	1141                	addi	sp,sp,-16
ffffffffc0203dd0:	e406                	sd	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203dd2:	00855793          	srli	a5,a0,0x8
ffffffffc0203dd6:	c3a5                	beqz	a5,ffffffffc0203e36 <swapfs_read+0x68>
ffffffffc0203dd8:	0000d717          	auipc	a4,0xd
ffffffffc0203ddc:	76873703          	ld	a4,1896(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203de0:	04e7fb63          	bgeu	a5,a4,ffffffffc0203e36 <swapfs_read+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203de4:	0000d617          	auipc	a2,0xd
ffffffffc0203de8:	74463603          	ld	a2,1860(a2) # ffffffffc0211528 <pages>
ffffffffc0203dec:	8d91                	sub	a1,a1,a2
ffffffffc0203dee:	4035d613          	srai	a2,a1,0x3
ffffffffc0203df2:	00002597          	auipc	a1,0x2
ffffffffc0203df6:	4ce5b583          	ld	a1,1230(a1) # ffffffffc02062c0 <error_string+0x38>
ffffffffc0203dfa:	02b60633          	mul	a2,a2,a1
ffffffffc0203dfe:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203e02:	00002797          	auipc	a5,0x2
ffffffffc0203e06:	4c67b783          	ld	a5,1222(a5) # ffffffffc02062c8 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e0a:	0000d717          	auipc	a4,0xd
ffffffffc0203e0e:	71673703          	ld	a4,1814(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e12:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e14:	00c61793          	slli	a5,a2,0xc
ffffffffc0203e18:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203e1a:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e1c:	02e7f963          	bgeu	a5,a4,ffffffffc0203e4e <swapfs_read+0x80>
}
ffffffffc0203e20:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e22:	0000d797          	auipc	a5,0xd
ffffffffc0203e26:	7167b783          	ld	a5,1814(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203e2a:	46a1                	li	a3,8
ffffffffc0203e2c:	963e                	add	a2,a2,a5
ffffffffc0203e2e:	4505                	li	a0,1
}
ffffffffc0203e30:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e32:	e6efc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203e36:	86aa                	mv	a3,a0
ffffffffc0203e38:	00002617          	auipc	a2,0x2
ffffffffc0203e3c:	22060613          	addi	a2,a2,544 # ffffffffc0206058 <default_pmm_manager+0xec8>
ffffffffc0203e40:	45d1                	li	a1,20
ffffffffc0203e42:	00002517          	auipc	a0,0x2
ffffffffc0203e46:	1fe50513          	addi	a0,a0,510 # ffffffffc0206040 <default_pmm_manager+0xeb0>
ffffffffc0203e4a:	d2afc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203e4e:	86b2                	mv	a3,a2
ffffffffc0203e50:	06a00593          	li	a1,106
ffffffffc0203e54:	00001617          	auipc	a2,0x1
ffffffffc0203e58:	3cc60613          	addi	a2,a2,972 # ffffffffc0205220 <default_pmm_manager+0x90>
ffffffffc0203e5c:	00001517          	auipc	a0,0x1
ffffffffc0203e60:	38c50513          	addi	a0,a0,908 # ffffffffc02051e8 <default_pmm_manager+0x58>
ffffffffc0203e64:	d10fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203e68 <swapfs_write>:
...
ffffffffc0203e6c:	00855793          	srli	a5,a0,0x8
ffffffffc0203e70:	c3a5                	beqz	a5,ffffffffc0203ed0 <swapfs_write+0x68>
ffffffffc0203e72:	0000d717          	auipc	a4,0xd
ffffffffc0203e76:	6ce73703          	ld	a4,1742(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203e7a:	04e7fb63          	bgeu	a5,a4,ffffffffc0203ed0 <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203e7e:	0000d617          	auipc	a2,0xd
ffffffffc0203e82:	6aa63603          	ld	a2,1706(a2) # ffffffffc0211528 <pages>
ffffffffc0203e86:	8d91                	sub	a1,a1,a2
ffffffffc0203e88:	4035d613          	srai	a2,a1,0x3
ffffffffc0203e8c:	00002597          	auipc	a1,0x2
ffffffffc0203e90:	4345b583          	ld	a1,1076(a1) # ffffffffc02062c0 <error_string+0x38>
ffffffffc0203e94:	02b60633          	mul	a2,a2,a1
ffffffffc0203e98:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203e9c:	00002797          	auipc	a5,0x2
ffffffffc0203ea0:	42c7b783          	ld	a5,1068(a5) # ffffffffc02062c8 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203ea4:	0000d717          	auipc	a4,0xd
ffffffffc0203ea8:	67c73703          	ld	a4,1660(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203eac:	963e                	add	a2,a2,a5
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203eae:	00c61793          	slli	a5,a2,0xc
ffffffffc0203eb2:	83b1                	srli	a5,a5,0xc
    return page2ppn(page) << PGSHIFT;
ffffffffc0203eb4:	0632                	slli	a2,a2,0xc
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203eb6:	02e7f963          	bgeu	a5,a4,ffffffffc0203ee8 <swapfs_write+0x80>
}
ffffffffc0203eba:	60a2                	ld	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203ebc:	0000d797          	auipc	a5,0xd
ffffffffc0203ec0:	67c7b783          	ld	a5,1660(a5) # ffffffffc0211538 <va_pa_offset>
ffffffffc0203ec4:	46a1                	li	a3,8
ffffffffc0203ec6:	963e                	add	a2,a2,a5
ffffffffc0203ec8:	4505                	li	a0,1
}
ffffffffc0203eca:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203ecc:	df8fc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203ed0:	86aa                	mv	a3,a0
ffffffffc0203ed2:	00002617          	auipc	a2,0x2
ffffffffc0203ed6:	18660613          	addi	a2,a2,390 # ffffffffc0206058 <default_pmm_manager+0xec8>
ffffffffc0203eda:	45e5                	li	a1,25
ffffffffc0203edc:	00002517          	auipc	a0,0x2
ffffffffc0203ee0:	16450513          	addi	a0,a0,356 # ffffffffc0206040 <default_pmm_manager+0xeb0>
ffffffffc0203ee4:	c90fc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203ee8:	86b2                	mv	a3,a2
ffffffffc0203eea:	06a00593          	li	a1,106
ffffffffc0203eee:	00001617          	auipc	a2,0x1
ffffffffc0203ef2:	33260613          	addi	a2,a2,818 # ffffffffc0205220 <default_pmm_manager+0x90>
ffffffffc0203ef6:	00001517          	auipc	a0,0x1
ffffffffc0203efa:	2f250513          	addi	a0,a0,754 # ffffffffc02051e8 <default_pmm_manager+0x58>
ffffffffc0203efe:	c76fc0ef          	jal	ra,ffffffffc0200374 <__panic>
...
ffffffffc0203f40:	13c78793          	addi	a5,a5,316 # ffffffffc0206078 <default_pmm_manager+0xee8>
...
ffffffffc0203f9c:	114a8a93          	addi	s5,s5,276 # ffffffffc02060ac <default_pmm_manager+0xf1c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203fa4:	2e8b8b93          	addi	s7,s7,744 # ffffffffc0206288 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
...
ffffffffc02041fa:	eb260613          	addi	a2,a2,-334 # ffffffffc02060a8 <default_pmm_manager+0xf18>
...
ffffffffc020420c:	e9060613          	addi	a2,a2,-368 # ffffffffc0206098 <default_pmm_manager+0xf08>
...
ffffffffc020421e:	e7640413          	addi	s0,s0,-394 # ffffffffc0206090 <default_pmm_manager+0xf00>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204222:	85e2                	mv	a1,s8
ffffffffc0204224:	8522                	mv	a0,s0
ffffffffc0204226:	e43e                	sd	a5,8(sp)
ffffffffc0204228:	196000ef          	jal	ra,ffffffffc02043be <strnlen>
...
ffffffffc02042a8:	dec40413          	addi	s0,s0,-532 # ffffffffc0206090 <default_pmm_manager+0xf00>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
ffffffffc02042be:	dd7a0a13          	addi	s4,s4,-553 # ffffffffc0206091 <default_pmm_manager+0xf01>
...
ffffffffc020430a:	da250513          	addi	a0,a0,-606 # ffffffffc02060a8 <default_pmm_manager+0xf18>
...
strlen(const char *s) {
ffffffffc02043a8:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc02043aa:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc02043ac:	cb81                	beqz	a5,ffffffffc02043bc <strlen+0x18>
        cnt ++;
ffffffffc02043ae:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc02043b0:	00a707b3          	add	a5,a4,a0
ffffffffc02043b4:	0007c783          	lbu	a5,0(a5)
ffffffffc02043b8:	fbfd                	bnez	a5,ffffffffc02043ae <strlen+0xa>
...
ffffffffc02043be:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc02043c0:	e589                	bnez	a1,ffffffffc02043ca <strnlen+0xc>
ffffffffc02043c2:	a811                	j	ffffffffc02043d6 <strnlen+0x18>
        cnt ++;
ffffffffc02043c4:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc02043c6:	00f58863          	beq	a1,a5,ffffffffc02043d6 <strnlen+0x18>
ffffffffc02043ca:	00f50733          	add	a4,a0,a5
ffffffffc02043ce:	00074703          	lbu	a4,0(a4)
ffffffffc02043d2:	fb6d                	bnez	a4,ffffffffc02043c4 <strnlen+0x6>
ffffffffc02043d4:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc02043d6:	852e                	mv	a0,a1
ffffffffc02043d8:	8082                	ret

ffffffffc02043da <strcpy>:
char *
...
ffffffffc02043e8:	fb75                	bnez	a4,ffffffffc02043dc <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc02043f0:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc02043f4:	cb89                	beqz	a5,ffffffffc0204406 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc02043f6:	0505                	addi	a0,a0,1
ffffffffc02043f8:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc02043fa:	fee789e3          	beq	a5,a4,ffffffffc02043ec <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc02043fe:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204402:	9d19                	subw	a0,a0,a4
ffffffffc0204404:	8082                	ret
ffffffffc0204406:	4501                	li	a0,0
ffffffffc0204408:	bfed                	j	ffffffffc0204402 <strcmp+0x16>

ffffffffc020440a <strchr>:
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc020440a:	00054783          	lbu	a5,0(a0)
ffffffffc020440e:	c799                	beqz	a5,ffffffffc020441c <strchr+0x12>
        if (*s == c) {
ffffffffc0204410:	00f58763          	beq	a1,a5,ffffffffc020441e <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204414:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204418:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc020441a:	fbfd                	bnez	a5,ffffffffc0204410 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204420:	ca01                	beqz	a2,ffffffffc0204430 <memset+0x10>
ffffffffc0204422:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204424:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204426:	0785                	addi	a5,a5,1
ffffffffc0204428:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc020442c:	fec79de3          	bne	a5,a2,ffffffffc0204426 <memset+0x6>
    }
    return s;
...
ffffffffc0204432 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204432:	ca19                	beqz	a2,ffffffffc0204448 <memcpy+0x16>
ffffffffc0204434:	962e                	add	a2,a2,a1
    char *d = dst;
...
ffffffffc0204440:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204444:	fec59ae3          	bne	a1,a2,ffffffffc0204438 <memcpy+0x6>
    }
    return dst;
