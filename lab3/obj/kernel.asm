...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	38e040ef          	jal	ra,ffffffffc02043d8 <memset>

    const char *message = "(THU.CST) os is loading ...";
    cprintf("%s\n\n", message);
ffffffffc020004e:	00004597          	auipc	a1,0x4
ffffffffc0200052:	3ba58593          	addi	a1,a1,954 # ffffffffc0204408 <etext+0x6>
ffffffffc0200056:	00004517          	auipc	a0,0x4
ffffffffc020005a:	3d250513          	addi	a0,a0,978 # ffffffffc0204428 <etext+0x26>
...
ffffffffc02000ac:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000ae:	679030ef          	jal	ra,ffffffffc0203f26 <vprintfmt>
    return cnt;
}
...
ffffffffc02000e2:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e4:	643030ef          	jal	ra,ffffffffc0203f26 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc0200108:	32c50513          	addi	a0,a0,812 # ffffffffc0204430 <etext+0x2e>
void print_kerninfo(void) {
...
ffffffffc020011e:	33650513          	addi	a0,a0,822 # ffffffffc0204450 <etext+0x4e>
ffffffffc0200122:	f99ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc0200126:	00004597          	auipc	a1,0x4
ffffffffc020012a:	2dc58593          	addi	a1,a1,732 # ffffffffc0204402 <etext>
ffffffffc020012e:	00004517          	auipc	a0,0x4
ffffffffc0200132:	34250513          	addi	a0,a0,834 # ffffffffc0204470 <etext+0x6e>
...
ffffffffc0200146:	34e50513          	addi	a0,a0,846 # ffffffffc0204490 <etext+0x8e>
...
ffffffffc020015a:	35a50513          	addi	a0,a0,858 # ffffffffc02044b0 <etext+0xae>
...
ffffffffc0200188:	34c50513          	addi	a0,a0,844 # ffffffffc02044d0 <etext+0xce>
}
...
ffffffffc0200196:	36e60613          	addi	a2,a2,878 # ffffffffc0204500 <etext+0xfe>
ffffffffc020019a:	04e00593          	li	a1,78
ffffffffc020019e:	00004517          	auipc	a0,0x4
ffffffffc02001a2:	37a50513          	addi	a0,a0,890 # ffffffffc0204518 <etext+0x116>
void print_stackframe(void) {
...
ffffffffc02001b2:	38260613          	addi	a2,a2,898 # ffffffffc0204530 <etext+0x12e>
ffffffffc02001b6:	00004597          	auipc	a1,0x4
ffffffffc02001ba:	39a58593          	addi	a1,a1,922 # ffffffffc0204550 <etext+0x14e>
ffffffffc02001be:	00004517          	auipc	a0,0x4
ffffffffc02001c2:	39a50513          	addi	a0,a0,922 # ffffffffc0204558 <etext+0x156>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d0:	39c60613          	addi	a2,a2,924 # ffffffffc0204568 <etext+0x166>
ffffffffc02001d4:	00004597          	auipc	a1,0x4
ffffffffc02001d8:	3bc58593          	addi	a1,a1,956 # ffffffffc0204590 <etext+0x18e>
ffffffffc02001dc:	00004517          	auipc	a0,0x4
ffffffffc02001e0:	37c50513          	addi	a0,a0,892 # ffffffffc0204558 <etext+0x156>
ffffffffc02001e4:	ed7ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
ffffffffc02001e8:	00004617          	auipc	a2,0x4
ffffffffc02001ec:	3b860613          	addi	a2,a2,952 # ffffffffc02045a0 <etext+0x19e>
ffffffffc02001f0:	00004597          	auipc	a1,0x4
ffffffffc02001f4:	3d058593          	addi	a1,a1,976 # ffffffffc02045c0 <etext+0x1be>
ffffffffc02001f8:	00004517          	auipc	a0,0x4
ffffffffc02001fc:	36050513          	addi	a0,a0,864 # ffffffffc0204558 <etext+0x156>
...
ffffffffc0200236:	39e50513          	addi	a0,a0,926 # ffffffffc02045d0 <etext+0x1ce>
kmonitor(struct trapframe *tf) {
...
ffffffffc0200258:	3a450513          	addi	a0,a0,932 # ffffffffc02045f8 <etext+0x1f6>
...
ffffffffc020026e:	3f6c0c13          	addi	s8,s8,1014 # ffffffffc0204660 <commands>
        if ((buf = readline("")) != NULL) {
ffffffffc0200272:	00005917          	auipc	s2,0x5
ffffffffc0200276:	7fe90913          	addi	s2,s2,2046 # ffffffffc0205a70 <default_pmm_manager+0x928>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020027a:	00004497          	auipc	s1,0x4
ffffffffc020027e:	3a648493          	addi	s1,s1,934 # ffffffffc0204620 <etext+0x21e>
        if (argc == MAXARGS - 1) {
ffffffffc0200282:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200284:	00004b17          	auipc	s6,0x4
ffffffffc0200288:	3a4b0b13          	addi	s6,s6,932 # ffffffffc0204628 <etext+0x226>
        argv[argc ++] = buf;
ffffffffc020028c:	00004a17          	auipc	s4,0x4
ffffffffc0200290:	2c4a0a13          	addi	s4,s4,708 # ffffffffc0204550 <etext+0x14e>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200294:	4a8d                	li	s5,3
        if ((buf = readline("")) != NULL) {
ffffffffc0200296:	854a                	mv	a0,s2
ffffffffc0200298:	010040ef          	jal	ra,ffffffffc02042a8 <readline>
...
ffffffffc02002b2:	3b2d0d13          	addi	s10,s10,946 # ffffffffc0204660 <commands>
        argv[argc ++] = buf;
...
ffffffffc02002ba:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002bc:	0e8040ef          	jal	ra,ffffffffc02043a4 <strcmp>
...
ffffffffc02002ce:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02002d0:	0d4040ef          	jal	ra,ffffffffc02043a4 <strcmp>
...
ffffffffc020030e:	0b4040ef          	jal	ra,ffffffffc02043c2 <strchr>
...
ffffffffc020034c:	076040ef          	jal	ra,ffffffffc02043c2 <strchr>
...
ffffffffc020036a:	2e250513          	addi	a0,a0,738 # ffffffffc0204648 <etext+0x246>
...
ffffffffc02003a6:	30650513          	addi	a0,a0,774 # ffffffffc02046a8 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc02003bc:	20850513          	addi	a0,a0,520 # ffffffffc02055c0 <default_pmm_manager+0x478>
...
ffffffffc02003fa:	2d250513          	addi	a0,a0,722 # ffffffffc02046c8 <commands+0x68>
    ticks = 0;
...
ffffffffc02004b6:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004b8:	733030ef          	jal	ra,ffffffffc02043ea <memcpy>
    return 0;
}
...
ffffffffc02004da:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004dc:	70f030ef          	jal	ra,ffffffffc02043ea <memcpy>
    return 0;
}
...
ffffffffc0200528:	1c450513          	addi	a0,a0,452 # ffffffffc02046e8 <commands+0x88>
...
ffffffffc0200550:	1bc60613          	addi	a2,a2,444 # ffffffffc0204708 <commands+0xa8>
ffffffffc0200554:	07800593          	li	a1,120
ffffffffc0200558:	00004517          	auipc	a0,0x4
ffffffffc020055c:	1c850513          	addi	a0,a0,456 # ffffffffc0204720 <commands+0xc0>
...
ffffffffc020058e:	1ae50513          	addi	a0,a0,430 # ffffffffc0204738 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200746:	2de50513          	addi	a0,a0,734 # ffffffffc0204a20 <commands+0x3c0>
}
...
ffffffffc020075a:	2e250513          	addi	a0,a0,738 # ffffffffc0204a38 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200772:	2e250513          	addi	a0,a0,738 # ffffffffc0204a50 <commands+0x3f0>
ffffffffc0200776:	945ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  epc      0x%08x\n", tf->epc);
ffffffffc020077a:	10843583          	ld	a1,264(s0)
ffffffffc020077e:	00004517          	auipc	a0,0x4
ffffffffc0200782:	2ea50513          	addi	a0,a0,746 # ffffffffc0204a68 <commands+0x408>
ffffffffc0200786:	935ff0ef          	jal	ra,ffffffffc02000ba <cprintf>
    cprintf("  badvaddr 0x%08x\n", tf->badvaddr);
ffffffffc020078a:	11043583          	ld	a1,272(s0)
ffffffffc020078e:	00004517          	auipc	a0,0x4
ffffffffc0200792:	2f250513          	addi	a0,a0,754 # ffffffffc0204a80 <commands+0x420>
...
ffffffffc02007a6:	2f650513          	addi	a0,a0,758 # ffffffffc0204a98 <commands+0x438>
}
...
ffffffffc02007c2:	3a270713          	addi	a4,a4,930 # ffffffffc0204b60 <commands+0x500>
...
ffffffffc02007d4:	34050513          	addi	a0,a0,832 # ffffffffc0204b10 <commands+0x4b0>
ffffffffc02007d8:	8e3ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02007dc:	00004517          	auipc	a0,0x4
ffffffffc02007e0:	31450513          	addi	a0,a0,788 # ffffffffc0204af0 <commands+0x490>
ffffffffc02007e4:	8d7ff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02007e8:	00004517          	auipc	a0,0x4
ffffffffc02007ec:	2c850513          	addi	a0,a0,712 # ffffffffc0204ab0 <commands+0x450>
ffffffffc02007f0:	8cbff06f          	j	ffffffffc02000ba <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02007f4:	00004517          	auipc	a0,0x4
ffffffffc02007f8:	2dc50513          	addi	a0,a0,732 # ffffffffc0204ad0 <commands+0x470>
...
ffffffffc020082a:	31a50513          	addi	a0,a0,794 # ffffffffc0204b40 <commands+0x4e0>
...
ffffffffc020083e:	2f650513          	addi	a0,a0,758 # ffffffffc0204b30 <commands+0x4d0>
}
...
ffffffffc0200860:	4ec70713          	addi	a4,a4,1260 # ffffffffc0204d48 <commands+0x6e8>
...
ffffffffc0200872:	4c250513          	addi	a0,a0,1218 # ffffffffc0204d30 <commands+0x6d0>
...
ffffffffc0200894:	30050513          	addi	a0,a0,768 # ffffffffc0204b90 <commands+0x530>
}
...
ffffffffc02008a8:	30c50513          	addi	a0,a0,780 # ffffffffc0204bb0 <commands+0x550>
ffffffffc02008ac:	b7f5                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Illegal instruction\n");
ffffffffc02008ae:	00004517          	auipc	a0,0x4
ffffffffc02008b2:	32250513          	addi	a0,a0,802 # ffffffffc0204bd0 <commands+0x570>
ffffffffc02008b6:	b7cd                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Breakpoint\n");
ffffffffc02008b8:	00004517          	auipc	a0,0x4
ffffffffc02008bc:	33050513          	addi	a0,a0,816 # ffffffffc0204be8 <commands+0x588>
ffffffffc02008c0:	bfe1                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load address misaligned\n");
ffffffffc02008c2:	00004517          	auipc	a0,0x4
ffffffffc02008c6:	33650513          	addi	a0,a0,822 # ffffffffc0204bf8 <commands+0x598>
ffffffffc02008ca:	b7f9                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc02008cc:	00004517          	auipc	a0,0x4
ffffffffc02008d0:	34c50513          	addi	a0,a0,844 # ffffffffc0204c18 <commands+0x5b8>
...
ffffffffc02008ee:	34660613          	addi	a2,a2,838 # ffffffffc0204c30 <commands+0x5d0>
ffffffffc02008f2:	0ca00593          	li	a1,202
ffffffffc02008f6:	00004517          	auipc	a0,0x4
ffffffffc02008fa:	e2a50513          	addi	a0,a0,-470 # ffffffffc0204720 <commands+0xc0>
ffffffffc02008fe:	a77ff0ef          	jal	ra,ffffffffc0200374 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc0200902:	00004517          	auipc	a0,0x4
ffffffffc0200906:	34e50513          	addi	a0,a0,846 # ffffffffc0204c50 <commands+0x5f0>
ffffffffc020090a:	b779                	j	ffffffffc0200898 <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc020090c:	00004517          	auipc	a0,0x4
ffffffffc0200910:	35c50513          	addi	a0,a0,860 # ffffffffc0204c68 <commands+0x608>
...
ffffffffc0200998:	29c60613          	addi	a2,a2,668 # ffffffffc0204c30 <commands+0x5d0>
ffffffffc020099c:	0ea00593          	li	a1,234
ffffffffc02009a0:	00004517          	auipc	a0,0x4
ffffffffc02009a4:	d8050513          	addi	a0,a0,-640 # ffffffffc0204720 <commands+0xc0>
...
ffffffffc02009c4:	27060613          	addi	a2,a2,624 # ffffffffc0204c30 <commands+0x5d0>
ffffffffc02009c8:	0f100593          	li	a1,241
ffffffffc02009cc:	00004517          	auipc	a0,0x4
ffffffffc02009d0:	d5450513          	addi	a0,a0,-684 # ffffffffc0204720 <commands+0xc0>
...
ffffffffc0200dc6:	fc668693          	addi	a3,a3,-58 # ffffffffc0204d88 <commands+0x728>
ffffffffc0200dca:	00004617          	auipc	a2,0x4
ffffffffc0200dce:	fce60613          	addi	a2,a2,-50 # ffffffffc0204d98 <commands+0x738>
ffffffffc0200dd2:	0f000593          	li	a1,240
ffffffffc0200dd6:	00004517          	auipc	a0,0x4
ffffffffc0200dda:	fda50513          	addi	a0,a0,-38 # ffffffffc0204db0 <commands+0x750>
ffffffffc0200dde:	d96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200de2:	00004697          	auipc	a3,0x4
ffffffffc0200de6:	06668693          	addi	a3,a3,102 # ffffffffc0204e48 <commands+0x7e8>
ffffffffc0200dea:	00004617          	auipc	a2,0x4
ffffffffc0200dee:	fae60613          	addi	a2,a2,-82 # ffffffffc0204d98 <commands+0x738>
ffffffffc0200df2:	0bd00593          	li	a1,189
ffffffffc0200df6:	00004517          	auipc	a0,0x4
ffffffffc0200dfa:	fba50513          	addi	a0,a0,-70 # ffffffffc0204db0 <commands+0x750>
ffffffffc0200dfe:	d76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200e02:	00004697          	auipc	a3,0x4
ffffffffc0200e06:	06e68693          	addi	a3,a3,110 # ffffffffc0204e70 <commands+0x810>
ffffffffc0200e0a:	00004617          	auipc	a2,0x4
ffffffffc0200e0e:	f8e60613          	addi	a2,a2,-114 # ffffffffc0204d98 <commands+0x738>
ffffffffc0200e12:	0be00593          	li	a1,190
ffffffffc0200e16:	00004517          	auipc	a0,0x4
ffffffffc0200e1a:	f9a50513          	addi	a0,a0,-102 # ffffffffc0204db0 <commands+0x750>
ffffffffc0200e1e:	d56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200e22:	00004697          	auipc	a3,0x4
ffffffffc0200e26:	08e68693          	addi	a3,a3,142 # ffffffffc0204eb0 <commands+0x850>
ffffffffc0200e2a:	00004617          	auipc	a2,0x4
ffffffffc0200e2e:	f6e60613          	addi	a2,a2,-146 # ffffffffc0204d98 <commands+0x738>
ffffffffc0200e32:	0c000593          	li	a1,192
ffffffffc0200e36:	00004517          	auipc	a0,0x4
ffffffffc0200e3a:	f7a50513          	addi	a0,a0,-134 # ffffffffc0204db0 <commands+0x750>
ffffffffc0200e3e:	d36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200e42:	00004697          	auipc	a3,0x4
ffffffffc0200e46:	0f668693          	addi	a3,a3,246 # ffffffffc0204f38 <commands+0x8d8>
ffffffffc0200e4a:	00004617          	auipc	a2,0x4
ffffffffc0200e4e:	f4e60613          	addi	a2,a2,-178 # ffffffffc0204d98 <commands+0x738>
ffffffffc0200e52:	0d900593          	li	a1,217
ffffffffc0200e56:	00004517          	auipc	a0,0x4
ffffffffc0200e5a:	f5a50513          	addi	a0,a0,-166 # ffffffffc0204db0 <commands+0x750>
ffffffffc0200e5e:	d16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200e62:	00004697          	auipc	a3,0x4
ffffffffc0200e66:	f8668693          	addi	a3,a3,-122 # ffffffffc0204de8 <commands+0x788>
ffffffffc0200e6a:	00004617          	auipc	a2,0x4
ffffffffc0200e6e:	f2e60613          	addi	a2,a2,-210 # ffffffffc0204d98 <commands+0x738>
ffffffffc0200e72:	0d200593          	li	a1,210
ffffffffc0200e76:	00004517          	auipc	a0,0x4
ffffffffc0200e7a:	f3a50513          	addi	a0,a0,-198 # ffffffffc0204db0 <commands+0x750>
ffffffffc0200e7e:	cf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 3);
ffffffffc0200e82:	00004697          	auipc	a3,0x4
ffffffffc0200e86:	0a668693          	addi	a3,a3,166 # ffffffffc0204f28 <commands+0x8c8>
ffffffffc0200e8a:	00004617          	auipc	a2,0x4
ffffffffc0200e8e:	f0e60613          	addi	a2,a2,-242 # ffffffffc0204d98 <commands+0x738>
ffffffffc0200e92:	0d000593          	li	a1,208
ffffffffc0200e96:	00004517          	auipc	a0,0x4
ffffffffc0200e9a:	f1a50513          	addi	a0,a0,-230 # ffffffffc0204db0 <commands+0x750>
ffffffffc0200e9e:	cd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200ea2:	00004697          	auipc	a3,0x4
ffffffffc0200ea6:	06e68693          	addi	a3,a3,110 # ffffffffc0204f10 <commands+0x8b0>
ffffffffc0200eaa:	00004617          	auipc	a2,0x4
ffffffffc0200eae:	eee60613          	addi	a2,a2,-274 # ffffffffc0204d98 <commands+0x738>
ffffffffc0200eb2:	0cb00593          	li	a1,203
ffffffffc0200eb6:	00004517          	auipc	a0,0x4
ffffffffc0200eba:	efa50513          	addi	a0,a0,-262 # ffffffffc0204db0 <commands+0x750>
ffffffffc0200ebe:	cb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200ec2:	00004697          	auipc	a3,0x4
ffffffffc0200ec6:	02e68693          	addi	a3,a3,46 # ffffffffc0204ef0 <commands+0x890>
ffffffffc0200eca:	00004617          	auipc	a2,0x4
ffffffffc0200ece:	ece60613          	addi	a2,a2,-306 # ffffffffc0204d98 <commands+0x738>
ffffffffc0200ed2:	0c200593          	li	a1,194
ffffffffc0200ed6:	00004517          	auipc	a0,0x4
ffffffffc0200eda:	eda50513          	addi	a0,a0,-294 # ffffffffc0204db0 <commands+0x750>
ffffffffc0200ede:	c96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != NULL);
ffffffffc0200ee2:	00004697          	auipc	a3,0x4
ffffffffc0200ee6:	09e68693          	addi	a3,a3,158 # ffffffffc0204f80 <commands+0x920>
ffffffffc0200eea:	00004617          	auipc	a2,0x4
ffffffffc0200eee:	eae60613          	addi	a2,a2,-338 # ffffffffc0204d98 <commands+0x738>
ffffffffc0200ef2:	0f800593          	li	a1,248
ffffffffc0200ef6:	00004517          	auipc	a0,0x4
ffffffffc0200efa:	eba50513          	addi	a0,a0,-326 # ffffffffc0204db0 <commands+0x750>
ffffffffc0200efe:	c76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0200f02:	00004697          	auipc	a3,0x4
ffffffffc0200f06:	06e68693          	addi	a3,a3,110 # ffffffffc0204f70 <commands+0x910>
ffffffffc0200f0a:	00004617          	auipc	a2,0x4
ffffffffc0200f0e:	e8e60613          	addi	a2,a2,-370 # ffffffffc0204d98 <commands+0x738>
ffffffffc0200f12:	0df00593          	li	a1,223
ffffffffc0200f16:	00004517          	auipc	a0,0x4
ffffffffc0200f1a:	e9a50513          	addi	a0,a0,-358 # ffffffffc0204db0 <commands+0x750>
ffffffffc0200f1e:	c56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f22:	00004697          	auipc	a3,0x4
ffffffffc0200f26:	fee68693          	addi	a3,a3,-18 # ffffffffc0204f10 <commands+0x8b0>
ffffffffc0200f2a:	00004617          	auipc	a2,0x4
ffffffffc0200f2e:	e6e60613          	addi	a2,a2,-402 # ffffffffc0204d98 <commands+0x738>
ffffffffc0200f32:	0dd00593          	li	a1,221
ffffffffc0200f36:	00004517          	auipc	a0,0x4
ffffffffc0200f3a:	e7a50513          	addi	a0,a0,-390 # ffffffffc0204db0 <commands+0x750>
ffffffffc0200f3e:	c36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200f42:	00004697          	auipc	a3,0x4
ffffffffc0200f46:	00e68693          	addi	a3,a3,14 # ffffffffc0204f50 <commands+0x8f0>
ffffffffc0200f4a:	00004617          	auipc	a2,0x4
ffffffffc0200f4e:	e4e60613          	addi	a2,a2,-434 # ffffffffc0204d98 <commands+0x738>
ffffffffc0200f52:	0dc00593          	li	a1,220
ffffffffc0200f56:	00004517          	auipc	a0,0x4
ffffffffc0200f5a:	e5a50513          	addi	a0,a0,-422 # ffffffffc0204db0 <commands+0x750>
ffffffffc0200f5e:	c16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f62:	00004697          	auipc	a3,0x4
ffffffffc0200f66:	e8668693          	addi	a3,a3,-378 # ffffffffc0204de8 <commands+0x788>
ffffffffc0200f6a:	00004617          	auipc	a2,0x4
ffffffffc0200f6e:	e2e60613          	addi	a2,a2,-466 # ffffffffc0204d98 <commands+0x738>
ffffffffc0200f72:	0b900593          	li	a1,185
ffffffffc0200f76:	00004517          	auipc	a0,0x4
ffffffffc0200f7a:	e3a50513          	addi	a0,a0,-454 # ffffffffc0204db0 <commands+0x750>
ffffffffc0200f7e:	bf6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f82:	00004697          	auipc	a3,0x4
ffffffffc0200f86:	f8e68693          	addi	a3,a3,-114 # ffffffffc0204f10 <commands+0x8b0>
ffffffffc0200f8a:	00004617          	auipc	a2,0x4
ffffffffc0200f8e:	e0e60613          	addi	a2,a2,-498 # ffffffffc0204d98 <commands+0x738>
ffffffffc0200f92:	0d600593          	li	a1,214
ffffffffc0200f96:	00004517          	auipc	a0,0x4
ffffffffc0200f9a:	e1a50513          	addi	a0,a0,-486 # ffffffffc0204db0 <commands+0x750>
ffffffffc0200f9e:	bd6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fa2:	00004697          	auipc	a3,0x4
ffffffffc0200fa6:	e8668693          	addi	a3,a3,-378 # ffffffffc0204e28 <commands+0x7c8>
ffffffffc0200faa:	00004617          	auipc	a2,0x4
ffffffffc0200fae:	dee60613          	addi	a2,a2,-530 # ffffffffc0204d98 <commands+0x738>
ffffffffc0200fb2:	0d400593          	li	a1,212
ffffffffc0200fb6:	00004517          	auipc	a0,0x4
ffffffffc0200fba:	dfa50513          	addi	a0,a0,-518 # ffffffffc0204db0 <commands+0x750>
ffffffffc0200fbe:	bb6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0200fc2:	00004697          	auipc	a3,0x4
ffffffffc0200fc6:	e4668693          	addi	a3,a3,-442 # ffffffffc0204e08 <commands+0x7a8>
ffffffffc0200fca:	00004617          	auipc	a2,0x4
ffffffffc0200fce:	dce60613          	addi	a2,a2,-562 # ffffffffc0204d98 <commands+0x738>
ffffffffc0200fd2:	0d300593          	li	a1,211
ffffffffc0200fd6:	00004517          	auipc	a0,0x4
ffffffffc0200fda:	dda50513          	addi	a0,a0,-550 # ffffffffc0204db0 <commands+0x750>
ffffffffc0200fde:	b96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0200fe2:	00004697          	auipc	a3,0x4
ffffffffc0200fe6:	e4668693          	addi	a3,a3,-442 # ffffffffc0204e28 <commands+0x7c8>
ffffffffc0200fea:	00004617          	auipc	a2,0x4
ffffffffc0200fee:	dae60613          	addi	a2,a2,-594 # ffffffffc0204d98 <commands+0x738>
ffffffffc0200ff2:	0bb00593          	li	a1,187
ffffffffc0200ff6:	00004517          	auipc	a0,0x4
ffffffffc0200ffa:	dba50513          	addi	a0,a0,-582 # ffffffffc0204db0 <commands+0x750>
ffffffffc0200ffe:	b76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(count == 0);
ffffffffc0201002:	00004697          	auipc	a3,0x4
ffffffffc0201006:	0ce68693          	addi	a3,a3,206 # ffffffffc02050d0 <commands+0xa70>
ffffffffc020100a:	00004617          	auipc	a2,0x4
ffffffffc020100e:	d8e60613          	addi	a2,a2,-626 # ffffffffc0204d98 <commands+0x738>
ffffffffc0201012:	12500593          	li	a1,293
ffffffffc0201016:	00004517          	auipc	a0,0x4
ffffffffc020101a:	d9a50513          	addi	a0,a0,-614 # ffffffffc0204db0 <commands+0x750>
ffffffffc020101e:	b56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0201022:	00004697          	auipc	a3,0x4
ffffffffc0201026:	f4e68693          	addi	a3,a3,-178 # ffffffffc0204f70 <commands+0x910>
ffffffffc020102a:	00004617          	auipc	a2,0x4
ffffffffc020102e:	d6e60613          	addi	a2,a2,-658 # ffffffffc0204d98 <commands+0x738>
ffffffffc0201032:	11a00593          	li	a1,282
ffffffffc0201036:	00004517          	auipc	a0,0x4
ffffffffc020103a:	d7a50513          	addi	a0,a0,-646 # ffffffffc0204db0 <commands+0x750>
ffffffffc020103e:	b36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201042:	00004697          	auipc	a3,0x4
ffffffffc0201046:	ece68693          	addi	a3,a3,-306 # ffffffffc0204f10 <commands+0x8b0>
ffffffffc020104a:	00004617          	auipc	a2,0x4
ffffffffc020104e:	d4e60613          	addi	a2,a2,-690 # ffffffffc0204d98 <commands+0x738>
ffffffffc0201052:	11800593          	li	a1,280
ffffffffc0201056:	00004517          	auipc	a0,0x4
ffffffffc020105a:	d5a50513          	addi	a0,a0,-678 # ffffffffc0204db0 <commands+0x750>
ffffffffc020105e:	b16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201062:	00004697          	auipc	a3,0x4
ffffffffc0201066:	e6e68693          	addi	a3,a3,-402 # ffffffffc0204ed0 <commands+0x870>
ffffffffc020106a:	00004617          	auipc	a2,0x4
ffffffffc020106e:	d2e60613          	addi	a2,a2,-722 # ffffffffc0204d98 <commands+0x738>
ffffffffc0201072:	0c100593          	li	a1,193
ffffffffc0201076:	00004517          	auipc	a0,0x4
ffffffffc020107a:	d3a50513          	addi	a0,a0,-710 # ffffffffc0204db0 <commands+0x750>
ffffffffc020107e:	af6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201082:	00004697          	auipc	a3,0x4
ffffffffc0201086:	00e68693          	addi	a3,a3,14 # ffffffffc0205090 <commands+0xa30>
ffffffffc020108a:	00004617          	auipc	a2,0x4
ffffffffc020108e:	d0e60613          	addi	a2,a2,-754 # ffffffffc0204d98 <commands+0x738>
ffffffffc0201092:	11200593          	li	a1,274
ffffffffc0201096:	00004517          	auipc	a0,0x4
ffffffffc020109a:	d1a50513          	addi	a0,a0,-742 # ffffffffc0204db0 <commands+0x750>
ffffffffc020109e:	ad6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc02010a2:	00004697          	auipc	a3,0x4
ffffffffc02010a6:	fce68693          	addi	a3,a3,-50 # ffffffffc0205070 <commands+0xa10>
ffffffffc02010aa:	00004617          	auipc	a2,0x4
ffffffffc02010ae:	cee60613          	addi	a2,a2,-786 # ffffffffc0204d98 <commands+0x738>
ffffffffc02010b2:	11000593          	li	a1,272
ffffffffc02010b6:	00004517          	auipc	a0,0x4
ffffffffc02010ba:	cfa50513          	addi	a0,a0,-774 # ffffffffc0204db0 <commands+0x750>
ffffffffc02010be:	ab6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02010c2:	00004697          	auipc	a3,0x4
ffffffffc02010c6:	f8668693          	addi	a3,a3,-122 # ffffffffc0205048 <commands+0x9e8>
ffffffffc02010ca:	00004617          	auipc	a2,0x4
ffffffffc02010ce:	cce60613          	addi	a2,a2,-818 # ffffffffc0204d98 <commands+0x738>
ffffffffc02010d2:	10e00593          	li	a1,270
ffffffffc02010d6:	00004517          	auipc	a0,0x4
ffffffffc02010da:	cda50513          	addi	a0,a0,-806 # ffffffffc0204db0 <commands+0x750>
ffffffffc02010de:	a96ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02010e2:	00004697          	auipc	a3,0x4
ffffffffc02010e6:	f3e68693          	addi	a3,a3,-194 # ffffffffc0205020 <commands+0x9c0>
ffffffffc02010ea:	00004617          	auipc	a2,0x4
ffffffffc02010ee:	cae60613          	addi	a2,a2,-850 # ffffffffc0204d98 <commands+0x738>
ffffffffc02010f2:	10d00593          	li	a1,269
ffffffffc02010f6:	00004517          	auipc	a0,0x4
ffffffffc02010fa:	cba50513          	addi	a0,a0,-838 # ffffffffc0204db0 <commands+0x750>
ffffffffc02010fe:	a76ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201102:	00004697          	auipc	a3,0x4
ffffffffc0201106:	f0e68693          	addi	a3,a3,-242 # ffffffffc0205010 <commands+0x9b0>
ffffffffc020110a:	00004617          	auipc	a2,0x4
ffffffffc020110e:	c8e60613          	addi	a2,a2,-882 # ffffffffc0204d98 <commands+0x738>
ffffffffc0201112:	10800593          	li	a1,264
ffffffffc0201116:	00004517          	auipc	a0,0x4
ffffffffc020111a:	c9a50513          	addi	a0,a0,-870 # ffffffffc0204db0 <commands+0x750>
ffffffffc020111e:	a56ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201122:	00004697          	auipc	a3,0x4
ffffffffc0201126:	dee68693          	addi	a3,a3,-530 # ffffffffc0204f10 <commands+0x8b0>
ffffffffc020112a:	00004617          	auipc	a2,0x4
ffffffffc020112e:	c6e60613          	addi	a2,a2,-914 # ffffffffc0204d98 <commands+0x738>
ffffffffc0201132:	10700593          	li	a1,263
ffffffffc0201136:	00004517          	auipc	a0,0x4
ffffffffc020113a:	c7a50513          	addi	a0,a0,-902 # ffffffffc0204db0 <commands+0x750>
ffffffffc020113e:	a36ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201142:	00004697          	auipc	a3,0x4
ffffffffc0201146:	eae68693          	addi	a3,a3,-338 # ffffffffc0204ff0 <commands+0x990>
ffffffffc020114a:	00004617          	auipc	a2,0x4
ffffffffc020114e:	c4e60613          	addi	a2,a2,-946 # ffffffffc0204d98 <commands+0x738>
ffffffffc0201152:	10600593          	li	a1,262
ffffffffc0201156:	00004517          	auipc	a0,0x4
ffffffffc020115a:	c5a50513          	addi	a0,a0,-934 # ffffffffc0204db0 <commands+0x750>
ffffffffc020115e:	a16ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201162:	00004697          	auipc	a3,0x4
ffffffffc0201166:	e5e68693          	addi	a3,a3,-418 # ffffffffc0204fc0 <commands+0x960>
ffffffffc020116a:	00004617          	auipc	a2,0x4
ffffffffc020116e:	c2e60613          	addi	a2,a2,-978 # ffffffffc0204d98 <commands+0x738>
ffffffffc0201172:	10500593          	li	a1,261
ffffffffc0201176:	00004517          	auipc	a0,0x4
ffffffffc020117a:	c3a50513          	addi	a0,a0,-966 # ffffffffc0204db0 <commands+0x750>
ffffffffc020117e:	9f6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201182:	00004697          	auipc	a3,0x4
ffffffffc0201186:	e2668693          	addi	a3,a3,-474 # ffffffffc0204fa8 <commands+0x948>
ffffffffc020118a:	00004617          	auipc	a2,0x4
ffffffffc020118e:	c0e60613          	addi	a2,a2,-1010 # ffffffffc0204d98 <commands+0x738>
ffffffffc0201192:	10400593          	li	a1,260
ffffffffc0201196:	00004517          	auipc	a0,0x4
ffffffffc020119a:	c1a50513          	addi	a0,a0,-998 # ffffffffc0204db0 <commands+0x750>
ffffffffc020119e:	9d6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011a2:	00004697          	auipc	a3,0x4
ffffffffc02011a6:	d6e68693          	addi	a3,a3,-658 # ffffffffc0204f10 <commands+0x8b0>
ffffffffc02011aa:	00004617          	auipc	a2,0x4
ffffffffc02011ae:	bee60613          	addi	a2,a2,-1042 # ffffffffc0204d98 <commands+0x738>
ffffffffc02011b2:	0fe00593          	li	a1,254
ffffffffc02011b6:	00004517          	auipc	a0,0x4
ffffffffc02011ba:	bfa50513          	addi	a0,a0,-1030 # ffffffffc0204db0 <commands+0x750>
ffffffffc02011be:	9b6ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!PageProperty(p0));
ffffffffc02011c2:	00004697          	auipc	a3,0x4
ffffffffc02011c6:	dce68693          	addi	a3,a3,-562 # ffffffffc0204f90 <commands+0x930>
ffffffffc02011ca:	00004617          	auipc	a2,0x4
ffffffffc02011ce:	bce60613          	addi	a2,a2,-1074 # ffffffffc0204d98 <commands+0x738>
ffffffffc02011d2:	0f900593          	li	a1,249
ffffffffc02011d6:	00004517          	auipc	a0,0x4
ffffffffc02011da:	bda50513          	addi	a0,a0,-1062 # ffffffffc0204db0 <commands+0x750>
ffffffffc02011de:	996ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02011e2:	00004697          	auipc	a3,0x4
ffffffffc02011e6:	ece68693          	addi	a3,a3,-306 # ffffffffc02050b0 <commands+0xa50>
ffffffffc02011ea:	00004617          	auipc	a2,0x4
ffffffffc02011ee:	bae60613          	addi	a2,a2,-1106 # ffffffffc0204d98 <commands+0x738>
ffffffffc02011f2:	11700593          	li	a1,279
ffffffffc02011f6:	00004517          	auipc	a0,0x4
ffffffffc02011fa:	bba50513          	addi	a0,a0,-1094 # ffffffffc0204db0 <commands+0x750>
ffffffffc02011fe:	976ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == 0);
ffffffffc0201202:	00004697          	auipc	a3,0x4
ffffffffc0201206:	ede68693          	addi	a3,a3,-290 # ffffffffc02050e0 <commands+0xa80>
ffffffffc020120a:	00004617          	auipc	a2,0x4
ffffffffc020120e:	b8e60613          	addi	a2,a2,-1138 # ffffffffc0204d98 <commands+0x738>
ffffffffc0201212:	12600593          	li	a1,294
ffffffffc0201216:	00004517          	auipc	a0,0x4
ffffffffc020121a:	b9a50513          	addi	a0,a0,-1126 # ffffffffc0204db0 <commands+0x750>
ffffffffc020121e:	956ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == nr_free_pages());
ffffffffc0201222:	00004697          	auipc	a3,0x4
ffffffffc0201226:	ba668693          	addi	a3,a3,-1114 # ffffffffc0204dc8 <commands+0x768>
ffffffffc020122a:	00004617          	auipc	a2,0x4
ffffffffc020122e:	b6e60613          	addi	a2,a2,-1170 # ffffffffc0204d98 <commands+0x738>
ffffffffc0201232:	0f300593          	li	a1,243
ffffffffc0201236:	00004517          	auipc	a0,0x4
ffffffffc020123a:	b7a50513          	addi	a0,a0,-1158 # ffffffffc0204db0 <commands+0x750>
ffffffffc020123e:	936ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201242:	00004697          	auipc	a3,0x4
ffffffffc0201246:	bc668693          	addi	a3,a3,-1082 # ffffffffc0204e08 <commands+0x7a8>
ffffffffc020124a:	00004617          	auipc	a2,0x4
ffffffffc020124e:	b4e60613          	addi	a2,a2,-1202 # ffffffffc0204d98 <commands+0x738>
ffffffffc0201252:	0ba00593          	li	a1,186
ffffffffc0201256:	00004517          	auipc	a0,0x4
ffffffffc020125a:	b5a50513          	addi	a0,a0,-1190 # ffffffffc0204db0 <commands+0x750>
...
ffffffffc020139e:	d5e68693          	addi	a3,a3,-674 # ffffffffc02050f8 <commands+0xa98>
ffffffffc02013a2:	00004617          	auipc	a2,0x4
ffffffffc02013a6:	9f660613          	addi	a2,a2,-1546 # ffffffffc0204d98 <commands+0x738>
ffffffffc02013aa:	08300593          	li	a1,131
ffffffffc02013ae:	00004517          	auipc	a0,0x4
ffffffffc02013b2:	a0250513          	addi	a0,a0,-1534 # ffffffffc0204db0 <commands+0x750>
ffffffffc02013b6:	fbffe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc02013ba:	00004697          	auipc	a3,0x4
ffffffffc02013be:	d3668693          	addi	a3,a3,-714 # ffffffffc02050f0 <commands+0xa90>
ffffffffc02013c2:	00004617          	auipc	a2,0x4
ffffffffc02013c6:	9d660613          	addi	a2,a2,-1578 # ffffffffc0204d98 <commands+0x738>
ffffffffc02013ca:	08000593          	li	a1,128
ffffffffc02013ce:	00004517          	auipc	a0,0x4
ffffffffc02013d2:	9e250513          	addi	a0,a0,-1566 # ffffffffc0204db0 <commands+0x750>
...
ffffffffc0201476:	c7e68693          	addi	a3,a3,-898 # ffffffffc02050f0 <commands+0xa90>
ffffffffc020147a:	00004617          	auipc	a2,0x4
ffffffffc020147e:	91e60613          	addi	a2,a2,-1762 # ffffffffc0204d98 <commands+0x738>
ffffffffc0201482:	06200593          	li	a1,98
ffffffffc0201486:	00004517          	auipc	a0,0x4
ffffffffc020148a:	92a50513          	addi	a0,a0,-1750 # ffffffffc0204db0 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc020154c:	bd868693          	addi	a3,a3,-1064 # ffffffffc0205120 <commands+0xac0>
ffffffffc0201550:	00004617          	auipc	a2,0x4
ffffffffc0201554:	84860613          	addi	a2,a2,-1976 # ffffffffc0204d98 <commands+0x738>
ffffffffc0201558:	04900593          	li	a1,73
ffffffffc020155c:	00004517          	auipc	a0,0x4
ffffffffc0201560:	85450513          	addi	a0,a0,-1964 # ffffffffc0204db0 <commands+0x750>
ffffffffc0201564:	e11fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc0201568:	00004697          	auipc	a3,0x4
ffffffffc020156c:	b8868693          	addi	a3,a3,-1144 # ffffffffc02050f0 <commands+0xa90>
ffffffffc0201570:	00004617          	auipc	a2,0x4
ffffffffc0201574:	82860613          	addi	a2,a2,-2008 # ffffffffc0204d98 <commands+0x738>
ffffffffc0201578:	04600593          	li	a1,70
ffffffffc020157c:	00004517          	auipc	a0,0x4
ffffffffc0201580:	83450513          	addi	a0,a0,-1996 # ffffffffc0204db0 <commands+0x750>
...
ffffffffc020158e:	bf660613          	addi	a2,a2,-1034 # ffffffffc0205180 <default_pmm_manager+0x38>
ffffffffc0201592:	06500593          	li	a1,101
ffffffffc0201596:	00004517          	auipc	a0,0x4
ffffffffc020159a:	c0a50513          	addi	a0,a0,-1014 # ffffffffc02051a0 <default_pmm_manager+0x58>
static inline struct Page *pa2page(uintptr_t pa) {
...
ffffffffc02015aa:	c0a60613          	addi	a2,a2,-1014 # ffffffffc02051b0 <default_pmm_manager+0x68>
ffffffffc02015ae:	07000593          	li	a1,112
ffffffffc02015b2:	00004517          	auipc	a0,0x4
ffffffffc02015b6:	bee50513          	addi	a0,a0,-1042 # ffffffffc02051a0 <default_pmm_manager+0x58>
static inline struct Page *pte2page(pte_t pte) {
...
ffffffffc0201760:	479020ef          	jal	ra,ffffffffc02043d8 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201802:	3d7020ef          	jal	ra,ffffffffc02043d8 <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201862:	97a60613          	addi	a2,a2,-1670 # ffffffffc02051d8 <default_pmm_manager+0x90>
ffffffffc0201866:	10200593          	li	a1,258
ffffffffc020186a:	00004517          	auipc	a0,0x4
ffffffffc020186e:	99650513          	addi	a0,a0,-1642 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc0201872:	b03fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201876:	00004617          	auipc	a2,0x4
ffffffffc020187a:	96260613          	addi	a2,a2,-1694 # ffffffffc02051d8 <default_pmm_manager+0x90>
ffffffffc020187e:	10f00593          	li	a1,271
ffffffffc0201882:	00004517          	auipc	a0,0x4
ffffffffc0201886:	97e50513          	addi	a0,a0,-1666 # ffffffffc0205200 <default_pmm_manager+0xb8>
...
ffffffffc0201894:	94860613          	addi	a2,a2,-1720 # ffffffffc02051d8 <default_pmm_manager+0x90>
ffffffffc0201898:	10b00593          	li	a1,267
ffffffffc020189c:	00004517          	auipc	a0,0x4
ffffffffc02018a0:	96450513          	addi	a0,a0,-1692 # ffffffffc0205200 <default_pmm_manager+0xb8>
...
ffffffffc02018ae:	92e60613          	addi	a2,a2,-1746 # ffffffffc02051d8 <default_pmm_manager+0x90>
ffffffffc02018b2:	0ff00593          	li	a1,255
ffffffffc02018b6:	00004517          	auipc	a0,0x4
ffffffffc02018ba:	94a50513          	addi	a0,a0,-1718 # ffffffffc0205200 <default_pmm_manager+0xb8>
...
ffffffffc0201aba:	69278793          	addi	a5,a5,1682 # ffffffffc0205148 <default_pmm_manager>
...
ffffffffc0201ac8:	74c50513          	addi	a0,a0,1868 # ffffffffc0205210 <default_pmm_manager+0xc8>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201b24:	70850513          	addi	a0,a0,1800 # ffffffffc0205228 <default_pmm_manager+0xe0>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201b34:	72850513          	addi	a0,a0,1832 # ffffffffc0205258 <default_pmm_manager+0x110>
...
ffffffffc0201b4e:	72650513          	addi	a0,a0,1830 # ffffffffc0205270 <default_pmm_manager+0x128>
...
ffffffffc0201bda:	6ea50513          	addi	a0,a0,1770 # ffffffffc02052c0 <default_pmm_manager+0x178>
...
ffffffffc0201ea2:	70a50513          	addi	a0,a0,1802 # ffffffffc02055a8 <default_pmm_manager+0x460>
...
ffffffffc0201f58:	78c58593          	addi	a1,a1,1932 # ffffffffc02056e0 <default_pmm_manager+0x598>
ffffffffc0201f5c:	10000513          	li	a0,256
ffffffffc0201f60:	432020ef          	jal	ra,ffffffffc0204392 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f64:	10040593          	addi	a1,s0,256
ffffffffc0201f68:	10000513          	li	a0,256
ffffffffc0201f6c:	438020ef          	jal	ra,ffffffffc02043a4 <strcmp>
...
ffffffffc0201fa2:	10068023          	sb	zero,256(a3) # fffffffffff80100 <end+0x3fd6eb94>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fa6:	3b6020ef          	jal	ra,ffffffffc020435c <strlen>
...
ffffffffc020209c:	6c050513          	addi	a0,a0,1728 # ffffffffc0205758 <default_pmm_manager+0x610>
}
...
ffffffffc02021a2:	46a68693          	addi	a3,a3,1130 # ffffffffc0205608 <default_pmm_manager+0x4c0>
ffffffffc02021a6:	00003617          	auipc	a2,0x3
ffffffffc02021aa:	bf260613          	addi	a2,a2,-1038 # ffffffffc0204d98 <commands+0x738>
ffffffffc02021ae:	1ce00593          	li	a1,462
ffffffffc02021b2:	00003517          	auipc	a0,0x3
ffffffffc02021b6:	04e50513          	addi	a0,a0,78 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc02021ba:	9bafe0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc02021be:	00003697          	auipc	a3,0x3
ffffffffc02021c2:	40a68693          	addi	a3,a3,1034 # ffffffffc02055c8 <default_pmm_manager+0x480>
ffffffffc02021c6:	00003617          	auipc	a2,0x3
ffffffffc02021ca:	bd260613          	addi	a2,a2,-1070 # ffffffffc0204d98 <commands+0x738>
ffffffffc02021ce:	1cd00593          	li	a1,461
ffffffffc02021d2:	00003517          	auipc	a0,0x3
ffffffffc02021d6:	02e50513          	addi	a0,a0,46 # ffffffffc0205200 <default_pmm_manager+0xb8>
...
ffffffffc02021e4:	ff860613          	addi	a2,a2,-8 # ffffffffc02051d8 <default_pmm_manager+0x90>
ffffffffc02021e8:	1cd00593          	li	a1,461
ffffffffc02021ec:	00003517          	auipc	a0,0x3
ffffffffc02021f0:	01450513          	addi	a0,a0,20 # ffffffffc0205200 <default_pmm_manager+0xb8>
...
ffffffffc0202200:	09c60613          	addi	a2,a2,156 # ffffffffc0205298 <default_pmm_manager+0x150>
ffffffffc0202204:	07700593          	li	a1,119
ffffffffc0202208:	00003517          	auipc	a0,0x3
ffffffffc020220c:	ff850513          	addi	a0,a0,-8 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc0202210:	964fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc0202214:	00003617          	auipc	a2,0x3
ffffffffc0202218:	08460613          	addi	a2,a2,132 # ffffffffc0205298 <default_pmm_manager+0x150>
ffffffffc020221c:	0bd00593          	li	a1,189
ffffffffc0202220:	00003517          	auipc	a0,0x3
ffffffffc0202224:	fe050513          	addi	a0,a0,-32 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc0202228:	94cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc020222c:	00003697          	auipc	a3,0x3
ffffffffc0202230:	0d468693          	addi	a3,a3,212 # ffffffffc0205300 <default_pmm_manager+0x1b8>
ffffffffc0202234:	00003617          	auipc	a2,0x3
ffffffffc0202238:	b6460613          	addi	a2,a2,-1180 # ffffffffc0204d98 <commands+0x738>
ffffffffc020223c:	19300593          	li	a1,403
ffffffffc0202240:	00003517          	auipc	a0,0x3
ffffffffc0202244:	fc050513          	addi	a0,a0,-64 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc0202248:	92cfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020224c:	00003697          	auipc	a3,0x3
ffffffffc0202250:	09468693          	addi	a3,a3,148 # ffffffffc02052e0 <default_pmm_manager+0x198>
ffffffffc0202254:	00003617          	auipc	a2,0x3
ffffffffc0202258:	b4460613          	addi	a2,a2,-1212 # ffffffffc0204d98 <commands+0x738>
ffffffffc020225c:	19200593          	li	a1,402
ffffffffc0202260:	00003517          	auipc	a0,0x3
ffffffffc0202264:	fa050513          	addi	a0,a0,-96 # ffffffffc0205200 <default_pmm_manager+0xb8>
...
ffffffffc0202274:	12068693          	addi	a3,a3,288 # ffffffffc0205390 <default_pmm_manager+0x248>
ffffffffc0202278:	00003617          	auipc	a2,0x3
ffffffffc020227c:	b2060613          	addi	a2,a2,-1248 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202280:	19a00593          	li	a1,410
ffffffffc0202284:	00003517          	auipc	a0,0x3
ffffffffc0202288:	f7c50513          	addi	a0,a0,-132 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc020228c:	8e8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202290:	00003697          	auipc	a3,0x3
ffffffffc0202294:	0d068693          	addi	a3,a3,208 # ffffffffc0205360 <default_pmm_manager+0x218>
ffffffffc0202298:	00003617          	auipc	a2,0x3
ffffffffc020229c:	b0060613          	addi	a2,a2,-1280 # ffffffffc0204d98 <commands+0x738>
ffffffffc02022a0:	19800593          	li	a1,408
ffffffffc02022a4:	00003517          	auipc	a0,0x3
ffffffffc02022a8:	f5c50513          	addi	a0,a0,-164 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc02022ac:	8c8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc02022b0:	00003697          	auipc	a3,0x3
ffffffffc02022b4:	08868693          	addi	a3,a3,136 # ffffffffc0205338 <default_pmm_manager+0x1f0>
ffffffffc02022b8:	00003617          	auipc	a2,0x3
ffffffffc02022bc:	ae060613          	addi	a2,a2,-1312 # ffffffffc0204d98 <commands+0x738>
ffffffffc02022c0:	19400593          	li	a1,404
ffffffffc02022c4:	00003517          	auipc	a0,0x3
ffffffffc02022c8:	f3c50513          	addi	a0,a0,-196 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc02022cc:	8a8fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02022d0:	00003697          	auipc	a3,0x3
ffffffffc02022d4:	14868693          	addi	a3,a3,328 # ffffffffc0205418 <default_pmm_manager+0x2d0>
ffffffffc02022d8:	00003617          	auipc	a2,0x3
ffffffffc02022dc:	ac060613          	addi	a2,a2,-1344 # ffffffffc0204d98 <commands+0x738>
ffffffffc02022e0:	1a300593          	li	a1,419
ffffffffc02022e4:	00003517          	auipc	a0,0x3
ffffffffc02022e8:	f1c50513          	addi	a0,a0,-228 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc02022ec:	888fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02022f0:	00003697          	auipc	a3,0x3
ffffffffc02022f4:	1c868693          	addi	a3,a3,456 # ffffffffc02054b8 <default_pmm_manager+0x370>
ffffffffc02022f8:	00003617          	auipc	a2,0x3
ffffffffc02022fc:	aa060613          	addi	a2,a2,-1376 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202300:	1a800593          	li	a1,424
ffffffffc0202304:	00003517          	auipc	a0,0x3
ffffffffc0202308:	efc50513          	addi	a0,a0,-260 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc020230c:	868fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202310:	00003697          	auipc	a3,0x3
ffffffffc0202314:	0e068693          	addi	a3,a3,224 # ffffffffc02053f0 <default_pmm_manager+0x2a8>
ffffffffc0202318:	00003617          	auipc	a2,0x3
ffffffffc020231c:	a8060613          	addi	a2,a2,-1408 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202320:	1a000593          	li	a1,416
ffffffffc0202324:	00003517          	auipc	a0,0x3
ffffffffc0202328:	edc50513          	addi	a0,a0,-292 # ffffffffc0205200 <default_pmm_manager+0xb8>
...
ffffffffc0202336:	ea660613          	addi	a2,a2,-346 # ffffffffc02051d8 <default_pmm_manager+0x90>
ffffffffc020233a:	19f00593          	li	a1,415
ffffffffc020233e:	00003517          	auipc	a0,0x3
ffffffffc0202342:	ec250513          	addi	a0,a0,-318 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc0202346:	82efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020234a:	00003697          	auipc	a3,0x3
ffffffffc020234e:	10668693          	addi	a3,a3,262 # ffffffffc0205450 <default_pmm_manager+0x308>
ffffffffc0202352:	00003617          	auipc	a2,0x3
ffffffffc0202356:	a4660613          	addi	a2,a2,-1466 # ffffffffc0204d98 <commands+0x738>
ffffffffc020235a:	1ad00593          	li	a1,429
ffffffffc020235e:	00003517          	auipc	a0,0x3
ffffffffc0202362:	ea250513          	addi	a0,a0,-350 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc0202366:	80efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020236a:	00003697          	auipc	a3,0x3
ffffffffc020236e:	1ae68693          	addi	a3,a3,430 # ffffffffc0205518 <default_pmm_manager+0x3d0>
ffffffffc0202372:	00003617          	auipc	a2,0x3
ffffffffc0202376:	a2660613          	addi	a2,a2,-1498 # ffffffffc0204d98 <commands+0x738>
ffffffffc020237a:	1ac00593          	li	a1,428
ffffffffc020237e:	00003517          	auipc	a0,0x3
ffffffffc0202382:	e8250513          	addi	a0,a0,-382 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc0202386:	feffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020238a:	00003697          	auipc	a3,0x3
ffffffffc020238e:	17668693          	addi	a3,a3,374 # ffffffffc0205500 <default_pmm_manager+0x3b8>
ffffffffc0202392:	00003617          	auipc	a2,0x3
ffffffffc0202396:	a0660613          	addi	a2,a2,-1530 # ffffffffc0204d98 <commands+0x738>
ffffffffc020239a:	1ab00593          	li	a1,427
ffffffffc020239e:	00003517          	auipc	a0,0x3
ffffffffc02023a2:	e6250513          	addi	a0,a0,-414 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc02023a6:	fcffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc02023aa:	00003697          	auipc	a3,0x3
ffffffffc02023ae:	12668693          	addi	a3,a3,294 # ffffffffc02054d0 <default_pmm_manager+0x388>
ffffffffc02023b2:	00003617          	auipc	a2,0x3
ffffffffc02023b6:	9e660613          	addi	a2,a2,-1562 # ffffffffc0204d98 <commands+0x738>
ffffffffc02023ba:	1aa00593          	li	a1,426
ffffffffc02023be:	00003517          	auipc	a0,0x3
ffffffffc02023c2:	e4250513          	addi	a0,a0,-446 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc02023c6:	faffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc02023ca:	00003697          	auipc	a3,0x3
ffffffffc02023ce:	2be68693          	addi	a3,a3,702 # ffffffffc0205688 <default_pmm_manager+0x540>
ffffffffc02023d2:	00003617          	auipc	a2,0x3
ffffffffc02023d6:	9c660613          	addi	a2,a2,-1594 # ffffffffc0204d98 <commands+0x738>
ffffffffc02023da:	1d800593          	li	a1,472
ffffffffc02023de:	00003517          	auipc	a0,0x3
ffffffffc02023e2:	e2250513          	addi	a0,a0,-478 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc02023e6:	f8ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02023ea:	00003697          	auipc	a3,0x3
ffffffffc02023ee:	0b668693          	addi	a3,a3,182 # ffffffffc02054a0 <default_pmm_manager+0x358>
ffffffffc02023f2:	00003617          	auipc	a2,0x3
ffffffffc02023f6:	9a660613          	addi	a2,a2,-1626 # ffffffffc0204d98 <commands+0x738>
ffffffffc02023fa:	1a700593          	li	a1,423
ffffffffc02023fe:	00003517          	auipc	a0,0x3
ffffffffc0202402:	e0250513          	addi	a0,a0,-510 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc0202406:	f6ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_W);
ffffffffc020240a:	00003697          	auipc	a3,0x3
ffffffffc020240e:	08668693          	addi	a3,a3,134 # ffffffffc0205490 <default_pmm_manager+0x348>
ffffffffc0202412:	00003617          	auipc	a2,0x3
ffffffffc0202416:	98660613          	addi	a2,a2,-1658 # ffffffffc0204d98 <commands+0x738>
ffffffffc020241a:	1a600593          	li	a1,422
ffffffffc020241e:	00003517          	auipc	a0,0x3
ffffffffc0202422:	de250513          	addi	a0,a0,-542 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc0202426:	f4ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020242a:	00003697          	auipc	a3,0x3
ffffffffc020242e:	15e68693          	addi	a3,a3,350 # ffffffffc0205588 <default_pmm_manager+0x440>
ffffffffc0202432:	00003617          	auipc	a2,0x3
ffffffffc0202436:	96660613          	addi	a2,a2,-1690 # ffffffffc0204d98 <commands+0x738>
ffffffffc020243a:	1e800593          	li	a1,488
ffffffffc020243e:	00003517          	auipc	a0,0x3
ffffffffc0202442:	dc250513          	addi	a0,a0,-574 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc0202446:	f2ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020244a:	00003697          	auipc	a3,0x3
ffffffffc020244e:	03668693          	addi	a3,a3,54 # ffffffffc0205480 <default_pmm_manager+0x338>
ffffffffc0202452:	00003617          	auipc	a2,0x3
ffffffffc0202456:	94660613          	addi	a2,a2,-1722 # ffffffffc0204d98 <commands+0x738>
ffffffffc020245a:	1a500593          	li	a1,421
ffffffffc020245e:	00003517          	auipc	a0,0x3
ffffffffc0202462:	da250513          	addi	a0,a0,-606 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc0202466:	f0ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020246a:	00003697          	auipc	a3,0x3
ffffffffc020246e:	f6e68693          	addi	a3,a3,-146 # ffffffffc02053d8 <default_pmm_manager+0x290>
ffffffffc0202472:	00003617          	auipc	a2,0x3
ffffffffc0202476:	92660613          	addi	a2,a2,-1754 # ffffffffc0204d98 <commands+0x738>
ffffffffc020247a:	1b200593          	li	a1,434
ffffffffc020247e:	00003517          	auipc	a0,0x3
ffffffffc0202482:	d8250513          	addi	a0,a0,-638 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc0202486:	eeffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020248a:	00003697          	auipc	a3,0x3
ffffffffc020248e:	0a668693          	addi	a3,a3,166 # ffffffffc0205530 <default_pmm_manager+0x3e8>
ffffffffc0202492:	00003617          	auipc	a2,0x3
ffffffffc0202496:	90660613          	addi	a2,a2,-1786 # ffffffffc0204d98 <commands+0x738>
ffffffffc020249a:	1af00593          	li	a1,431
ffffffffc020249e:	00003517          	auipc	a0,0x3
ffffffffc02024a2:	d6250513          	addi	a0,a0,-670 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc02024a6:	ecffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02024aa:	00003697          	auipc	a3,0x3
ffffffffc02024ae:	f1668693          	addi	a3,a3,-234 # ffffffffc02053c0 <default_pmm_manager+0x278>
ffffffffc02024b2:	00003617          	auipc	a2,0x3
ffffffffc02024b6:	8e660613          	addi	a2,a2,-1818 # ffffffffc0204d98 <commands+0x738>
ffffffffc02024ba:	1ae00593          	li	a1,430
ffffffffc02024be:	00003517          	auipc	a0,0x3
ffffffffc02024c2:	d4250513          	addi	a0,a0,-702 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc02024c6:	eaffd0ef          	jal	ra,ffffffffc0200374 <__panic>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc02024ca:	00003617          	auipc	a2,0x3
ffffffffc02024ce:	d0e60613          	addi	a2,a2,-754 # ffffffffc02051d8 <default_pmm_manager+0x90>
ffffffffc02024d2:	06a00593          	li	a1,106
ffffffffc02024d6:	00003517          	auipc	a0,0x3
ffffffffc02024da:	cca50513          	addi	a0,a0,-822 # ffffffffc02051a0 <default_pmm_manager+0x58>
ffffffffc02024de:	e97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02024e2:	00003697          	auipc	a3,0x3
ffffffffc02024e6:	07e68693          	addi	a3,a3,126 # ffffffffc0205560 <default_pmm_manager+0x418>
ffffffffc02024ea:	00003617          	auipc	a2,0x3
ffffffffc02024ee:	8ae60613          	addi	a2,a2,-1874 # ffffffffc0204d98 <commands+0x738>
ffffffffc02024f2:	1b900593          	li	a1,441
ffffffffc02024f6:	00003517          	auipc	a0,0x3
ffffffffc02024fa:	d0a50513          	addi	a0,a0,-758 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc02024fe:	e77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202502:	00003697          	auipc	a3,0x3
ffffffffc0202506:	01668693          	addi	a3,a3,22 # ffffffffc0205518 <default_pmm_manager+0x3d0>
ffffffffc020250a:	00003617          	auipc	a2,0x3
ffffffffc020250e:	88e60613          	addi	a2,a2,-1906 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202512:	1b700593          	li	a1,439
ffffffffc0202516:	00003517          	auipc	a0,0x3
ffffffffc020251a:	cea50513          	addi	a0,a0,-790 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc020251e:	e57fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202522:	00003697          	auipc	a3,0x3
ffffffffc0202526:	02668693          	addi	a3,a3,38 # ffffffffc0205548 <default_pmm_manager+0x400>
ffffffffc020252a:	00003617          	auipc	a2,0x3
ffffffffc020252e:	86e60613          	addi	a2,a2,-1938 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202532:	1b600593          	li	a1,438
ffffffffc0202536:	00003517          	auipc	a0,0x3
ffffffffc020253a:	cca50513          	addi	a0,a0,-822 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc020253e:	e37fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202542:	00003697          	auipc	a3,0x3
ffffffffc0202546:	fd668693          	addi	a3,a3,-42 # ffffffffc0205518 <default_pmm_manager+0x3d0>
ffffffffc020254a:	00003617          	auipc	a2,0x3
ffffffffc020254e:	84e60613          	addi	a2,a2,-1970 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202552:	1b300593          	li	a1,435
ffffffffc0202556:	00003517          	auipc	a0,0x3
ffffffffc020255a:	caa50513          	addi	a0,a0,-854 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc020255e:	e17fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202562:	00003697          	auipc	a3,0x3
ffffffffc0202566:	10e68693          	addi	a3,a3,270 # ffffffffc0205670 <default_pmm_manager+0x528>
ffffffffc020256a:	00003617          	auipc	a2,0x3
ffffffffc020256e:	82e60613          	addi	a2,a2,-2002 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202572:	1d700593          	li	a1,471
ffffffffc0202576:	00003517          	auipc	a0,0x3
ffffffffc020257a:	c8a50513          	addi	a0,a0,-886 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc020257e:	df7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202582:	00003697          	auipc	a3,0x3
ffffffffc0202586:	0b668693          	addi	a3,a3,182 # ffffffffc0205638 <default_pmm_manager+0x4f0>
ffffffffc020258a:	00003617          	auipc	a2,0x3
ffffffffc020258e:	80e60613          	addi	a2,a2,-2034 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202592:	1d600593          	li	a1,470
ffffffffc0202596:	00003517          	auipc	a0,0x3
ffffffffc020259a:	c6a50513          	addi	a0,a0,-918 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc020259e:	dd7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc02025a2:	00003697          	auipc	a3,0x3
ffffffffc02025a6:	07e68693          	addi	a3,a3,126 # ffffffffc0205620 <default_pmm_manager+0x4d8>
ffffffffc02025aa:	00002617          	auipc	a2,0x2
ffffffffc02025ae:	7ee60613          	addi	a2,a2,2030 # ffffffffc0204d98 <commands+0x738>
ffffffffc02025b2:	1d200593          	li	a1,466
ffffffffc02025b6:	00003517          	auipc	a0,0x3
ffffffffc02025ba:	c4a50513          	addi	a0,a0,-950 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc02025be:	db7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02025c2:	00003697          	auipc	a3,0x3
ffffffffc02025c6:	fc668693          	addi	a3,a3,-58 # ffffffffc0205588 <default_pmm_manager+0x440>
ffffffffc02025ca:	00002617          	auipc	a2,0x2
ffffffffc02025ce:	7ce60613          	addi	a2,a2,1998 # ffffffffc0204d98 <commands+0x738>
ffffffffc02025d2:	1c000593          	li	a1,448
ffffffffc02025d6:	00003517          	auipc	a0,0x3
ffffffffc02025da:	c2a50513          	addi	a0,a0,-982 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc02025de:	d97fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02025e2:	00003697          	auipc	a3,0x3
ffffffffc02025e6:	dde68693          	addi	a3,a3,-546 # ffffffffc02053c0 <default_pmm_manager+0x278>
ffffffffc02025ea:	00002617          	auipc	a2,0x2
ffffffffc02025ee:	7ae60613          	addi	a2,a2,1966 # ffffffffc0204d98 <commands+0x738>
ffffffffc02025f2:	19b00593          	li	a1,411
ffffffffc02025f6:	00003517          	auipc	a0,0x3
ffffffffc02025fa:	c0a50513          	addi	a0,a0,-1014 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc02025fe:	d77fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc0202602:	00003617          	auipc	a2,0x3
ffffffffc0202606:	bd660613          	addi	a2,a2,-1066 # ffffffffc02051d8 <default_pmm_manager+0x90>
ffffffffc020260a:	19e00593          	li	a1,414
ffffffffc020260e:	00003517          	auipc	a0,0x3
ffffffffc0202612:	bf250513          	addi	a0,a0,-1038 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc0202616:	d5ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020261a:	00003697          	auipc	a3,0x3
ffffffffc020261e:	dbe68693          	addi	a3,a3,-578 # ffffffffc02053d8 <default_pmm_manager+0x290>
ffffffffc0202622:	00002617          	auipc	a2,0x2
ffffffffc0202626:	77660613          	addi	a2,a2,1910 # ffffffffc0204d98 <commands+0x738>
ffffffffc020262a:	19c00593          	li	a1,412
ffffffffc020262e:	00003517          	auipc	a0,0x3
ffffffffc0202632:	bd250513          	addi	a0,a0,-1070 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc0202636:	d3ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020263a:	00003697          	auipc	a3,0x3
ffffffffc020263e:	e1668693          	addi	a3,a3,-490 # ffffffffc0205450 <default_pmm_manager+0x308>
ffffffffc0202642:	00002617          	auipc	a2,0x2
ffffffffc0202646:	75660613          	addi	a2,a2,1878 # ffffffffc0204d98 <commands+0x738>
ffffffffc020264a:	1a400593          	li	a1,420
ffffffffc020264e:	00003517          	auipc	a0,0x3
ffffffffc0202652:	bb250513          	addi	a0,a0,-1102 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc0202656:	d1ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020265a:	00003697          	auipc	a3,0x3
ffffffffc020265e:	0d668693          	addi	a3,a3,214 # ffffffffc0205730 <default_pmm_manager+0x5e8>
ffffffffc0202662:	00002617          	auipc	a2,0x2
ffffffffc0202666:	73660613          	addi	a2,a2,1846 # ffffffffc0204d98 <commands+0x738>
ffffffffc020266a:	1e000593          	li	a1,480
ffffffffc020266e:	00003517          	auipc	a0,0x3
ffffffffc0202672:	b9250513          	addi	a0,a0,-1134 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc0202676:	cfffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020267a:	00003697          	auipc	a3,0x3
ffffffffc020267e:	07e68693          	addi	a3,a3,126 # ffffffffc02056f8 <default_pmm_manager+0x5b0>
ffffffffc0202682:	00002617          	auipc	a2,0x2
ffffffffc0202686:	71660613          	addi	a2,a2,1814 # ffffffffc0204d98 <commands+0x738>
ffffffffc020268a:	1dd00593          	li	a1,477
ffffffffc020268e:	00003517          	auipc	a0,0x3
ffffffffc0202692:	b7250513          	addi	a0,a0,-1166 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc0202696:	cdffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 2);
ffffffffc020269a:	00003697          	auipc	a3,0x3
ffffffffc020269e:	02e68693          	addi	a3,a3,46 # ffffffffc02056c8 <default_pmm_manager+0x580>
ffffffffc02026a2:	00002617          	auipc	a2,0x2
ffffffffc02026a6:	6f660613          	addi	a2,a2,1782 # ffffffffc0204d98 <commands+0x738>
ffffffffc02026aa:	1d900593          	li	a1,473
ffffffffc02026ae:	00003517          	auipc	a0,0x3
ffffffffc02026b2:	b5250513          	addi	a0,a0,-1198 # ffffffffc0205200 <default_pmm_manager+0xb8>
...
ffffffffc0202724:	05868693          	addi	a3,a3,88 # ffffffffc0205778 <default_pmm_manager+0x630>
ffffffffc0202728:	00002617          	auipc	a2,0x2
ffffffffc020272c:	67060613          	addi	a2,a2,1648 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202730:	17a00593          	li	a1,378
ffffffffc0202734:	00003517          	auipc	a0,0x3
ffffffffc0202738:	acc50513          	addi	a0,a0,-1332 # ffffffffc0205200 <default_pmm_manager+0xb8>
...
ffffffffc02027dc:	fb868693          	addi	a3,a3,-72 # ffffffffc0205790 <default_pmm_manager+0x648>
ffffffffc02027e0:	00002617          	auipc	a2,0x2
ffffffffc02027e4:	5b860613          	addi	a2,a2,1464 # ffffffffc0204d98 <commands+0x738>
ffffffffc02027e8:	1f000593          	li	a1,496
ffffffffc02027ec:	00003517          	auipc	a0,0x3
ffffffffc02027f0:	a1450513          	addi	a0,a0,-1516 # ffffffffc0205200 <default_pmm_manager+0xb8>
...
ffffffffc02027fe:	9de60613          	addi	a2,a2,-1570 # ffffffffc02051d8 <default_pmm_manager+0x90>
ffffffffc0202802:	06a00593          	li	a1,106
ffffffffc0202806:	00003517          	auipc	a0,0x3
ffffffffc020280a:	99a50513          	addi	a0,a0,-1638 # ffffffffc02051a0 <default_pmm_manager+0x58>
ffffffffc020280e:	b67fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(base != NULL);
ffffffffc0202812:	00003697          	auipc	a3,0x3
ffffffffc0202816:	f9e68693          	addi	a3,a3,-98 # ffffffffc02057b0 <default_pmm_manager+0x668>
ffffffffc020281a:	00002617          	auipc	a2,0x2
ffffffffc020281e:	57e60613          	addi	a2,a2,1406 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202822:	1f300593          	li	a1,499
ffffffffc0202826:	00003517          	auipc	a0,0x3
ffffffffc020282a:	9da50513          	addi	a0,a0,-1574 # ffffffffc0205200 <default_pmm_manager+0xb8>
...
ffffffffc02028c6:	9d660613          	addi	a2,a2,-1578 # ffffffffc0205298 <default_pmm_manager+0x150>
ffffffffc02028ca:	06c00593          	li	a1,108
ffffffffc02028ce:	00003517          	auipc	a0,0x3
ffffffffc02028d2:	8d250513          	addi	a0,a0,-1838 # ffffffffc02051a0 <default_pmm_manager+0x58>
ffffffffc02028d6:	a9ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(ptr != NULL);
ffffffffc02028da:	00003697          	auipc	a3,0x3
ffffffffc02028de:	ee668693          	addi	a3,a3,-282 # ffffffffc02057c0 <default_pmm_manager+0x678>
ffffffffc02028e2:	00002617          	auipc	a2,0x2
ffffffffc02028e6:	4b660613          	addi	a2,a2,1206 # ffffffffc0204d98 <commands+0x738>
ffffffffc02028ea:	1fa00593          	li	a1,506
ffffffffc02028ee:	00003517          	auipc	a0,0x3
ffffffffc02028f2:	91250513          	addi	a0,a0,-1774 # ffffffffc0205200 <default_pmm_manager+0xb8>
ffffffffc02028f6:	a7ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0 && n < 1024 * 0124);
ffffffffc02028fa:	00003697          	auipc	a3,0x3
ffffffffc02028fe:	e9668693          	addi	a3,a3,-362 # ffffffffc0205790 <default_pmm_manager+0x648>
ffffffffc0202902:	00002617          	auipc	a2,0x2
ffffffffc0202906:	49660613          	addi	a2,a2,1174 # ffffffffc0204d98 <commands+0x738>
ffffffffc020290a:	1f900593          	li	a1,505
ffffffffc020290e:	00003517          	auipc	a0,0x3
ffffffffc0202912:	8f250513          	addi	a0,a0,-1806 # ffffffffc0205200 <default_pmm_manager+0xb8>
...
ffffffffc0202934:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202936:	418010ef          	jal	ra,ffffffffc0203d4e <swapfs_init>
...
ffffffffc0202994:	e7050513          	addi	a0,a0,-400 # ffffffffc0205800 <default_pmm_manager+0x6b8>
    return listelm->next;
...
ffffffffc02029e4:	e3850513          	addi	a0,a0,-456 # ffffffffc0205818 <default_pmm_manager+0x6d0>
...
ffffffffc0202a34:	e5850513          	addi	a0,a0,-424 # ffffffffc0205888 <default_pmm_manager+0x740>
...
ffffffffc0202a50:	e8c50513          	addi	a0,a0,-372 # ffffffffc02058d8 <default_pmm_manager+0x790>
...
ffffffffc0202ac4:	ea050513          	addi	a0,a0,-352 # ffffffffc0205960 <default_pmm_manager+0x818>
...
ffffffffc0202c10:	dfc50513          	addi	a0,a0,-516 # ffffffffc0205a08 <default_pmm_manager+0x8c0>
...
ffffffffc0202c62:	dda50513          	addi	a0,a0,-550 # ffffffffc0205a38 <default_pmm_manager+0x8f0>
ffffffffc0202c66:	c54fd0ef          	jal	ra,ffffffffc02000ba <cprintf>
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
ffffffffc0202c6a:	00003517          	auipc	a0,0x3
ffffffffc0202c6e:	dee50513          	addi	a0,a0,-530 # ffffffffc0205a58 <default_pmm_manager+0x910>
...
ffffffffc0202c80:	10c68693          	addi	a3,a3,268 # ffffffffc0204d88 <commands+0x728>
ffffffffc0202c84:	00002617          	auipc	a2,0x2
ffffffffc0202c88:	11460613          	addi	a2,a2,276 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202c8c:	0ba00593          	li	a1,186
ffffffffc0202c90:	00003517          	auipc	a0,0x3
ffffffffc0202c94:	b6050513          	addi	a0,a0,-1184 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202c98:	edcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202c9c:	00003697          	auipc	a3,0x3
ffffffffc0202ca0:	d4468693          	addi	a3,a3,-700 # ffffffffc02059e0 <default_pmm_manager+0x898>
ffffffffc0202ca4:	00002617          	auipc	a2,0x2
ffffffffc0202ca8:	0f460613          	addi	a2,a2,244 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202cac:	0fa00593          	li	a1,250
ffffffffc0202cb0:	00003517          	auipc	a0,0x3
ffffffffc0202cb4:	b4050513          	addi	a0,a0,-1216 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202cb8:	ebcfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202cbc:	00002617          	auipc	a2,0x2
ffffffffc0202cc0:	4f460613          	addi	a2,a2,1268 # ffffffffc02051b0 <default_pmm_manager+0x68>
ffffffffc0202cc4:	07000593          	li	a1,112
ffffffffc0202cc8:	00002517          	auipc	a0,0x2
ffffffffc0202ccc:	4d850513          	addi	a0,a0,1240 # ffffffffc02051a0 <default_pmm_manager+0x58>
ffffffffc0202cd0:	ea4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202cd4:	00002617          	auipc	a2,0x2
ffffffffc0202cd8:	4ac60613          	addi	a2,a2,1196 # ffffffffc0205180 <default_pmm_manager+0x38>
ffffffffc0202cdc:	06500593          	li	a1,101
ffffffffc0202ce0:	00002517          	auipc	a0,0x2
ffffffffc0202ce4:	4c050513          	addi	a0,a0,1216 # ffffffffc02051a0 <default_pmm_manager+0x58>
ffffffffc0202ce8:	e8cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202cec:	00003697          	auipc	a3,0x3
ffffffffc0202cf0:	c2c68693          	addi	a3,a3,-980 # ffffffffc0205918 <default_pmm_manager+0x7d0>
ffffffffc0202cf4:	00002617          	auipc	a2,0x2
ffffffffc0202cf8:	0a460613          	addi	a2,a2,164 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202cfc:	0db00593          	li	a1,219
ffffffffc0202d00:	00003517          	auipc	a0,0x3
ffffffffc0202d04:	af050513          	addi	a0,a0,-1296 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202d08:	e6cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202d0c:	00003697          	auipc	a3,0x3
ffffffffc0202d10:	bf468693          	addi	a3,a3,-1036 # ffffffffc0205900 <default_pmm_manager+0x7b8>
ffffffffc0202d14:	00002617          	auipc	a2,0x2
ffffffffc0202d18:	08460613          	addi	a2,a2,132 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202d1c:	0da00593          	li	a1,218
ffffffffc0202d20:	00003517          	auipc	a0,0x3
ffffffffc0202d24:	ad050513          	addi	a0,a0,-1328 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202d28:	e4cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202d2c:	00003617          	auipc	a2,0x3
ffffffffc0202d30:	aa460613          	addi	a2,a2,-1372 # ffffffffc02057d0 <default_pmm_manager+0x688>
ffffffffc0202d34:	02700593          	li	a1,39
ffffffffc0202d38:	00003517          	auipc	a0,0x3
ffffffffc0202d3c:	ab850513          	addi	a0,a0,-1352 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202d40:	e34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202d44:	00003697          	auipc	a3,0x3
ffffffffc0202d48:	c8468693          	addi	a3,a3,-892 # ffffffffc02059c8 <default_pmm_manager+0x880>
ffffffffc0202d4c:	00002617          	auipc	a2,0x2
ffffffffc0202d50:	04c60613          	addi	a2,a2,76 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202d54:	0f900593          	li	a1,249
ffffffffc0202d58:	00003517          	auipc	a0,0x3
ffffffffc0202d5c:	a9850513          	addi	a0,a0,-1384 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202d60:	e14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d64:	00003697          	auipc	a3,0x3
ffffffffc0202d68:	c5468693          	addi	a3,a3,-940 # ffffffffc02059b8 <default_pmm_manager+0x870>
ffffffffc0202d6c:	00002617          	auipc	a2,0x2
ffffffffc0202d70:	02c60613          	addi	a2,a2,44 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202d74:	09d00593          	li	a1,157
ffffffffc0202d78:	00003517          	auipc	a0,0x3
ffffffffc0202d7c:	a7850513          	addi	a0,a0,-1416 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202d80:	df4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d84:	00003697          	auipc	a3,0x3
ffffffffc0202d88:	c3468693          	addi	a3,a3,-972 # ffffffffc02059b8 <default_pmm_manager+0x870>
ffffffffc0202d8c:	00002617          	auipc	a2,0x2
ffffffffc0202d90:	00c60613          	addi	a2,a2,12 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202d94:	09f00593          	li	a1,159
ffffffffc0202d98:	00003517          	auipc	a0,0x3
ffffffffc0202d9c:	a5850513          	addi	a0,a0,-1448 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202da0:	dd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert( nr_free == 0);         
ffffffffc0202da4:	00002697          	auipc	a3,0x2
ffffffffc0202da8:	1cc68693          	addi	a3,a3,460 # ffffffffc0204f70 <commands+0x910>
ffffffffc0202dac:	00002617          	auipc	a2,0x2
ffffffffc0202db0:	fec60613          	addi	a2,a2,-20 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202db4:	0f100593          	li	a1,241
ffffffffc0202db8:	00003517          	auipc	a0,0x3
ffffffffc0202dbc:	a3850513          	addi	a0,a0,-1480 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202dc0:	db4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(ret==0);
ffffffffc0202dc4:	00003697          	auipc	a3,0x3
ffffffffc0202dc8:	c6c68693          	addi	a3,a3,-916 # ffffffffc0205a30 <default_pmm_manager+0x8e8>
ffffffffc0202dcc:	00002617          	auipc	a2,0x2
ffffffffc0202dd0:	fcc60613          	addi	a2,a2,-52 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202dd4:	10000593          	li	a1,256
ffffffffc0202dd8:	00003517          	auipc	a0,0x3
ffffffffc0202ddc:	a1850513          	addi	a0,a0,-1512 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202de0:	d94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0202de4:	00003697          	auipc	a3,0x3
ffffffffc0202de8:	a8468693          	addi	a3,a3,-1404 # ffffffffc0205868 <default_pmm_manager+0x720>
ffffffffc0202dec:	00002617          	auipc	a2,0x2
ffffffffc0202df0:	fac60613          	addi	a2,a2,-84 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202df4:	0ca00593          	li	a1,202
ffffffffc0202df8:	00003517          	auipc	a0,0x3
ffffffffc0202dfc:	9f850513          	addi	a0,a0,-1544 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202e00:	d74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(vma != NULL);
ffffffffc0202e04:	00003697          	auipc	a3,0x3
ffffffffc0202e08:	a7468693          	addi	a3,a3,-1420 # ffffffffc0205878 <default_pmm_manager+0x730>
ffffffffc0202e0c:	00002617          	auipc	a2,0x2
ffffffffc0202e10:	f8c60613          	addi	a2,a2,-116 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202e14:	0cd00593          	li	a1,205
ffffffffc0202e18:	00003517          	auipc	a0,0x3
ffffffffc0202e1c:	9d850513          	addi	a0,a0,-1576 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202e20:	d54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0202e24:	00003697          	auipc	a3,0x3
ffffffffc0202e28:	a9c68693          	addi	a3,a3,-1380 # ffffffffc02058c0 <default_pmm_manager+0x778>
ffffffffc0202e2c:	00002617          	auipc	a2,0x2
ffffffffc0202e30:	f6c60613          	addi	a2,a2,-148 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202e34:	0d500593          	li	a1,213
ffffffffc0202e38:	00003517          	auipc	a0,0x3
ffffffffc0202e3c:	9b850513          	addi	a0,a0,-1608 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202e40:	d34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(total == nr_free_pages());
ffffffffc0202e44:	00002697          	auipc	a3,0x2
ffffffffc0202e48:	f8468693          	addi	a3,a3,-124 # ffffffffc0204dc8 <commands+0x768>
ffffffffc0202e4c:	00002617          	auipc	a2,0x2
ffffffffc0202e50:	f4c60613          	addi	a2,a2,-180 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202e54:	0bd00593          	li	a1,189
ffffffffc0202e58:	00003517          	auipc	a0,0x3
ffffffffc0202e5c:	99850513          	addi	a0,a0,-1640 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202e60:	d14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e64:	00003697          	auipc	a3,0x3
ffffffffc0202e68:	b3468693          	addi	a3,a3,-1228 # ffffffffc0205998 <default_pmm_manager+0x850>
ffffffffc0202e6c:	00002617          	auipc	a2,0x2
ffffffffc0202e70:	f2c60613          	addi	a2,a2,-212 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202e74:	09500593          	li	a1,149
ffffffffc0202e78:	00003517          	auipc	a0,0x3
ffffffffc0202e7c:	97850513          	addi	a0,a0,-1672 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202e80:	cf4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202e84:	00003697          	auipc	a3,0x3
ffffffffc0202e88:	b1468693          	addi	a3,a3,-1260 # ffffffffc0205998 <default_pmm_manager+0x850>
ffffffffc0202e8c:	00002617          	auipc	a2,0x2
ffffffffc0202e90:	f0c60613          	addi	a2,a2,-244 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202e94:	09700593          	li	a1,151
ffffffffc0202e98:	00003517          	auipc	a0,0x3
ffffffffc0202e9c:	95850513          	addi	a0,a0,-1704 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202ea0:	cd4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ea4:	00003697          	auipc	a3,0x3
ffffffffc0202ea8:	b0468693          	addi	a3,a3,-1276 # ffffffffc02059a8 <default_pmm_manager+0x860>
ffffffffc0202eac:	00002617          	auipc	a2,0x2
ffffffffc0202eb0:	eec60613          	addi	a2,a2,-276 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202eb4:	09900593          	li	a1,153
ffffffffc0202eb8:	00003517          	auipc	a0,0x3
ffffffffc0202ebc:	93850513          	addi	a0,a0,-1736 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202ec0:	cb4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ec4:	00003697          	auipc	a3,0x3
ffffffffc0202ec8:	ae468693          	addi	a3,a3,-1308 # ffffffffc02059a8 <default_pmm_manager+0x860>
ffffffffc0202ecc:	00002617          	auipc	a2,0x2
ffffffffc0202ed0:	ecc60613          	addi	a2,a2,-308 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202ed4:	09b00593          	li	a1,155
ffffffffc0202ed8:	00003517          	auipc	a0,0x3
ffffffffc0202edc:	91850513          	addi	a0,a0,-1768 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202ee0:	c94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202ee4:	00003697          	auipc	a3,0x3
ffffffffc0202ee8:	aa468693          	addi	a3,a3,-1372 # ffffffffc0205988 <default_pmm_manager+0x840>
ffffffffc0202eec:	00002617          	auipc	a2,0x2
ffffffffc0202ef0:	eac60613          	addi	a2,a2,-340 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202ef4:	09100593          	li	a1,145
ffffffffc0202ef8:	00003517          	auipc	a0,0x3
ffffffffc0202efc:	8f850513          	addi	a0,a0,-1800 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202f00:	c74fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202f04:	00003697          	auipc	a3,0x3
ffffffffc0202f08:	a8468693          	addi	a3,a3,-1404 # ffffffffc0205988 <default_pmm_manager+0x840>
ffffffffc0202f0c:	00002617          	auipc	a2,0x2
ffffffffc0202f10:	e8c60613          	addi	a2,a2,-372 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202f14:	09300593          	li	a1,147
ffffffffc0202f18:	00003517          	auipc	a0,0x3
ffffffffc0202f1c:	8d850513          	addi	a0,a0,-1832 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202f20:	c54fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(mm != NULL);
ffffffffc0202f24:	00003697          	auipc	a3,0x3
ffffffffc0202f28:	91c68693          	addi	a3,a3,-1764 # ffffffffc0205840 <default_pmm_manager+0x6f8>
ffffffffc0202f2c:	00002617          	auipc	a2,0x2
ffffffffc0202f30:	e6c60613          	addi	a2,a2,-404 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202f34:	0c200593          	li	a1,194
ffffffffc0202f38:	00003517          	auipc	a0,0x3
ffffffffc0202f3c:	8b850513          	addi	a0,a0,-1864 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202f40:	c34fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0202f44:	00003697          	auipc	a3,0x3
ffffffffc0202f48:	90c68693          	addi	a3,a3,-1780 # ffffffffc0205850 <default_pmm_manager+0x708>
ffffffffc0202f4c:	00002617          	auipc	a2,0x2
ffffffffc0202f50:	e4c60613          	addi	a2,a2,-436 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202f54:	0c500593          	li	a1,197
ffffffffc0202f58:	00003517          	auipc	a0,0x3
ffffffffc0202f5c:	89850513          	addi	a0,a0,-1896 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
ffffffffc0202f60:	c14fd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0202f64:	00003697          	auipc	a3,0x3
ffffffffc0202f68:	9d468693          	addi	a3,a3,-1580 # ffffffffc0205938 <default_pmm_manager+0x7f0>
ffffffffc0202f6c:	00002617          	auipc	a2,0x2
ffffffffc0202f70:	e2c60613          	addi	a2,a2,-468 # ffffffffc0204d98 <commands+0x738>
ffffffffc0202f74:	0e800593          	li	a1,232
ffffffffc0202f78:	00003517          	auipc	a0,0x3
ffffffffc0202f7c:	87850513          	addi	a0,a0,-1928 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
...
ffffffffc0202fc8:	b14b0b13          	addi	s6,s6,-1260 # ffffffffc0205ad8 <default_pmm_manager+0x990>
                    cprintf("SWAP: failed to save\n");
ffffffffc0202fcc:	00003b97          	auipc	s7,0x3
ffffffffc0202fd0:	af4b8b93          	addi	s7,s7,-1292 # ffffffffc0205ac0 <default_pmm_manager+0x978>
...
ffffffffc0203040:	5e1000ef          	jal	ra,ffffffffc0203e20 <swapfs_write>
...
ffffffffc0203082:	9fa50513          	addi	a0,a0,-1542 # ffffffffc0205a78 <default_pmm_manager+0x930>
...
ffffffffc0203094:	a1868693          	addi	a3,a3,-1512 # ffffffffc0205aa8 <default_pmm_manager+0x960>
ffffffffc0203098:	00002617          	auipc	a2,0x2
ffffffffc020309c:	d0060613          	addi	a2,a2,-768 # ffffffffc0204d98 <commands+0x738>
ffffffffc02030a0:	06600593          	li	a1,102
ffffffffc02030a4:	00002517          	auipc	a0,0x2
ffffffffc02030a8:	74c50513          	addi	a0,a0,1868 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
...
ffffffffc02030de:	4a9000ef          	jal	ra,ffffffffc0203d86 <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc02030e2:	00093583          	ld	a1,0(s2)
ffffffffc02030e6:	8626                	mv	a2,s1
ffffffffc02030e8:	00003517          	auipc	a0,0x3
ffffffffc02030ec:	a4050513          	addi	a0,a0,-1472 # ffffffffc0205b28 <default_pmm_manager+0x9e0>
...
ffffffffc020310e:	a0e68693          	addi	a3,a3,-1522 # ffffffffc0205b18 <default_pmm_manager+0x9d0>
ffffffffc0203112:	00002617          	auipc	a2,0x2
ffffffffc0203116:	c8660613          	addi	a2,a2,-890 # ffffffffc0204d98 <commands+0x738>
ffffffffc020311a:	07c00593          	li	a1,124
ffffffffc020311e:	00002517          	auipc	a0,0x2
ffffffffc0203122:	6d250513          	addi	a0,a0,1746 # ffffffffc02057f0 <default_pmm_manager+0x6a8>
...
ffffffffc0203210:	7ac68693          	addi	a3,a3,1964 # ffffffffc02059b8 <default_pmm_manager+0x870>
ffffffffc0203214:	00002617          	auipc	a2,0x2
ffffffffc0203218:	b8460613          	addi	a2,a2,-1148 # ffffffffc0204d98 <commands+0x738>
ffffffffc020321c:	09800593          	li	a1,152
ffffffffc0203220:	00003517          	auipc	a0,0x3
ffffffffc0203224:	94850513          	addi	a0,a0,-1720 # ffffffffc0205b68 <default_pmm_manager+0xa20>
ffffffffc0203228:	94cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==6);
ffffffffc020322c:	00003697          	auipc	a3,0x3
ffffffffc0203230:	98c68693          	addi	a3,a3,-1652 # ffffffffc0205bb8 <default_pmm_manager+0xa70>
ffffffffc0203234:	00002617          	auipc	a2,0x2
ffffffffc0203238:	b6460613          	addi	a2,a2,-1180 # ffffffffc0204d98 <commands+0x738>
ffffffffc020323c:	0af00593          	li	a1,175
ffffffffc0203240:	00003517          	auipc	a0,0x3
ffffffffc0203244:	92850513          	addi	a0,a0,-1752 # ffffffffc0205b68 <default_pmm_manager+0xa20>
ffffffffc0203248:	92cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc020324c:	00003697          	auipc	a3,0x3
ffffffffc0203250:	94468693          	addi	a3,a3,-1724 # ffffffffc0205b90 <default_pmm_manager+0xa48>
ffffffffc0203254:	00002617          	auipc	a2,0x2
ffffffffc0203258:	b4460613          	addi	a2,a2,-1212 # ffffffffc0204d98 <commands+0x738>
ffffffffc020325c:	0ad00593          	li	a1,173
ffffffffc0203260:	00003517          	auipc	a0,0x3
ffffffffc0203264:	90850513          	addi	a0,a0,-1784 # ffffffffc0205b68 <default_pmm_manager+0xa20>
ffffffffc0203268:	90cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020326c:	00003697          	auipc	a3,0x3
ffffffffc0203270:	91468693          	addi	a3,a3,-1772 # ffffffffc0205b80 <default_pmm_manager+0xa38>
ffffffffc0203274:	00002617          	auipc	a2,0x2
ffffffffc0203278:	b2460613          	addi	a2,a2,-1244 # ffffffffc0204d98 <commands+0x738>
ffffffffc020327c:	0ac00593          	li	a1,172
ffffffffc0203280:	00003517          	auipc	a0,0x3
ffffffffc0203284:	8e850513          	addi	a0,a0,-1816 # ffffffffc0205b68 <default_pmm_manager+0xa20>
ffffffffc0203288:	8ecfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020328c:	00003697          	auipc	a3,0x3
ffffffffc0203290:	8f468693          	addi	a3,a3,-1804 # ffffffffc0205b80 <default_pmm_manager+0xa38>
ffffffffc0203294:	00002617          	auipc	a2,0x2
ffffffffc0203298:	b0460613          	addi	a2,a2,-1276 # ffffffffc0204d98 <commands+0x738>
ffffffffc020329c:	0aa00593          	li	a1,170
ffffffffc02032a0:	00003517          	auipc	a0,0x3
ffffffffc02032a4:	8c850513          	addi	a0,a0,-1848 # ffffffffc0205b68 <default_pmm_manager+0xa20>
ffffffffc02032a8:	8ccfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032ac:	00003697          	auipc	a3,0x3
ffffffffc02032b0:	8d468693          	addi	a3,a3,-1836 # ffffffffc0205b80 <default_pmm_manager+0xa38>
ffffffffc02032b4:	00002617          	auipc	a2,0x2
ffffffffc02032b8:	ae460613          	addi	a2,a2,-1308 # ffffffffc0204d98 <commands+0x738>
ffffffffc02032bc:	0a800593          	li	a1,168
ffffffffc02032c0:	00003517          	auipc	a0,0x3
ffffffffc02032c4:	8a850513          	addi	a0,a0,-1880 # ffffffffc0205b68 <default_pmm_manager+0xa20>
ffffffffc02032c8:	8acfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032cc:	00003697          	auipc	a3,0x3
ffffffffc02032d0:	8b468693          	addi	a3,a3,-1868 # ffffffffc0205b80 <default_pmm_manager+0xa38>
ffffffffc02032d4:	00002617          	auipc	a2,0x2
ffffffffc02032d8:	ac460613          	addi	a2,a2,-1340 # ffffffffc0204d98 <commands+0x738>
ffffffffc02032dc:	0a600593          	li	a1,166
ffffffffc02032e0:	00003517          	auipc	a0,0x3
ffffffffc02032e4:	88850513          	addi	a0,a0,-1912 # ffffffffc0205b68 <default_pmm_manager+0xa20>
ffffffffc02032e8:	88cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02032ec:	00003697          	auipc	a3,0x3
ffffffffc02032f0:	89468693          	addi	a3,a3,-1900 # ffffffffc0205b80 <default_pmm_manager+0xa38>
ffffffffc02032f4:	00002617          	auipc	a2,0x2
ffffffffc02032f8:	aa460613          	addi	a2,a2,-1372 # ffffffffc0204d98 <commands+0x738>
ffffffffc02032fc:	0a400593          	li	a1,164
ffffffffc0203300:	00003517          	auipc	a0,0x3
ffffffffc0203304:	86850513          	addi	a0,a0,-1944 # ffffffffc0205b68 <default_pmm_manager+0xa20>
ffffffffc0203308:	86cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020330c:	00003697          	auipc	a3,0x3
ffffffffc0203310:	87468693          	addi	a3,a3,-1932 # ffffffffc0205b80 <default_pmm_manager+0xa38>
ffffffffc0203314:	00002617          	auipc	a2,0x2
ffffffffc0203318:	a8460613          	addi	a2,a2,-1404 # ffffffffc0204d98 <commands+0x738>
ffffffffc020331c:	0a200593          	li	a1,162
ffffffffc0203320:	00003517          	auipc	a0,0x3
ffffffffc0203324:	84850513          	addi	a0,a0,-1976 # ffffffffc0205b68 <default_pmm_manager+0xa20>
ffffffffc0203328:	84cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc020332c:	00003697          	auipc	a3,0x3
ffffffffc0203330:	85468693          	addi	a3,a3,-1964 # ffffffffc0205b80 <default_pmm_manager+0xa38>
ffffffffc0203334:	00002617          	auipc	a2,0x2
ffffffffc0203338:	a6460613          	addi	a2,a2,-1436 # ffffffffc0204d98 <commands+0x738>
ffffffffc020333c:	0a000593          	li	a1,160
ffffffffc0203340:	00003517          	auipc	a0,0x3
ffffffffc0203344:	82850513          	addi	a0,a0,-2008 # ffffffffc0205b68 <default_pmm_manager+0xa20>
ffffffffc0203348:	82cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020334c:	00002697          	auipc	a3,0x2
ffffffffc0203350:	66c68693          	addi	a3,a3,1644 # ffffffffc02059b8 <default_pmm_manager+0x870>
ffffffffc0203354:	00002617          	auipc	a2,0x2
ffffffffc0203358:	a4460613          	addi	a2,a2,-1468 # ffffffffc0204d98 <commands+0x738>
ffffffffc020335c:	09e00593          	li	a1,158
ffffffffc0203360:	00003517          	auipc	a0,0x3
ffffffffc0203364:	80850513          	addi	a0,a0,-2040 # ffffffffc0205b68 <default_pmm_manager+0xa20>
ffffffffc0203368:	80cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020336c:	00002697          	auipc	a3,0x2
ffffffffc0203370:	64c68693          	addi	a3,a3,1612 # ffffffffc02059b8 <default_pmm_manager+0x870>
ffffffffc0203374:	00002617          	auipc	a2,0x2
ffffffffc0203378:	a2460613          	addi	a2,a2,-1500 # ffffffffc0204d98 <commands+0x738>
ffffffffc020337c:	09c00593          	li	a1,156
ffffffffc0203380:	00002517          	auipc	a0,0x2
ffffffffc0203384:	7e850513          	addi	a0,a0,2024 # ffffffffc0205b68 <default_pmm_manager+0xa20>
ffffffffc0203388:	fedfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc020338c:	00002697          	auipc	a3,0x2
ffffffffc0203390:	62c68693          	addi	a3,a3,1580 # ffffffffc02059b8 <default_pmm_manager+0x870>
ffffffffc0203394:	00002617          	auipc	a2,0x2
ffffffffc0203398:	a0460613          	addi	a2,a2,-1532 # ffffffffc0204d98 <commands+0x738>
ffffffffc020339c:	09a00593          	li	a1,154
ffffffffc02033a0:	00002517          	auipc	a0,0x2
ffffffffc02033a4:	7c850513          	addi	a0,a0,1992 # ffffffffc0205b68 <default_pmm_manager+0xa20>
...
{
ffffffffc02033ae:	7179                	addi	sp,sp,-48
ffffffffc02033b0:	f406                	sd	ra,40(sp)
...
ffffffffc02033b8:	e44e                	sd	s3,8(sp)
         assert(head != NULL);
ffffffffc02033ba:	c33d                	beqz	a4,ffffffffc0203420 <_clock_swap_out_victim+0x74>
     assert(in_tick==0);
ffffffffc02033bc:	e251                	bnez	a2,ffffffffc0203440 <_clock_swap_out_victim+0x94>
ffffffffc02033be:	0000e917          	auipc	s2,0xe
ffffffffc02033c2:	19a90913          	addi	s2,s2,410 # ffffffffc0211558 <curr_ptr>
ffffffffc02033c6:	00093403          	ld	s0,0(s2)
ffffffffc02033ca:	89ae                	mv	s3,a1
ffffffffc02033cc:	4681                	li	a3,0
ffffffffc02033ce:	a029                	j	ffffffffc02033d8 <_clock_swap_out_victim+0x2c>
            page->visited = 0;
ffffffffc02033d0:	fe043023          	sd	zero,-32(s0)
    return listelm->next;
ffffffffc02033d4:	8426                	mv	s0,s1
ffffffffc02033d6:	4685                	li	a3,1
ffffffffc02033d8:	6404                	ld	s1,8(s0)
         if(curr_ptr == head)
ffffffffc02033da:	fe870de3          	beq	a4,s0,ffffffffc02033d4 <_clock_swap_out_victim+0x28>
        if(page->visited == 0)
ffffffffc02033de:	fe043783          	ld	a5,-32(s0)
ffffffffc02033e2:	f7fd                	bnez	a5,ffffffffc02033d0 <_clock_swap_out_victim+0x24>
ffffffffc02033e4:	c299                	beqz	a3,ffffffffc02033ea <_clock_swap_out_victim+0x3e>
ffffffffc02033e6:	00893023          	sd	s0,0(s2)
            cprintf("curr_ptr 0xffffffff%x\n",curr_ptr);
ffffffffc02033ea:	85a2                	mv	a1,s0
ffffffffc02033ec:	00002517          	auipc	a0,0x2
ffffffffc02033f0:	7fc50513          	addi	a0,a0,2044 # ffffffffc0205be8 <default_pmm_manager+0xaa0>
ffffffffc02033f4:	cc7fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
            list_del(curr_ptr);
ffffffffc02033f8:	00093783          	ld	a5,0(s2)
        struct Page * page = le2page(curr_ptr,pra_page_link);
ffffffffc02033fc:	fd040413          	addi	s0,s0,-48
}
ffffffffc0203400:	70a2                	ld	ra,40(sp)
    __list_del(listelm->prev, listelm->next);
ffffffffc0203402:	6398                	ld	a4,0(a5)
...
ffffffffc020340a:	e398                	sd	a4,0(a5)
            *ptr_page = page;
ffffffffc020340c:	0089b023          	sd	s0,0(s3)
}
ffffffffc0203410:	7402                	ld	s0,32(sp)
            curr_ptr = next_entry;
ffffffffc0203412:	00993023          	sd	s1,0(s2)
}
ffffffffc0203416:	69a2                	ld	s3,8(sp)
...
ffffffffc0203424:	7a868693          	addi	a3,a3,1960 # ffffffffc0205bc8 <default_pmm_manager+0xa80>
ffffffffc0203428:	00002617          	auipc	a2,0x2
ffffffffc020342c:	97060613          	addi	a2,a2,-1680 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203430:	04f00593          	li	a1,79
ffffffffc0203434:	00002517          	auipc	a0,0x2
ffffffffc0203438:	73450513          	addi	a0,a0,1844 # ffffffffc0205b68 <default_pmm_manager+0xa20>
ffffffffc020343c:	f39fc0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(in_tick==0);
ffffffffc0203440:	00002697          	auipc	a3,0x2
ffffffffc0203444:	79868693          	addi	a3,a3,1944 # ffffffffc0205bd8 <default_pmm_manager+0xa90>
ffffffffc0203448:	00002617          	auipc	a2,0x2
ffffffffc020344c:	95060613          	addi	a2,a2,-1712 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203450:	05000593          	li	a1,80
ffffffffc0203454:	00002517          	auipc	a0,0x2
ffffffffc0203458:	71450513          	addi	a0,a0,1812 # ffffffffc0205b68 <default_pmm_manager+0xa20>
...
ffffffffc0203468:	cf89                	beqz	a5,ffffffffc0203482 <_clock_map_swappable+0x22>
    list_entry_t *head=(list_entry_t*) mm->sm_priv;
...
ffffffffc0203472:	6394                	ld	a3,0(a5)
    prev->next = next->prev = elm;
ffffffffc0203474:	e398                	sd	a4,0(a5)
ffffffffc0203476:	e698                	sd	a4,8(a3)
    elm->next = next;
ffffffffc0203478:	fe1c                	sd	a5,56(a2)
    page->visited = 1;
ffffffffc020347a:	4785                	li	a5,1
    elm->prev = prev;
ffffffffc020347c:	fa14                	sd	a3,48(a2)
...
ffffffffc0203488:	77c68693          	addi	a3,a3,1916 # ffffffffc0205c00 <default_pmm_manager+0xab8>
ffffffffc020348c:	00002617          	auipc	a2,0x2
ffffffffc0203490:	90c60613          	addi	a2,a2,-1780 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203494:	03a00593          	li	a1,58
ffffffffc0203498:	00002517          	auipc	a0,0x2
ffffffffc020349c:	6d050513          	addi	a0,a0,1744 # ffffffffc0205b68 <default_pmm_manager+0xa20>
{
...
ffffffffc02034ac:	79868693          	addi	a3,a3,1944 # ffffffffc0205c40 <default_pmm_manager+0xaf8>
ffffffffc02034b0:	00002617          	auipc	a2,0x2
ffffffffc02034b4:	8e860613          	addi	a2,a2,-1816 # ffffffffc0204d98 <commands+0x738>
ffffffffc02034b8:	07d00593          	li	a1,125
ffffffffc02034bc:	00002517          	auipc	a0,0x2
ffffffffc02034c0:	7a450513          	addi	a0,a0,1956 # ffffffffc0205c60 <default_pmm_manager+0xb18>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0203582:	0105b803          	ld	a6,16(a1) # 1010 <kern_entry-0xffffffffc01feff0>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
...
ffffffffc02035f4:	68068693          	addi	a3,a3,1664 # ffffffffc0205c70 <default_pmm_manager+0xb28>
ffffffffc02035f8:	00001617          	auipc	a2,0x1
ffffffffc02035fc:	7a060613          	addi	a2,a2,1952 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203600:	08400593          	li	a1,132
ffffffffc0203604:	00002517          	auipc	a0,0x2
ffffffffc0203608:	65c50513          	addi	a0,a0,1628 # ffffffffc0205c60 <default_pmm_manager+0xb18>
ffffffffc020360c:	d69fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203610:	00002697          	auipc	a3,0x2
ffffffffc0203614:	6a068693          	addi	a3,a3,1696 # ffffffffc0205cb0 <default_pmm_manager+0xb68>
ffffffffc0203618:	00001617          	auipc	a2,0x1
ffffffffc020361c:	78060613          	addi	a2,a2,1920 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203620:	07c00593          	li	a1,124
ffffffffc0203624:	00002517          	auipc	a0,0x2
ffffffffc0203628:	63c50513          	addi	a0,a0,1596 # ffffffffc0205c60 <default_pmm_manager+0xb18>
ffffffffc020362c:	d49fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc0203630:	00002697          	auipc	a3,0x2
ffffffffc0203634:	66068693          	addi	a3,a3,1632 # ffffffffc0205c90 <default_pmm_manager+0xb48>
ffffffffc0203638:	00001617          	auipc	a2,0x1
ffffffffc020363c:	76060613          	addi	a2,a2,1888 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203640:	07b00593          	li	a1,123
ffffffffc0203644:	00002517          	auipc	a0,0x2
ffffffffc0203648:	61c50513          	addi	a0,a0,1564 # ffffffffc0205c60 <default_pmm_manager+0xb18>
...
ffffffffc02036fe:	17e68693          	addi	a3,a3,382 # ffffffffc0205878 <default_pmm_manager+0x730>
ffffffffc0203702:	00001617          	auipc	a2,0x1
ffffffffc0203706:	69660613          	addi	a2,a2,1686 # ffffffffc0204d98 <commands+0x738>
ffffffffc020370a:	0ce00593          	li	a1,206
ffffffffc020370e:	00002517          	auipc	a0,0x2
ffffffffc0203712:	55250513          	addi	a0,a0,1362 # ffffffffc0205c60 <default_pmm_manager+0xb18>
...
ffffffffc0203752:	12a68693          	addi	a3,a3,298 # ffffffffc0205878 <default_pmm_manager+0x730>
ffffffffc0203756:	00001617          	auipc	a2,0x1
ffffffffc020375a:	64260613          	addi	a2,a2,1602 # ffffffffc0204d98 <commands+0x738>
ffffffffc020375e:	0d400593          	li	a1,212
ffffffffc0203762:	00002517          	auipc	a0,0x2
ffffffffc0203766:	4fe50513          	addi	a0,a0,1278 # ffffffffc0205c60 <default_pmm_manager+0xb18>
...
ffffffffc0203826:	5ae50513          	addi	a0,a0,1454 # ffffffffc0205dd0 <default_pmm_manager+0xc88>
ffffffffc020382a:	891fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc020382e:	00002697          	auipc	a3,0x2
ffffffffc0203832:	5ca68693          	addi	a3,a3,1482 # ffffffffc0205df8 <default_pmm_manager+0xcb0>
ffffffffc0203836:	00001617          	auipc	a2,0x1
ffffffffc020383a:	56260613          	addi	a2,a2,1378 # ffffffffc0204d98 <commands+0x738>
ffffffffc020383e:	0f600593          	li	a1,246
ffffffffc0203842:	00002517          	auipc	a0,0x2
ffffffffc0203846:	41e50513          	addi	a0,a0,1054 # ffffffffc0205c60 <default_pmm_manager+0xb18>
...
ffffffffc0203884:	5b850513          	addi	a0,a0,1464 # ffffffffc0205e38 <default_pmm_manager+0xcf0>
...
ffffffffc0203962:	8c273703          	ld	a4,-1854(a4) # ffffffffc0206220 <nbase>
...
ffffffffc02039c6:	4c650513          	addi	a0,a0,1222 # ffffffffc0205e88 <default_pmm_manager+0xd40>
...
ffffffffc02039ee:	4be50513          	addi	a0,a0,1214 # ffffffffc0205ea8 <default_pmm_manager+0xd60>
}
...
ffffffffc0203a02:	2ea68693          	addi	a3,a3,746 # ffffffffc0205ce8 <default_pmm_manager+0xba0>
ffffffffc0203a06:	00001617          	auipc	a2,0x1
ffffffffc0203a0a:	39260613          	addi	a2,a2,914 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203a0e:	0dd00593          	li	a1,221
ffffffffc0203a12:	00002517          	auipc	a0,0x2
ffffffffc0203a16:	24e50513          	addi	a0,a0,590 # ffffffffc0205c60 <default_pmm_manager+0xb18>
ffffffffc0203a1a:	95bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203a1e:	00002697          	auipc	a3,0x2
ffffffffc0203a22:	38268693          	addi	a3,a3,898 # ffffffffc0205da0 <default_pmm_manager+0xc58>
ffffffffc0203a26:	00001617          	auipc	a2,0x1
ffffffffc0203a2a:	37260613          	addi	a2,a2,882 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203a2e:	0ee00593          	li	a1,238
ffffffffc0203a32:	00002517          	auipc	a0,0x2
ffffffffc0203a36:	22e50513          	addi	a0,a0,558 # ffffffffc0205c60 <default_pmm_manager+0xb18>
ffffffffc0203a3a:	93bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203a3e:	00002697          	auipc	a3,0x2
ffffffffc0203a42:	33268693          	addi	a3,a3,818 # ffffffffc0205d70 <default_pmm_manager+0xc28>
ffffffffc0203a46:	00001617          	auipc	a2,0x1
ffffffffc0203a4a:	35260613          	addi	a2,a2,850 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203a4e:	0ed00593          	li	a1,237
ffffffffc0203a52:	00002517          	auipc	a0,0x2
ffffffffc0203a56:	20e50513          	addi	a0,a0,526 # ffffffffc0205c60 <default_pmm_manager+0xb18>
ffffffffc0203a5a:	91bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203a5e:	00002697          	auipc	a3,0x2
ffffffffc0203a62:	27268693          	addi	a3,a3,626 # ffffffffc0205cd0 <default_pmm_manager+0xb88>
ffffffffc0203a66:	00001617          	auipc	a2,0x1
ffffffffc0203a6a:	33260613          	addi	a2,a2,818 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203a6e:	0db00593          	li	a1,219
ffffffffc0203a72:	00002517          	auipc	a0,0x2
ffffffffc0203a76:	1ee50513          	addi	a0,a0,494 # ffffffffc0205c60 <default_pmm_manager+0xb18>
ffffffffc0203a7a:	8fbfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc0203a7e:	00002697          	auipc	a3,0x2
ffffffffc0203a82:	2a268693          	addi	a3,a3,674 # ffffffffc0205d20 <default_pmm_manager+0xbd8>
ffffffffc0203a86:	00001617          	auipc	a2,0x1
ffffffffc0203a8a:	31260613          	addi	a2,a2,786 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203a8e:	0e300593          	li	a1,227
ffffffffc0203a92:	00002517          	auipc	a0,0x2
ffffffffc0203a96:	1ce50513          	addi	a0,a0,462 # ffffffffc0205c60 <default_pmm_manager+0xb18>
ffffffffc0203a9a:	8dbfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc0203a9e:	00002697          	auipc	a3,0x2
ffffffffc0203aa2:	29268693          	addi	a3,a3,658 # ffffffffc0205d30 <default_pmm_manager+0xbe8>
ffffffffc0203aa6:	00001617          	auipc	a2,0x1
ffffffffc0203aaa:	2f260613          	addi	a2,a2,754 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203aae:	0e500593          	li	a1,229
ffffffffc0203ab2:	00002517          	auipc	a0,0x2
ffffffffc0203ab6:	1ae50513          	addi	a0,a0,430 # ffffffffc0205c60 <default_pmm_manager+0xb18>
ffffffffc0203aba:	8bbfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc0203abe:	00002697          	auipc	a3,0x2
ffffffffc0203ac2:	28268693          	addi	a3,a3,642 # ffffffffc0205d40 <default_pmm_manager+0xbf8>
ffffffffc0203ac6:	00001617          	auipc	a2,0x1
ffffffffc0203aca:	2d260613          	addi	a2,a2,722 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203ace:	0e700593          	li	a1,231
ffffffffc0203ad2:	00002517          	auipc	a0,0x2
ffffffffc0203ad6:	18e50513          	addi	a0,a0,398 # ffffffffc0205c60 <default_pmm_manager+0xb18>
ffffffffc0203ada:	89bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc0203ade:	00002697          	auipc	a3,0x2
ffffffffc0203ae2:	27268693          	addi	a3,a3,626 # ffffffffc0205d50 <default_pmm_manager+0xc08>
ffffffffc0203ae6:	00001617          	auipc	a2,0x1
ffffffffc0203aea:	2b260613          	addi	a2,a2,690 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203aee:	0e900593          	li	a1,233
ffffffffc0203af2:	00002517          	auipc	a0,0x2
ffffffffc0203af6:	16e50513          	addi	a0,a0,366 # ffffffffc0205c60 <default_pmm_manager+0xb18>
ffffffffc0203afa:	87bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc0203afe:	00002697          	auipc	a3,0x2
ffffffffc0203b02:	26268693          	addi	a3,a3,610 # ffffffffc0205d60 <default_pmm_manager+0xc18>
ffffffffc0203b06:	00001617          	auipc	a2,0x1
ffffffffc0203b0a:	29260613          	addi	a2,a2,658 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203b0e:	0eb00593          	li	a1,235
ffffffffc0203b12:	00002517          	auipc	a0,0x2
ffffffffc0203b16:	14e50513          	addi	a0,a0,334 # ffffffffc0205c60 <default_pmm_manager+0xb18>
ffffffffc0203b1a:	85bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203b1e:	00002697          	auipc	a3,0x2
ffffffffc0203b22:	d4a68693          	addi	a3,a3,-694 # ffffffffc0205868 <default_pmm_manager+0x720>
ffffffffc0203b26:	00001617          	auipc	a2,0x1
ffffffffc0203b2a:	27260613          	addi	a2,a2,626 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203b2e:	10d00593          	li	a1,269
ffffffffc0203b32:	00002517          	auipc	a0,0x2
ffffffffc0203b36:	12e50513          	addi	a0,a0,302 # ffffffffc0205c60 <default_pmm_manager+0xb18>
ffffffffc0203b3a:	83bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203b3e:	00002697          	auipc	a3,0x2
ffffffffc0203b42:	38268693          	addi	a3,a3,898 # ffffffffc0205ec0 <default_pmm_manager+0xd78>
ffffffffc0203b46:	00001617          	auipc	a2,0x1
ffffffffc0203b4a:	25260613          	addi	a2,a2,594 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203b4e:	10a00593          	li	a1,266
ffffffffc0203b52:	00002517          	auipc	a0,0x2
ffffffffc0203b56:	10e50513          	addi	a0,a0,270 # ffffffffc0205c60 <default_pmm_manager+0xb18>
    check_mm_struct = mm_create();
...
ffffffffc0203b6a:	d1268693          	addi	a3,a3,-750 # ffffffffc0205878 <default_pmm_manager+0x730>
ffffffffc0203b6e:	00001617          	auipc	a2,0x1
ffffffffc0203b72:	22a60613          	addi	a2,a2,554 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203b76:	11100593          	li	a1,273
ffffffffc0203b7a:	00002517          	auipc	a0,0x2
ffffffffc0203b7e:	0e650513          	addi	a0,a0,230 # ffffffffc0205c60 <default_pmm_manager+0xb18>
ffffffffc0203b82:	ff2fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203b86:	00002697          	auipc	a3,0x2
ffffffffc0203b8a:	2d268693          	addi	a3,a3,722 # ffffffffc0205e58 <default_pmm_manager+0xd10>
ffffffffc0203b8e:	00001617          	auipc	a2,0x1
ffffffffc0203b92:	20a60613          	addi	a2,a2,522 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203b96:	11600593          	li	a1,278
ffffffffc0203b9a:	00002517          	auipc	a0,0x2
ffffffffc0203b9e:	0c650513          	addi	a0,a0,198 # ffffffffc0205c60 <default_pmm_manager+0xb18>
ffffffffc0203ba2:	fd2fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203ba6:	00002697          	auipc	a3,0x2
ffffffffc0203baa:	2d268693          	addi	a3,a3,722 # ffffffffc0205e78 <default_pmm_manager+0xd30>
ffffffffc0203bae:	00001617          	auipc	a2,0x1
ffffffffc0203bb2:	1ea60613          	addi	a2,a2,490 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203bb6:	12000593          	li	a1,288
ffffffffc0203bba:	00002517          	auipc	a0,0x2
ffffffffc0203bbe:	0a650513          	addi	a0,a0,166 # ffffffffc0205c60 <default_pmm_manager+0xb18>
ffffffffc0203bc2:	fb2fc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203bc6:	00001617          	auipc	a2,0x1
ffffffffc0203bca:	5ba60613          	addi	a2,a2,1466 # ffffffffc0205180 <default_pmm_manager+0x38>
ffffffffc0203bce:	06500593          	li	a1,101
ffffffffc0203bd2:	00001517          	auipc	a0,0x1
ffffffffc0203bd6:	5ce50513          	addi	a0,a0,1486 # ffffffffc02051a0 <default_pmm_manager+0x58>
ffffffffc0203bda:	f9afc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203bde:	00002697          	auipc	a3,0x2
ffffffffc0203be2:	23268693          	addi	a3,a3,562 # ffffffffc0205e10 <default_pmm_manager+0xcc8>
ffffffffc0203be6:	00001617          	auipc	a2,0x1
ffffffffc0203bea:	1b260613          	addi	a2,a2,434 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203bee:	12e00593          	li	a1,302
ffffffffc0203bf2:	00002517          	auipc	a0,0x2
ffffffffc0203bf6:	06e50513          	addi	a0,a0,110 # ffffffffc0205c60 <default_pmm_manager+0xb18>
ffffffffc0203bfa:	f7afc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203bfe:	00002697          	auipc	a3,0x2
ffffffffc0203c02:	21268693          	addi	a3,a3,530 # ffffffffc0205e10 <default_pmm_manager+0xcc8>
ffffffffc0203c06:	00001617          	auipc	a2,0x1
ffffffffc0203c0a:	19260613          	addi	a2,a2,402 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203c0e:	0bd00593          	li	a1,189
ffffffffc0203c12:	00002517          	auipc	a0,0x2
ffffffffc0203c16:	04e50513          	addi	a0,a0,78 # ffffffffc0205c60 <default_pmm_manager+0xb18>
ffffffffc0203c1a:	f5afc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc0203c1e:	00002697          	auipc	a3,0x2
ffffffffc0203c22:	c2268693          	addi	a3,a3,-990 # ffffffffc0205840 <default_pmm_manager+0x6f8>
ffffffffc0203c26:	00001617          	auipc	a2,0x1
ffffffffc0203c2a:	17260613          	addi	a2,a2,370 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203c2e:	0c700593          	li	a1,199
ffffffffc0203c32:	00002517          	auipc	a0,0x2
ffffffffc0203c36:	02e50513          	addi	a0,a0,46 # ffffffffc0205c60 <default_pmm_manager+0xb18>
ffffffffc0203c3a:	f3afc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203c3e:	00002697          	auipc	a3,0x2
ffffffffc0203c42:	1d268693          	addi	a3,a3,466 # ffffffffc0205e10 <default_pmm_manager+0xcc8>
ffffffffc0203c46:	00001617          	auipc	a2,0x1
ffffffffc0203c4a:	15260613          	addi	a2,a2,338 # ffffffffc0204d98 <commands+0x738>
ffffffffc0203c4e:	0fb00593          	li	a1,251
ffffffffc0203c52:	00002517          	auipc	a0,0x2
ffffffffc0203c56:	00e50513          	addi	a0,a0,14 # ffffffffc0205c60 <default_pmm_manager+0xb18>
...
ffffffffc0203c5e:	7139                	addi	sp,sp,-64
    int ret = -E_INVAL;
    //try to find a vma which include addr
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203c60:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203c62:	f822                	sd	s0,48(sp)
ffffffffc0203c64:	f426                	sd	s1,40(sp)
ffffffffc0203c66:	fc06                	sd	ra,56(sp)
ffffffffc0203c68:	f04a                	sd	s2,32(sp)
ffffffffc0203c6a:	ec4e                	sd	s3,24(sp)
ffffffffc0203c6c:	8432                	mv	s0,a2
ffffffffc0203c6e:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203c70:	8d1ff0ef          	jal	ra,ffffffffc0203540 <find_vma>
...
ffffffffc0203c86:	c15d                	beqz	a0,ffffffffc0203d2c <do_pgfault+0xce>
ffffffffc0203c88:	651c                	ld	a5,8(a0)
ffffffffc0203c8a:	0af46163          	bltu	s0,a5,ffffffffc0203d2c <do_pgfault+0xce>
...
ffffffffc0203c8e:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203c90:	49c1                	li	s3,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203c92:	8b89                	andi	a5,a5,2
ffffffffc0203c94:	efa9                	bnez	a5,ffffffffc0203cee <do_pgfault+0x90>
        perm |= (PTE_R | PTE_W);
    }
...
ffffffffc0203ca6:	c5a5                	beqz	a1,ffffffffc0203d0e <do_pgfault+0xb0>
...
ffffffffc0203cb0:	c7d9                	beqz	a5,ffffffffc0203d3e <do_pgfault+0xe0>
...
ffffffffc0203cbe:	892a                	mv	s2,a0
            if(ret!=0){
ffffffffc0203cc0:	e90d                	bnez	a0,ffffffffc0203cf2 <do_pgfault+0x94>
...
ffffffffc0203cc6:	86ce                	mv	a3,s3
...
ffffffffc0203cdc:	e3a0                	sd	s0,64(a5)
   }
...
ffffffffc0203ce0:	7442                	ld	s0,48(sp)
ffffffffc0203ce2:	74a2                	ld	s1,40(sp)
ffffffffc0203ce4:	69e2                	ld	s3,24(sp)
ffffffffc0203ce6:	854a                	mv	a0,s2
ffffffffc0203ce8:	7902                	ld	s2,32(sp)
ffffffffc0203cea:	6121                	addi	sp,sp,64
ffffffffc0203cec:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203cee:	49d9                	li	s3,22
ffffffffc0203cf0:	b75d                	j	ffffffffc0203c96 <do_pgfault+0x38>
                cprintf("swap_in in do_pgfault failed\n");
ffffffffc0203cf2:	00002517          	auipc	a0,0x2
ffffffffc0203cf6:	23e50513          	addi	a0,a0,574 # ffffffffc0205f30 <default_pmm_manager+0xde8>
ffffffffc0203cfa:	bc0fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
}
ffffffffc0203cfe:	70e2                	ld	ra,56(sp)
ffffffffc0203d00:	7442                	ld	s0,48(sp)
...
ffffffffc0203d0a:	6121                	addi	sp,sp,64
ffffffffc0203d0c:	8082                	ret
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203d0e:	6c88                	ld	a0,24(s1)
ffffffffc0203d10:	864e                	mv	a2,s3
ffffffffc0203d12:	85a2                	mv	a1,s0
ffffffffc0203d14:	9adfe0ef          	jal	ra,ffffffffc02026c0 <pgdir_alloc_page>
   ret = 0;
ffffffffc0203d18:	4901                	li	s2,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203d1a:	f171                	bnez	a0,ffffffffc0203cde <do_pgfault+0x80>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203d1c:	00002517          	auipc	a0,0x2
ffffffffc0203d20:	1ec50513          	addi	a0,a0,492 # ffffffffc0205f08 <default_pmm_manager+0xdc0>
ffffffffc0203d24:	b96fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d28:	5971                	li	s2,-4
            goto failed;
ffffffffc0203d2a:	bf55                	j	ffffffffc0203cde <do_pgfault+0x80>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203d2c:	85a2                	mv	a1,s0
ffffffffc0203d2e:	00002517          	auipc	a0,0x2
ffffffffc0203d32:	1aa50513          	addi	a0,a0,426 # ffffffffc0205ed8 <default_pmm_manager+0xd90>
ffffffffc0203d36:	b84fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    int ret = -E_INVAL;
ffffffffc0203d3a:	5975                	li	s2,-3
        goto failed;
ffffffffc0203d3c:	b74d                	j	ffffffffc0203cde <do_pgfault+0x80>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203d3e:	00002517          	auipc	a0,0x2
ffffffffc0203d42:	21250513          	addi	a0,a0,530 # ffffffffc0205f50 <default_pmm_manager+0xe08>
ffffffffc0203d46:	b74fc0ef          	jal	ra,ffffffffc02000ba <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203d4a:	5971                	li	s2,-4
            goto failed;
ffffffffc0203d4c:	bf49                	j	ffffffffc0203cde <do_pgfault+0x80>
...
ffffffffc0203d52:	e406                	sd	ra,8(sp)
    if (!ide_device_valid(SWAP_DEV_NO)) {
ffffffffc0203d54:	f40fc0ef          	jal	ra,ffffffffc0200494 <ide_device_valid>
ffffffffc0203d58:	cd01                	beqz	a0,ffffffffc0203d70 <swapfs_init+0x22>
        panic("swap fs isn't available.\n");
    }
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc0203d5a:	4505                	li	a0,1
ffffffffc0203d5c:	f3efc0ef          	jal	ra,ffffffffc020049a <ide_device_size>
}
...
ffffffffc0203d74:	20860613          	addi	a2,a2,520 # ffffffffc0205f78 <default_pmm_manager+0xe30>
ffffffffc0203d78:	45b5                	li	a1,13
ffffffffc0203d7a:	00002517          	auipc	a0,0x2
ffffffffc0203d7e:	21e50513          	addi	a0,a0,542 # ffffffffc0205f98 <default_pmm_manager+0xe50>
...
ffffffffc0203d8e:	c3a5                	beqz	a5,ffffffffc0203dee <swapfs_read+0x68>
ffffffffc0203d90:	0000d717          	auipc	a4,0xd
ffffffffc0203d94:	7b073703          	ld	a4,1968(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203d98:	04e7fb63          	bgeu	a5,a4,ffffffffc0203dee <swapfs_read+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203d9c:	0000d617          	auipc	a2,0xd
ffffffffc0203da0:	78c63603          	ld	a2,1932(a2) # ffffffffc0211528 <pages>
ffffffffc0203da4:	8d91                	sub	a1,a1,a2
ffffffffc0203da6:	4035d613          	srai	a2,a1,0x3
ffffffffc0203daa:	00002597          	auipc	a1,0x2
ffffffffc0203dae:	46e5b583          	ld	a1,1134(a1) # ffffffffc0206218 <error_string+0x38>
ffffffffc0203db2:	02b60633          	mul	a2,a2,a1
ffffffffc0203db6:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203dba:	00002797          	auipc	a5,0x2
ffffffffc0203dbe:	4667b783          	ld	a5,1126(a5) # ffffffffc0206220 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203dc2:	0000d717          	auipc	a4,0xd
ffffffffc0203dc6:	75e73703          	ld	a4,1886(a4) # ffffffffc0211520 <npage>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203dd4:	02e7f963          	bgeu	a5,a4,ffffffffc0203e06 <swapfs_read+0x80>
}
ffffffffc0203dd8:	60a2                	ld	ra,8(sp)
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203dda:	0000d797          	auipc	a5,0xd
ffffffffc0203dde:	75e7b783          	ld	a5,1886(a5) # ffffffffc0211538 <va_pa_offset>
...
ffffffffc0203de8:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203dea:	eb6fc06f          	j	ffffffffc02004a0 <ide_read_secs>
ffffffffc0203dee:	86aa                	mv	a3,a0
ffffffffc0203df0:	00002617          	auipc	a2,0x2
ffffffffc0203df4:	1c060613          	addi	a2,a2,448 # ffffffffc0205fb0 <default_pmm_manager+0xe68>
ffffffffc0203df8:	45d1                	li	a1,20
ffffffffc0203dfa:	00002517          	auipc	a0,0x2
ffffffffc0203dfe:	19e50513          	addi	a0,a0,414 # ffffffffc0205f98 <default_pmm_manager+0xe50>
...
ffffffffc0203e10:	3cc60613          	addi	a2,a2,972 # ffffffffc02051d8 <default_pmm_manager+0x90>
ffffffffc0203e14:	00001517          	auipc	a0,0x1
ffffffffc0203e18:	38c50513          	addi	a0,a0,908 # ffffffffc02051a0 <default_pmm_manager+0x58>
ffffffffc0203e1c:	d58fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203e20 <swapfs_write>:
...
ffffffffc0203e28:	c3a5                	beqz	a5,ffffffffc0203e88 <swapfs_write+0x68>
ffffffffc0203e2a:	0000d717          	auipc	a4,0xd
ffffffffc0203e2e:	71673703          	ld	a4,1814(a4) # ffffffffc0211540 <max_swap_offset>
ffffffffc0203e32:	04e7fb63          	bgeu	a5,a4,ffffffffc0203e88 <swapfs_write+0x68>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0203e48:	3d45b583          	ld	a1,980(a1) # ffffffffc0206218 <error_string+0x38>
ffffffffc0203e4c:	02b60633          	mul	a2,a2,a1
ffffffffc0203e50:	0037959b          	slliw	a1,a5,0x3
ffffffffc0203e54:	00002797          	auipc	a5,0x2
ffffffffc0203e58:	3cc7b783          	ld	a5,972(a5) # ffffffffc0206220 <nbase>
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
...
static inline void *page2kva(struct Page *page) { return KADDR(page2pa(page)); }
ffffffffc0203e6e:	02e7f963          	bgeu	a5,a4,ffffffffc0203ea0 <swapfs_write+0x80>
}
...
ffffffffc0203e82:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203e84:	e40fc06f          	j	ffffffffc02004c4 <ide_write_secs>
ffffffffc0203e88:	86aa                	mv	a3,a0
ffffffffc0203e8a:	00002617          	auipc	a2,0x2
ffffffffc0203e8e:	12660613          	addi	a2,a2,294 # ffffffffc0205fb0 <default_pmm_manager+0xe68>
ffffffffc0203e92:	45e5                	li	a1,25
ffffffffc0203e94:	00002517          	auipc	a0,0x2
ffffffffc0203e98:	10450513          	addi	a0,a0,260 # ffffffffc0205f98 <default_pmm_manager+0xe50>
...
ffffffffc0203eaa:	33260613          	addi	a2,a2,818 # ffffffffc02051d8 <default_pmm_manager+0x90>
ffffffffc0203eae:	00001517          	auipc	a0,0x1
ffffffffc0203eb2:	2f250513          	addi	a0,a0,754 # ffffffffc02051a0 <default_pmm_manager+0x58>
ffffffffc0203eb6:	cbefc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203eba <printnum>:
 * */
static void
...
ffffffffc0203eba:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203ebe:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203ec0:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203ec4:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203ec6:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203eca:	f022                	sd	s0,32(sp)
ffffffffc0203ecc:	ec26                	sd	s1,24(sp)
ffffffffc0203ece:	e84a                	sd	s2,16(sp)
ffffffffc0203ed0:	f406                	sd	ra,40(sp)
ffffffffc0203ed2:	e44e                	sd	s3,8(sp)
ffffffffc0203ed4:	84aa                	mv	s1,a0
ffffffffc0203ed6:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0203ed8:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203edc:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0203ede:	03067e63          	bgeu	a2,a6,ffffffffc0203f1a <printnum+0x60>
ffffffffc0203ee2:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0203ee4:	00805763          	blez	s0,ffffffffc0203ef2 <printnum+0x38>
ffffffffc0203ee8:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203eea:	85ca                	mv	a1,s2
ffffffffc0203eec:	854e                	mv	a0,s3
ffffffffc0203eee:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203ef0:	fc65                	bnez	s0,ffffffffc0203ee8 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203ef2:	1a02                	slli	s4,s4,0x20
ffffffffc0203ef4:	00002797          	auipc	a5,0x2
ffffffffc0203ef8:	0dc78793          	addi	a5,a5,220 # ffffffffc0205fd0 <default_pmm_manager+0xe88>
ffffffffc0203efc:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203f00:	9a3e                	add	s4,s4,a5
}
ffffffffc0203f02:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f04:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203f08:	70a2                	ld	ra,40(sp)
ffffffffc0203f0a:	69a2                	ld	s3,8(sp)
ffffffffc0203f0c:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f0e:	85ca                	mv	a1,s2
ffffffffc0203f10:	87a6                	mv	a5,s1
}
ffffffffc0203f12:	6942                	ld	s2,16(sp)
ffffffffc0203f14:	64e2                	ld	s1,24(sp)
ffffffffc0203f16:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203f18:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203f1a:	03065633          	divu	a2,a2,a6
ffffffffc0203f1e:	8722                	mv	a4,s0
ffffffffc0203f20:	f9bff0ef          	jal	ra,ffffffffc0203eba <printnum>
ffffffffc0203f24:	b7f9                	j	ffffffffc0203ef2 <printnum+0x38>

ffffffffc0203f26 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203f26:	7119                	addi	sp,sp,-128
ffffffffc0203f28:	f4a6                	sd	s1,104(sp)
ffffffffc0203f2a:	f0ca                	sd	s2,96(sp)
ffffffffc0203f2c:	ecce                	sd	s3,88(sp)
ffffffffc0203f2e:	e8d2                	sd	s4,80(sp)
ffffffffc0203f30:	e4d6                	sd	s5,72(sp)
ffffffffc0203f32:	e0da                	sd	s6,64(sp)
ffffffffc0203f34:	fc5e                	sd	s7,56(sp)
ffffffffc0203f36:	f06a                	sd	s10,32(sp)
ffffffffc0203f38:	fc86                	sd	ra,120(sp)
ffffffffc0203f3a:	f8a2                	sd	s0,112(sp)
ffffffffc0203f3c:	f862                	sd	s8,48(sp)
ffffffffc0203f3e:	f466                	sd	s9,40(sp)
ffffffffc0203f40:	ec6e                	sd	s11,24(sp)
ffffffffc0203f42:	892a                	mv	s2,a0
ffffffffc0203f44:	84ae                	mv	s1,a1
ffffffffc0203f46:	8d32                	mv	s10,a2
ffffffffc0203f48:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0203f4a:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203f4e:	5b7d                	li	s6,-1
ffffffffc0203f50:	00002a97          	auipc	s5,0x2
ffffffffc0203f54:	0b4a8a93          	addi	s5,s5,180 # ffffffffc0206004 <default_pmm_manager+0xebc>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0203f58:	00002b97          	auipc	s7,0x2
ffffffffc0203f5c:	288b8b93          	addi	s7,s7,648 # ffffffffc02061e0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f60:	000d4503          	lbu	a0,0(s10) # 80000 <kern_entry-0xffffffffc0180000>
ffffffffc0203f64:	001d0413          	addi	s0,s10,1
ffffffffc0203f68:	01350a63          	beq	a0,s3,ffffffffc0203f7c <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0203f6c:	c121                	beqz	a0,ffffffffc0203fac <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0203f6e:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f70:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203f72:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203f74:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203f78:	ff351ae3          	bne	a0,s3,ffffffffc0203f6c <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f7c:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203f80:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203f84:	4c81                	li	s9,0
ffffffffc0203f86:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0203f88:	5c7d                	li	s8,-1
ffffffffc0203f8a:	5dfd                	li	s11,-1
ffffffffc0203f8c:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0203f90:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203f92:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0203f96:	0ff5f593          	zext.b	a1,a1
ffffffffc0203f9a:	00140d13          	addi	s10,s0,1
ffffffffc0203f9e:	04b56263          	bltu	a0,a1,ffffffffc0203fe2 <vprintfmt+0xbc>
ffffffffc0203fa2:	058a                	slli	a1,a1,0x2
ffffffffc0203fa4:	95d6                	add	a1,a1,s5
ffffffffc0203fa6:	4194                	lw	a3,0(a1)
ffffffffc0203fa8:	96d6                	add	a3,a3,s5
ffffffffc0203faa:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203fac:	70e6                	ld	ra,120(sp)
ffffffffc0203fae:	7446                	ld	s0,112(sp)
ffffffffc0203fb0:	74a6                	ld	s1,104(sp)
ffffffffc0203fb2:	7906                	ld	s2,96(sp)
ffffffffc0203fb4:	69e6                	ld	s3,88(sp)
ffffffffc0203fb6:	6a46                	ld	s4,80(sp)
ffffffffc0203fb8:	6aa6                	ld	s5,72(sp)
ffffffffc0203fba:	6b06                	ld	s6,64(sp)
ffffffffc0203fbc:	7be2                	ld	s7,56(sp)
ffffffffc0203fbe:	7c42                	ld	s8,48(sp)
ffffffffc0203fc0:	7ca2                	ld	s9,40(sp)
ffffffffc0203fc2:	7d02                	ld	s10,32(sp)
ffffffffc0203fc4:	6de2                	ld	s11,24(sp)
ffffffffc0203fc6:	6109                	addi	sp,sp,128
ffffffffc0203fc8:	8082                	ret
            padc = '0';
ffffffffc0203fca:	87b2                	mv	a5,a2
            goto reswitch;
...
ffffffffc0203fde:	fcb572e3          	bgeu	a0,a1,ffffffffc0203fa2 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0203fe2:	85a6                	mv	a1,s1
ffffffffc0203fe4:	02500513          	li	a0,37
ffffffffc0203fe8:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0203fea:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203fee:	8d22                	mv	s10,s0
ffffffffc0203ff0:	f73788e3          	beq	a5,s3,ffffffffc0203f60 <vprintfmt+0x3a>
ffffffffc0203ff4:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0203ff8:	1d7d                	addi	s10,s10,-1
ffffffffc0203ffa:	ff379de3          	bne	a5,s3,ffffffffc0203ff4 <vprintfmt+0xce>
ffffffffc0203ffe:	b78d                	j	ffffffffc0203f60 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204000:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204004:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204008:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc020400a:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc020400e:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204012:	02d86463          	bltu	a6,a3,ffffffffc020403a <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204016:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc020401a:	002c169b          	slliw	a3,s8,0x2
ffffffffc020401e:	0186873b          	addw	a4,a3,s8
ffffffffc0204022:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204026:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204028:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc020402c:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc020402e:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204032:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204036:	fed870e3          	bgeu	a6,a3,ffffffffc0204016 <vprintfmt+0xf0>
            if (width < 0)
ffffffffc020403a:	f40ddce3          	bgez	s11,ffffffffc0203f92 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc020403e:	8de2                	mv	s11,s8
ffffffffc0204040:	5c7d                	li	s8,-1
ffffffffc0204042:	bf81                	j	ffffffffc0203f92 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204044:	fffdc693          	not	a3,s11
ffffffffc0204048:	96fd                	srai	a3,a3,0x3f
ffffffffc020404a:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020404e:	00144603          	lbu	a2,1(s0)
ffffffffc0204052:	2d81                	sext.w	s11,s11
ffffffffc0204054:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204056:	bf35                	j	ffffffffc0203f92 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204058:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
...
ffffffffc0204064:	bfd9                	j	ffffffffc020403a <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204066:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204068:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020406c:	01174463          	blt	a4,a7,ffffffffc0204074 <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204070:	1a088e63          	beqz	a7,ffffffffc020422c <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204074:	000a3603          	ld	a2,0(s4)
ffffffffc0204078:	46c1                	li	a3,16
ffffffffc020407a:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc020407c:	2781                	sext.w	a5,a5
ffffffffc020407e:	876e                	mv	a4,s11
ffffffffc0204080:	85a6                	mv	a1,s1
ffffffffc0204082:	854a                	mv	a0,s2
ffffffffc0204084:	e37ff0ef          	jal	ra,ffffffffc0203eba <printnum>
            break;
ffffffffc0204088:	bde1                	j	ffffffffc0203f60 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc020408a:	000a2503          	lw	a0,0(s4)
ffffffffc020408e:	85a6                	mv	a1,s1
ffffffffc0204090:	0a21                	addi	s4,s4,8
ffffffffc0204092:	9902                	jalr	s2
            break;
ffffffffc0204094:	b5f1                	j	ffffffffc0203f60 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204096:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204098:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc020409c:	01174463          	blt	a4,a7,ffffffffc02040a4 <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc02040a0:	18088163          	beqz	a7,ffffffffc0204222 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc02040a4:	000a3603          	ld	a2,0(s4)
ffffffffc02040a8:	46a9                	li	a3,10
ffffffffc02040aa:	8a2e                	mv	s4,a1
ffffffffc02040ac:	bfc1                	j	ffffffffc020407c <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040ae:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc02040b2:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040b4:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02040b6:	bdf1                	j	ffffffffc0203f92 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc02040b8:	85a6                	mv	a1,s1
ffffffffc02040ba:	02500513          	li	a0,37
ffffffffc02040be:	9902                	jalr	s2
            break;
ffffffffc02040c0:	b545                	j	ffffffffc0203f60 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040c2:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc02040c6:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02040c8:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02040ca:	b5e1                	j	ffffffffc0203f92 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc02040cc:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc02040ce:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc02040d2:	01174463          	blt	a4,a7,ffffffffc02040da <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc02040d6:	14088163          	beqz	a7,ffffffffc0204218 <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc02040da:	000a3603          	ld	a2,0(s4)
ffffffffc02040de:	46a1                	li	a3,8
ffffffffc02040e0:	8a2e                	mv	s4,a1
ffffffffc02040e2:	bf69                	j	ffffffffc020407c <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc02040e4:	03000513          	li	a0,48
ffffffffc02040e8:	85a6                	mv	a1,s1
ffffffffc02040ea:	e03e                	sd	a5,0(sp)
ffffffffc02040ec:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc02040ee:	85a6                	mv	a1,s1
ffffffffc02040f0:	07800513          	li	a0,120
ffffffffc02040f4:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040f6:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc02040f8:	6782                	ld	a5,0(sp)
ffffffffc02040fa:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc02040fc:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204100:	bfb5                	j	ffffffffc020407c <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204102:	000a3403          	ld	s0,0(s4)
ffffffffc0204106:	008a0713          	addi	a4,s4,8
ffffffffc020410a:	e03a                	sd	a4,0(sp)
ffffffffc020410c:	14040263          	beqz	s0,ffffffffc0204250 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204110:	0fb05763          	blez	s11,ffffffffc02041fe <vprintfmt+0x2d8>
ffffffffc0204114:	02d00693          	li	a3,45
ffffffffc0204118:	0cd79163          	bne	a5,a3,ffffffffc02041da <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020411c:	00044783          	lbu	a5,0(s0)
ffffffffc0204120:	0007851b          	sext.w	a0,a5
ffffffffc0204124:	cf85                	beqz	a5,ffffffffc020415c <vprintfmt+0x236>
ffffffffc0204126:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020412a:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020412e:	000c4563          	bltz	s8,ffffffffc0204138 <vprintfmt+0x212>
ffffffffc0204132:	3c7d                	addiw	s8,s8,-1
ffffffffc0204134:	036c0263          	beq	s8,s6,ffffffffc0204158 <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204138:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020413a:	0e0c8e63          	beqz	s9,ffffffffc0204236 <vprintfmt+0x310>
ffffffffc020413e:	3781                	addiw	a5,a5,-32
ffffffffc0204140:	0ef47b63          	bgeu	s0,a5,ffffffffc0204236 <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204144:	03f00513          	li	a0,63
ffffffffc0204148:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020414a:	000a4783          	lbu	a5,0(s4)
ffffffffc020414e:	3dfd                	addiw	s11,s11,-1
ffffffffc0204150:	0a05                	addi	s4,s4,1
ffffffffc0204152:	0007851b          	sext.w	a0,a5
ffffffffc0204156:	ffe1                	bnez	a5,ffffffffc020412e <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204158:	01b05963          	blez	s11,ffffffffc020416a <vprintfmt+0x244>
ffffffffc020415c:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc020415e:	85a6                	mv	a1,s1
ffffffffc0204160:	02000513          	li	a0,32
ffffffffc0204164:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204166:	fe0d9be3          	bnez	s11,ffffffffc020415c <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc020416a:	6a02                	ld	s4,0(sp)
ffffffffc020416c:	bbd5                	j	ffffffffc0203f60 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc020416e:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204170:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204174:	01174463          	blt	a4,a7,ffffffffc020417c <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204178:	08088d63          	beqz	a7,ffffffffc0204212 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc020417c:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204180:	0a044d63          	bltz	s0,ffffffffc020423a <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204184:	8622                	mv	a2,s0
ffffffffc0204186:	8a66                	mv	s4,s9
ffffffffc0204188:	46a9                	li	a3,10
ffffffffc020418a:	bdcd                	j	ffffffffc020407c <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc020418c:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204190:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204192:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204194:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204198:	8fb5                	xor	a5,a5,a3
ffffffffc020419a:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc020419e:	02d74163          	blt	a4,a3,ffffffffc02041c0 <vprintfmt+0x29a>
ffffffffc02041a2:	00369793          	slli	a5,a3,0x3
ffffffffc02041a6:	97de                	add	a5,a5,s7
ffffffffc02041a8:	639c                	ld	a5,0(a5)
ffffffffc02041aa:	cb99                	beqz	a5,ffffffffc02041c0 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc02041ac:	86be                	mv	a3,a5
ffffffffc02041ae:	00002617          	auipc	a2,0x2
ffffffffc02041b2:	e5260613          	addi	a2,a2,-430 # ffffffffc0206000 <default_pmm_manager+0xeb8>
ffffffffc02041b6:	85a6                	mv	a1,s1
ffffffffc02041b8:	854a                	mv	a0,s2
ffffffffc02041ba:	0ce000ef          	jal	ra,ffffffffc0204288 <printfmt>
ffffffffc02041be:	b34d                	j	ffffffffc0203f60 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc02041c0:	00002617          	auipc	a2,0x2
ffffffffc02041c4:	e3060613          	addi	a2,a2,-464 # ffffffffc0205ff0 <default_pmm_manager+0xea8>
ffffffffc02041c8:	85a6                	mv	a1,s1
ffffffffc02041ca:	854a                	mv	a0,s2
ffffffffc02041cc:	0bc000ef          	jal	ra,ffffffffc0204288 <printfmt>
ffffffffc02041d0:	bb41                	j	ffffffffc0203f60 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc02041d2:	00002417          	auipc	s0,0x2
ffffffffc02041d6:	e1640413          	addi	s0,s0,-490 # ffffffffc0205fe8 <default_pmm_manager+0xea0>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041da:	85e2                	mv	a1,s8
ffffffffc02041dc:	8522                	mv	a0,s0
ffffffffc02041de:	e43e                	sd	a5,8(sp)
ffffffffc02041e0:	196000ef          	jal	ra,ffffffffc0204376 <strnlen>
ffffffffc02041e4:	40ad8dbb          	subw	s11,s11,a0
ffffffffc02041e8:	01b05b63          	blez	s11,ffffffffc02041fe <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc02041ec:	67a2                	ld	a5,8(sp)
ffffffffc02041ee:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
...
ffffffffc02041f8:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02041fa:	fe0d9ce3          	bnez	s11,ffffffffc02041f2 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02041fe:	00044783          	lbu	a5,0(s0)
ffffffffc0204202:	00140a13          	addi	s4,s0,1
ffffffffc0204206:	0007851b          	sext.w	a0,a5
ffffffffc020420a:	d3a5                	beqz	a5,ffffffffc020416a <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc020420c:	05e00413          	li	s0,94
ffffffffc0204210:	bf39                	j	ffffffffc020412e <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204212:	000a2403          	lw	s0,0(s4)
ffffffffc0204216:	b7ad                	j	ffffffffc0204180 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204218:	000a6603          	lwu	a2,0(s4)
ffffffffc020421c:	46a1                	li	a3,8
ffffffffc020421e:	8a2e                	mv	s4,a1
ffffffffc0204220:	bdb1                	j	ffffffffc020407c <vprintfmt+0x156>
ffffffffc0204222:	000a6603          	lwu	a2,0(s4)
ffffffffc0204226:	46a9                	li	a3,10
ffffffffc0204228:	8a2e                	mv	s4,a1
ffffffffc020422a:	bd89                	j	ffffffffc020407c <vprintfmt+0x156>
ffffffffc020422c:	000a6603          	lwu	a2,0(s4)
ffffffffc0204230:	46c1                	li	a3,16
ffffffffc0204232:	8a2e                	mv	s4,a1
ffffffffc0204234:	b5a1                	j	ffffffffc020407c <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204236:	9902                	jalr	s2
ffffffffc0204238:	bf09                	j	ffffffffc020414a <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc020423a:	85a6                	mv	a1,s1
ffffffffc020423c:	02d00513          	li	a0,45
ffffffffc0204240:	e03e                	sd	a5,0(sp)
ffffffffc0204242:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204244:	6782                	ld	a5,0(sp)
ffffffffc0204246:	8a66                	mv	s4,s9
ffffffffc0204248:	40800633          	neg	a2,s0
ffffffffc020424c:	46a9                	li	a3,10
ffffffffc020424e:	b53d                	j	ffffffffc020407c <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204250:	03b05163          	blez	s11,ffffffffc0204272 <vprintfmt+0x34c>
ffffffffc0204254:	02d00693          	li	a3,45
ffffffffc0204258:	f6d79de3          	bne	a5,a3,ffffffffc02041d2 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc020425c:	00002417          	auipc	s0,0x2
ffffffffc0204260:	d8c40413          	addi	s0,s0,-628 # ffffffffc0205fe8 <default_pmm_manager+0xea0>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204264:	02800793          	li	a5,40
ffffffffc0204268:	02800513          	li	a0,40
ffffffffc020426c:	00140a13          	addi	s4,s0,1
ffffffffc0204270:	bd6d                	j	ffffffffc020412a <vprintfmt+0x204>
ffffffffc0204272:	00002a17          	auipc	s4,0x2
ffffffffc0204276:	d77a0a13          	addi	s4,s4,-649 # ffffffffc0205fe9 <default_pmm_manager+0xea1>
ffffffffc020427a:	02800513          	li	a0,40
ffffffffc020427e:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204282:	05e00413          	li	s0,94
ffffffffc0204286:	b565                	j	ffffffffc020412e <vprintfmt+0x208>

ffffffffc0204288 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204288:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc020428a:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020428e:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204290:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204292:	ec06                	sd	ra,24(sp)
ffffffffc0204294:	f83a                	sd	a4,48(sp)
ffffffffc0204296:	fc3e                	sd	a5,56(sp)
ffffffffc0204298:	e0c2                	sd	a6,64(sp)
ffffffffc020429a:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc020429c:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020429e:	c89ff0ef          	jal	ra,ffffffffc0203f26 <vprintfmt>
}
ffffffffc02042a2:	60e2                	ld	ra,24(sp)
ffffffffc02042a4:	6161                	addi	sp,sp,80
ffffffffc02042a6:	8082                	ret

ffffffffc02042a8 <readline>:
...
ffffffffc02042a8:	715d                	addi	sp,sp,-80
ffffffffc02042aa:	e486                	sd	ra,72(sp)
ffffffffc02042ac:	e0a6                	sd	s1,64(sp)
ffffffffc02042ae:	fc4a                	sd	s2,56(sp)
ffffffffc02042b0:	f84e                	sd	s3,48(sp)
ffffffffc02042b2:	f452                	sd	s4,40(sp)
ffffffffc02042b4:	f056                	sd	s5,32(sp)
ffffffffc02042b6:	ec5a                	sd	s6,24(sp)
ffffffffc02042b8:	e85e                	sd	s7,16(sp)
    if (prompt != NULL) {
ffffffffc02042ba:	c901                	beqz	a0,ffffffffc02042ca <readline+0x22>
ffffffffc02042bc:	85aa                	mv	a1,a0
        cprintf("%s", prompt);
ffffffffc02042be:	00002517          	auipc	a0,0x2
ffffffffc02042c2:	d4250513          	addi	a0,a0,-702 # ffffffffc0206000 <default_pmm_manager+0xeb8>
ffffffffc02042c6:	df5fb0ef          	jal	ra,ffffffffc02000ba <cprintf>
readline(const char *prompt) {
ffffffffc02042ca:	4481                	li	s1,0
    while (1) {
        c = getchar();
        if (c < 0) {
            return NULL;
...
ffffffffc02042cc:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc02042ce:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc02042d0:	4aa9                	li	s5,10
ffffffffc02042d2:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc02042d4:	0000db97          	auipc	s7,0xd
ffffffffc02042d8:	e24b8b93          	addi	s7,s7,-476 # ffffffffc02110f8 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042dc:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc02042e0:	e13fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042e4:	00054a63          	bltz	a0,ffffffffc02042f8 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc02042e8:	00a95a63          	bge	s2,a0,ffffffffc02042fc <readline+0x54>
ffffffffc02042ec:	029a5263          	bge	s4,s1,ffffffffc0204310 <readline+0x68>
        c = getchar();
ffffffffc02042f0:	e03fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc02042f4:	fe055ae3          	bgez	a0,ffffffffc02042e8 <readline+0x40>
            return NULL;
ffffffffc02042f8:	4501                	li	a0,0
ffffffffc02042fa:	a091                	j	ffffffffc020433e <readline+0x96>
        else if (c == '\b' && i > 0) {
ffffffffc02042fc:	03351463          	bne	a0,s3,ffffffffc0204324 <readline+0x7c>
ffffffffc0204300:	e8a9                	bnez	s1,ffffffffc0204352 <readline+0xaa>
        c = getchar();
ffffffffc0204302:	df1fb0ef          	jal	ra,ffffffffc02000f2 <getchar>
        if (c < 0) {
ffffffffc0204306:	fe0549e3          	bltz	a0,ffffffffc02042f8 <readline+0x50>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc020430a:	fea959e3          	bge	s2,a0,ffffffffc02042fc <readline+0x54>
ffffffffc020430e:	4481                	li	s1,0
            cputchar(c);
ffffffffc0204310:	e42a                	sd	a0,8(sp)
ffffffffc0204312:	ddffb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i ++] = c;
ffffffffc0204316:	6522                	ld	a0,8(sp)
ffffffffc0204318:	009b87b3          	add	a5,s7,s1
ffffffffc020431c:	2485                	addiw	s1,s1,1
ffffffffc020431e:	00a78023          	sb	a0,0(a5)
ffffffffc0204322:	bf7d                	j	ffffffffc02042e0 <readline+0x38>
        else if (c == '\n' || c == '\r') {
ffffffffc0204324:	01550463          	beq	a0,s5,ffffffffc020432c <readline+0x84>
ffffffffc0204328:	fb651ce3          	bne	a0,s6,ffffffffc02042e0 <readline+0x38>
            cputchar(c);
ffffffffc020432c:	dc5fb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            buf[i] = '\0';
ffffffffc0204330:	0000d517          	auipc	a0,0xd
ffffffffc0204334:	dc850513          	addi	a0,a0,-568 # ffffffffc02110f8 <buf>
ffffffffc0204338:	94aa                	add	s1,s1,a0
ffffffffc020433a:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc020433e:	60a6                	ld	ra,72(sp)
ffffffffc0204340:	6486                	ld	s1,64(sp)
ffffffffc0204342:	7962                	ld	s2,56(sp)
ffffffffc0204344:	79c2                	ld	s3,48(sp)
ffffffffc0204346:	7a22                	ld	s4,40(sp)
ffffffffc0204348:	7a82                	ld	s5,32(sp)
ffffffffc020434a:	6b62                	ld	s6,24(sp)
ffffffffc020434c:	6bc2                	ld	s7,16(sp)
ffffffffc020434e:	6161                	addi	sp,sp,80
ffffffffc0204350:	8082                	ret
            cputchar(c);
ffffffffc0204352:	4521                	li	a0,8
ffffffffc0204354:	d9dfb0ef          	jal	ra,ffffffffc02000f0 <cputchar>
            i --;
ffffffffc0204358:	34fd                	addiw	s1,s1,-1
ffffffffc020435a:	b759                	j	ffffffffc02042e0 <readline+0x38>

ffffffffc020435c <strlen>:
...
strlen(const char *s) {
ffffffffc0204360:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204362:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204364:	cb81                	beqz	a5,ffffffffc0204374 <strlen+0x18>
        cnt ++;
ffffffffc0204366:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204368:	00a707b3          	add	a5,a4,a0
ffffffffc020436c:	0007c783          	lbu	a5,0(a5)
ffffffffc0204370:	fbfd                	bnez	a5,ffffffffc0204366 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204376:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204378:	e589                	bnez	a1,ffffffffc0204382 <strnlen+0xc>
ffffffffc020437a:	a811                	j	ffffffffc020438e <strnlen+0x18>
        cnt ++;
ffffffffc020437c:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc020437e:	00f58863          	beq	a1,a5,ffffffffc020438e <strnlen+0x18>
ffffffffc0204382:	00f50733          	add	a4,a0,a5
ffffffffc0204386:	00074703          	lbu	a4,0(a4)
ffffffffc020438a:	fb6d                	bnez	a4,ffffffffc020437c <strnlen+0x6>
ffffffffc020438c:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc020438e:	852e                	mv	a0,a1
ffffffffc0204390:	8082                	ret

ffffffffc0204392 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0204392:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204394:	0005c703          	lbu	a4,0(a1)
ffffffffc0204398:	0785                	addi	a5,a5,1
ffffffffc020439a:	0585                	addi	a1,a1,1
ffffffffc020439c:	fee78fa3          	sb	a4,-1(a5)
ffffffffc02043a0:	fb75                	bnez	a4,ffffffffc0204394 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc02043a8:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc02043ac:	cb89                	beqz	a5,ffffffffc02043be <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc02043ae:	0505                	addi	a0,a0,1
ffffffffc02043b0:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc02043b2:	fee789e3          	beq	a5,a4,ffffffffc02043a4 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
...
ffffffffc02043c0:	bfed                	j	ffffffffc02043ba <strcmp+0x16>

ffffffffc02043c2 <strchr>:
...
ffffffffc02043c6:	c799                	beqz	a5,ffffffffc02043d4 <strchr+0x12>
        if (*s == c) {
ffffffffc02043c8:	00f58763          	beq	a1,a5,ffffffffc02043d6 <strchr+0x14>
    while (*s != '\0') {
ffffffffc02043cc:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc02043d0:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc02043d2:	fbfd                	bnez	a5,ffffffffc02043c8 <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc02043d8:	ca01                	beqz	a2,ffffffffc02043e8 <memset+0x10>
ffffffffc02043da:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc02043dc:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc02043de:	0785                	addi	a5,a5,1
ffffffffc02043e0:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc02043e4:	fec79de3          	bne	a5,a2,ffffffffc02043de <memset+0x6>
    }
    return s;
...
ffffffffc02043ea <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02043ea:	ca19                	beqz	a2,ffffffffc0204400 <memcpy+0x16>
ffffffffc02043ec:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02043ee:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02043f0:	0005c703          	lbu	a4,0(a1)
ffffffffc02043f4:	0585                	addi	a1,a1,1
ffffffffc02043f6:	0785                	addi	a5,a5,1
ffffffffc02043f8:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02043fc:	fec59ae3          	bne	a1,a2,ffffffffc02043f0 <memcpy+0x6>
    }
    return dst;
