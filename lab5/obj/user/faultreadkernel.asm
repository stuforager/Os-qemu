...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	54c50513          	addi	a0,a0,1356 # 800580 <main+0x32>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800058:	54c50513          	addi	a0,a0,1356 # 8005a0 <main+0x52>
...
exit(int error_code) {
  ...
  800126:	48650513          	addi	a0,a0,1158 # 8005a8 <main+0x5a>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80017e:	66678793          	addi	a5,a5,1638 # 8007e0 <error_string+0xc8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001d2:	3eea0a13          	addi	s4,s4,1006 # 8005bc <main+0x6e>
  ...
  8001de:	53ec0c13          	addi	s8,s8,1342 # 800718 <error_string>
  ...
  800334:	5a060613          	addi	a2,a2,1440 # 8008d0 <error_string+0x1b8>
  ...
  800454:	47060613          	addi	a2,a2,1136 # 8008c0 <error_string+0x1a8>
  ...
  800466:	45660613          	addi	a2,a2,1110 # 8008b8 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
  80046a:	00000417          	auipc	s0,0x0
  80046e:	44f40413          	addi	s0,s0,1103 # 8008b9 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
  ...
  8004fa:	3c340413          	addi	s0,s0,963 # 8008b9 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  800560:	e406                	sd	ra,8(sp)
    cprintf("I read %08x from 0xfac00000!\n", *(unsigned *)0xfac00000);
  800562:	b3fff0ef          	jal	ra,8000a0 <cprintf>
    panic("FAIL: T.T\n");
