...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	5cc50513          	addi	a0,a0,1484 # 800600 <main+0xb2>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800058:	5cc50513          	addi	a0,a0,1484 # 800620 <main+0xd2>
...
exit(int error_code) {
  ...
  800126:	50650513          	addi	a0,a0,1286 # 800628 <main+0xda>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80017e:	6e678793          	addi	a5,a5,1766 # 800860 <error_string+0xc8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001d2:	46ea0a13          	addi	s4,s4,1134 # 80063c <main+0xee>
  ...
  8001de:	5bec0c13          	addi	s8,s8,1470 # 800798 <error_string>
  ...
  800334:	62060613          	addi	a2,a2,1568 # 800950 <error_string+0x1b8>
  ...
  800454:	4f060613          	addi	a2,a2,1264 # 800940 <error_string+0x1a8>
  ...
  800466:	4d660613          	addi	a2,a2,1238 # 800938 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
  80046a:	00000417          	auipc	s0,0x0
  80046e:	4cf40413          	addi	s0,s0,1231 # 800939 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
  ...
  8004fa:	44340413          	addi	s0,s0,1091 # 800939 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
...
main(void) {
  800558:	e406                	sd	ra,8(sp)
    cprintf("Making sure bss works right...\n");
  80055a:	b47ff0ef          	jal	ra,8000a0 <cprintf>
    int i;
  ...
  8005de:	ac3ff0ef          	jal	ra,8000a0 <cprintf>
  ...
  8005f4:	a007a823          	sw	zero,-1520(a5) # c02000 <bigarray+0x401000>
    exit(0);
  8005f8:	b23ff0ef          	jal	ra,80011a <exit>
